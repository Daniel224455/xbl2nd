...
/*
  ...
  ====================================================================
  $Header: //components/rel/boot.xf/2.0/QcomPkg/SDM845Pkg/Library/ClockLib/ClockApps.c#2 $
  $DateTime: 2017/10/13 16:25:06 $
  $Author: pwbldsvc $
  ====================================================================
*/
...
#define SILVER_CLUSTER_INITIAL_PERF_LEVEL  15      // OSM perf level (1516.8 MHz)
...
)
{
  ...
  {
    case CHIPINFO_ID_SDM845:
    default:
      HALClkCtxt->nChipId = CHIPINFO_ID_SDM845;
      break;
  }
}
