...
uint8   lpddr_geometry_table[][2][2] = {
  ...
  /* nrows, ncols      |  nrows, ncols     */
    ...
    {{16,    10},         {17,    10}},  // 12 Gb per channel (TBD as per JEDEC spec)
    {{16,    10},         {17,    10}}   // 16 Gb per channel (TBD as per JEDEC spec)
};
...
uint32   lpddr_timing_table[][2] = {
  /* tRFC_AB_in_ps, tRFC_PB_in_ps */
    ...
    {280000,        140000,},  // 12 Gb per channel (TBD as per JEDEC spec)
    {280000,        140000,}   // 16 Gb per channel (TBD as per JEDEC spec)
};
