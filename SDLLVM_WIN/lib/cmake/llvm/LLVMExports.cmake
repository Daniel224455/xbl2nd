...
set_target_properties(LLVMBitWriter PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMCodeGen"
)
...
# Create imported target LLVMAECore
add_library(LLVMAECore STATIC IMPORTED)
...
set_target_properties(LLVMipo PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMAnalysis;LLVMCore;LLVMIRReader;LLVMInstCombine;LLVMInstrumentation;LLVMLinker;LLVMObject;LLVMProfileData;LLVMScalarOpts;LLVMSupport;LLVMTransformUtils;LLVMVectorize;LLVMInstrumentation"
)
...
set_target_properties(LLVMDebugInfoPDB PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMDebugInfoCodeView;LLVMObject;LLVMSupport;C:/Program Files (x86)/Microsoft Visual Studio 14.0/DIA SDK/lib/amd64/diaguids.lib"
)
...
# Create imported target LTO_static
add_library(LTO_static STATIC IMPORTED)

set_target_properties(LTO_static PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMARMCodeGen;LLVMARMAsmPrinter;LLVMARMAsmParser;LLVMARMDesc;LLVMARMInfo;LLVMARMDisassembler;LLVMAArch64CodeGen;LLVMAArch64AsmPrinter;LLVMAArch64AsmParser;LLVMAArch64Desc;LLVMAArch64Info;LLVMAArch64Disassembler;LLVMAECore;LLVMBitReader;LLVMCore;LLVMLTO;LLVMMC;LLVMMCDisassembler;LLVMSupport;LLVMTarget"
)
...
# Create imported target addr2line
add_executable(addr2line IMPORTED)

# Create imported target LLVMAE
add_library(LLVMAE SHARED IMPORTED)
...
# Create imported target lto-as
add_executable(lto-as IMPORTED)

# Create imported target MCLDConfig
add_library(MCLDConfig STATIC IMPORTED)

# Create imported target MCLDCore
add_library(MCLDCore STATIC IMPORTED)

set_target_properties(MCLDCore PROPERTIES
  INTERFACE_LINK_LIBRARIES "MCLDMC;MCLDObject"
)

# Create imported target MCLDFragment
add_library(MCLDFragment STATIC IMPORTED)

set_target_properties(MCLDFragment PROPERTIES
  INTERFACE_LINK_LIBRARIES "MCLDLD"
)

# Create imported target MCLDLD
add_library(MCLDLD STATIC IMPORTED)

set_target_properties(MCLDLD PROPERTIES
  INTERFACE_LINK_LIBRARIES "MCLDConfig;MCLDFragment;LLVMObject;LTO"
)

# Create imported target MCLDMC
add_library(MCLDMC STATIC IMPORTED)

set_target_properties(MCLDMC PROPERTIES
  INTERFACE_LINK_LIBRARIES "MCLDSupport"
)

# Create imported target MCLDObject
add_library(MCLDObject STATIC IMPORTED)

set_target_properties(MCLDObject PROPERTIES
  INTERFACE_LINK_LIBRARIES "MCLDCore;MCLDFragment;MCLDLD;MCLDScript;MCLDSupport;MCLDTarget;LLVMSupport;LTO"
)

# Create imported target MCLDScript
add_library(MCLDScript STATIC IMPORTED)

set_target_properties(MCLDScript PROPERTIES
  INTERFACE_LINK_LIBRARIES "MCLDCore"
)

# Create imported target MCLDSupport
add_library(MCLDSupport STATIC IMPORTED)

set_target_properties(MCLDSupport PROPERTIES
  INTERFACE_LINK_LIBRARIES "MCLDLD"
)

# Create imported target MCLDTarget
add_library(MCLDTarget STATIC IMPORTED)

set_target_properties(MCLDTarget PROPERTIES
  INTERFACE_LINK_LIBRARIES "MCLDARMLDBackend;MCLDAArch64LDBackend;MCLDCore;MCLDLD"
)

# Create imported target MCLDARMLDBackend
add_library(MCLDARMLDBackend STATIC IMPORTED)

set_target_properties(MCLDARMLDBackend PROPERTIES
  INTERFACE_LINK_LIBRARIES "MCLDARMTargetInfo;MCLDCore;MCLDFragment;MCLDObject;MCLDTarget"
)

# Create imported target MCLDARMTargetInfo
add_library(MCLDARMTargetInfo STATIC IMPORTED)

# Create imported target MCLDAArch64LDBackend
add_library(MCLDAArch64LDBackend STATIC IMPORTED)

set_target_properties(MCLDAArch64LDBackend PROPERTIES
  INTERFACE_LINK_LIBRARIES "MCLDAArch64TargetInfo;MCLDCore;MCLDFragment;MCLDObject;MCLDTarget"
)

# Create imported target MCLDAArch64TargetInfo
add_library(MCLDAArch64TargetInfo STATIC IMPORTED)

# Create imported target MCLDDriver
add_library(MCLDDriver STATIC IMPORTED)

set_target_properties(MCLDDriver PROPERTIES
  INTERFACE_LINK_LIBRARIES "MCLDTarget;LLVMOption;LLVMSupport"
)
