...
#define REG_OFFSET_LLCC_COMMON(uint8)   ((uint8 == 0) ? \
                                        ...
                                        (uint8 == 2) ? \
                                        SEQ_DDR_SS_LLCC2_LLCC_COMMON_OFFSET : \
                                        (uint8 == 3) ? \
                                        SEQ_DDR_SS_LLCC3_LLCC_COMMON_OFFSET : \
...
#define REG_OFFSET_LLCC_FEAC(uint8)   ((uint8 == 0) ? \
                                        ...
                                        (uint8 == 2) ? \
                                        SEQ_DDR_SS_LLCC2_LLCC_FEAC_OFFSET : \
                                        (uint8 == 3) ? \
                                        SEQ_DDR_SS_LLCC3_LLCC_FEAC_OFFSET : \
...
#define REG_OFFSET_LLCC_FEWC(uint8)   ((uint8 == 0) ? \
                                        ...
                                        (uint8 == 2) ? \
                                        SEQ_DDR_SS_LLCC2_LLCC_FEWC_OFFSET : \
                                        (uint8 == 3) ? \
                                        SEQ_DDR_SS_LLCC3_LLCC_FEWC_OFFSET : \
...
#define REG_OFFSET_LLCC_BERC(uint8)   ((uint8 == 0) ? \
                                        ...
                                        (uint8 == 2) ? \
                                        SEQ_DDR_SS_LLCC2_LLCC_BERC_OFFSET : \
                                        (uint8 == 3) ? \
                                        SEQ_DDR_SS_LLCC3_LLCC_BERC_OFFSET : \
...
#define REG_OFFSET_LLCC_FERC(uint8)   ((uint8 == 0) ? \
                                        ...
                                        (uint8 == 2) ? \
                                        SEQ_DDR_SS_LLCC2_LLCC_FERC_OFFSET : \
                                        (uint8 == 3) ? \
                                        SEQ_DDR_SS_LLCC3_LLCC_FERC_OFFSET : \
...
#define REG_OFFSET_LLCC_BIST(uint8)   ((uint8 == 0) ? \
                                        ...
                                        (uint8 == 2) ? \
                                        SEQ_DDR_SS_LLCC2_LLCC_BIST_OFFSET : \
                                        (uint8 == 3) ? \
                                        SEQ_DDR_SS_LLCC3_LLCC_BIST_OFFSET : \
                                        (SEQ_DDR_SS_LLCC_BROADCAST_LLCC_FERC_OFFSET))
...
#define REG_OFFSET_LLCC_TBUF(uint8)   ((uint8 == 0) ? \
                                        ...
                                        (uint8 == 2) ? \
                                        SEQ_DDR_SS_LLCC2_LLCC_TBUF_OFFSET : \
                                        (uint8 == 3) ? \
                                        SEQ_DDR_SS_LLCC3_LLCC_TBUF_OFFSET : \
...
#define REG_OFFSET_LLCC_DRP(uint8)   ((uint8 == 0) ? \
                                        ...
                                        (uint8 == 2) ? \
                                        SEQ_DDR_SS_LLCC2_LLCC_DRP_OFFSET : \
                                        (uint8 == 3) ? \
                                        SEQ_DDR_SS_LLCC3_LLCC_DRP_OFFSET : \
...
#define REG_OFFSET_LLCC_TRP(uint8)   ((uint8 == 0) ? \
                                        ...
                                        (uint8 == 2) ? \
                                        SEQ_DDR_SS_LLCC2_LLCC_TRP_OFFSET : \
                                        (uint8 == 3) ? \
                                        SEQ_DDR_SS_LLCC3_LLCC_TRP_OFFSET : \
...
#define REG_OFFSET_LLCC_AMON(uint8)   ((uint8 == 0) ? \
                                        ...
                                        (uint8 == 2) ? \
                                        SEQ_DDR_SS_LLCC2_LLCC_AMON_OFFSET : \
                                        (uint8 == 3) ? \
                                        SEQ_DDR_SS_LLCC3_LLCC_AMON_OFFSET : \
...
#define REG_OFFSET_LLCC_BEAC(uint8)   ((uint8 == 0) ? \
                                        ...
                                        (uint8 == 2) ? \
                                        SEQ_DDR_SS_LLCC2_LLCC_BEAC_OFFSET : \
                                        (uint8 == 3) ? \
                                        SEQ_DDR_SS_LLCC3_LLCC_BEAC_OFFSET : \
...
#define REG_OFFSET_LLCC_MPU(uint8)   ((uint8 == 0) ? \
                                        ...
                                        (uint8 == 2) ? \
                                        SEQ_DDR_SS_LLCC2_LLCC_MPU_OFFSET : \
                                        (uint8 == 3) ? \
                                        SEQ_DDR_SS_LLCC3_LLCC_MPU_OFFSET : \
...
#define REG_OFFSET_LLCC_PMGR(uint8)   ((uint8 == 0) ? \
                                        ...
                                        (uint8 == 2) ? \
                                        SEQ_DDR_SS_LLCC2_LLCC_PMGR_OFFSET : \
                                        (uint8 == 3) ? \
                                        SEQ_DDR_SS_LLCC3_LLCC_PMGR_OFFSET : \
