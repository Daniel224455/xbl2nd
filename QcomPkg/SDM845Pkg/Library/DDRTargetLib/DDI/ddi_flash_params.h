...
typedef struct __attribute__((packed)) ddi_fail_summary
{
  ...
  uint32 rank_0_fail_count;
  uint32 rank_1_fail_count;
  uint32 channel_0_fail_count;
  uint32 channel_1_fail_count;
  uint32 channel_2_fail_count;
  uint32 channel_3_fail_count;
