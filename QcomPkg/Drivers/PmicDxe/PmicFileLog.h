...
--------   ---     ----------------------------------------------------------
09/22/17   va      Read logfs partition size as per alloted from target specific file
...
#define DEFAULT_LOGFILE_SIZE        8388608 // 8MB
#define CLOCKLOGFILE_SIZE   524288 // 0.5MB
#define UEFILOGFILE_SIXE    1048576 // 1 MB
