...
VOID XBLRamDumpMain( VOID )
{
  ...
  /*updating the boot_shared_uefi_ram_dump_magic variable from the shared imem location.
    this shared variable will be used in the ramdump path, rather than rely on shared imem value*/  
