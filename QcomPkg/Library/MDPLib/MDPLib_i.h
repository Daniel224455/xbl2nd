...
typedef struct
{
    ...
    uint32 uEscapeClockSource;         /**< Escape clock source: 0 - CXO, 1 - DSI PLL0, 2 - DSI PLL1 */
    uint32 uEscapeClockDivisor;        /**< Escape clock divisor 2x value */
...
**
* \retval MDP_ExtClockResourceList
*
****************************************************************************/ 
...
/* ---------------------------------------------------------------------- */
/**
** FUNCTION: MDPGetClockList()
**
** DESCRIPTION:
**   Return list of clocks for this clock type
**
** ---------------------------------------------------------------------- */
MDPClockEntry* MDPGetClockList(MDPClockTypes eClockType);
