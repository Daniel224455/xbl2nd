...
#else
#error "no DDR PHY include found"
#endif
...
typedef struct __attribute__((packed)) ddi_safe_mode_info
{ 
  uint8   self_refresh_mode_enable;                        /* Default 1 to enable. 0 used for debug. */
  uint8   refresh_rate_polling_enable;                     /* Default 1 to enable. 0 used for debug. */
  ...
  uint8   partial_array_self_refresh_enable;               /* 1: Enable periodic ZQ calibration, 0: Disable periodic ZQ calibration */
  ...
  uint8   low_power_CA_buffer_support_enable;              /* 1: Enable periodic training, 0: Disable periodic training */
  uint8   single_ended_clock_support_enable;               /* 1: Enable periodic ZQ calibration, 0: Disable periodic ZQ calibration */
  uint8   single_ended_write_DQS_support_enable;           /* 1: Enable periodic training, 0: Disable periodic training */
  uint8   single_ended_read_DQS_support_enable;            /* 1: Enable periodic training, 0: Disable periodic training */
