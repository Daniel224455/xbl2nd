/**
 ...
 Copyright (c) 2011-2013, 2018, 2020 Qualcomm Technologies, Incorporated.  All rights reserved.
 
 Portions Copyright (c) 2013, Intel Corporation. All rights reserved.<BR>
...
/*=============================================================================
 ...
 --------    ---    -----------------------------------------------------------
 01/08/20    pj      Switched out EFI_RNG_ALGORITHM_SP800_90 CTR_256_GUID with HASH_256_GUID
                     since that is what Qualcomm hardware is certified for
 07/25/18    pj      Added support for EFI_RNG_ALGORITHM_SP800_90_CTR_256_GUID
...
///
/// The algorithm corresponds to SP800-90 as defined in
...
/** @ingroup efi_rng_constants
  Protocol version. 
*/
#define RNG_REVISION 0x00020000
