 ...
 ******************************************************************************/
/*==============================================================================
$Header: //components/rel/boot.xf/2.0/QcomPkg/SDM845Pkg/Settings/DSF/target_config.h#44 $
$DateTime: 2018/09/19 10:51:29 $
$Author: pwbldsvc $
================================================================================*/

// DDR System Firmware Version
#define TARGET_DDR_SYSTEM_FIRMWARE_MAJOR_VERSION     253
#define TARGET_DDR_SYSTEM_FIRMWARE_MINOR_VERSION     10
...
// Mask indicating which chip selects support byte mode
#define BYTE_MODE_SUPPORTED_CHIPSELECTS 0x1 // chip select 0 only
...
#define TRAINING_INTERLEAVE_ADDRESS_OFFSET  0x00000200
...
#define DSF_RD_DQDQS_COARSE_FINE_PLOT_PIVOT          1  
...
#define DSF_WR_DQDQS_COARSE_FINE_PLOT_PIVOT          1  // Warning: The Pivot plot takes ~5 min
