...
typedef enum
{
  ...
  EFI_DISPLAY_UTILS_DISPLAY_DIAG_LOGS,        /**< Retrieve display diagnostic logs */
  EFI_DISPLAY_UTILS_DISPLAY_ORIENTATION,      /**< Configure the scanout orientation */  
  EFI_DISPLAY_UTILS_GET_PANEL_RESOLUTION,     /**< Retrieve mode resolution and frame rate information */
  EFI_DISPLAY_UTILS_GET_FRAME_CRC,            /**< Retrieve frame CRC  */
  EFI_DISPLAY_UTILS_WAIT_FOR_EVENT,           /**< Wait for an event */
