#ifndef __CLOCKNOC_SDM845V1_H__
#define __CLOCKNOC_SDM845V1_H__
/*
===========================================================================
*/
/**
  @file ClockNOC_SDM845V1.h
  ...
  { u'filename': u'ClockNOC_SDM845V1.h',
...
/*
  ...
  $Header: //components/rel/boot.xf/2.2/QcomPkg/SDM845Pkg/Library/ClockTargetLib/ClockNOC_SDM845v1.h#1 $
...
#define HWIO_AGGRE_NOC_A1NOC_DCD_MAXDIV_LOW_ADDR                                                     (AGGRE_NOC_A1NOC_SERVICE_NETWORK_REG_BASE      + 0x00012008)
...
#define HWIO_AGGRE_NOC_A2NOC_DCD_EAST_MAXDIV_LOW_ADDR                                                   (AGGRE_NOC_A2NOC_SERVICE_NETWORK_REG_BASE      + 0x0001f008)
#define HWIO_AGGRE_NOC_A2NOC_DCD_EAST_MAXDIV_LOW_RMSK                                                          0x7
#define HWIO_AGGRE_NOC_A2NOC_DCD_EAST_MAXDIV_LOW_IN          \
        in_dword_masked(HWIO_AGGRE_NOC_A2NOC_DCD_EAST_MAXDIV_LOW_ADDR, HWIO_AGGRE_NOC_A2NOC_DCD_EAST_MAXDIV_LOW_RMSK)
#define HWIO_AGGRE_NOC_A2NOC_DCD_EAST_MAXDIV_LOW_INM(m)      \
        in_dword_masked(HWIO_AGGRE_NOC_A2NOC_DCD_EAST_MAXDIV_LOW_ADDR, m)
#define HWIO_AGGRE_NOC_A2NOC_DCD_EAST_MAXDIV_LOW_OUT(v)      \
        out_dword(HWIO_AGGRE_NOC_A2NOC_DCD_EAST_MAXDIV_LOW_ADDR,v)
#define HWIO_AGGRE_NOC_A2NOC_DCD_EAST_MAXDIV_LOW_OUTM(m,v) \
        out_dword_masked_ns(HWIO_AGGRE_NOC_A2NOC_DCD_EAST_MAXDIV_LOW_ADDR,m,v,HWIO_AGGRE_NOC_A2NOC_DCD_EAST_MAXDIV_LOW_IN)
#define HWIO_AGGRE_NOC_A2NOC_DCD_EAST_MAXDIV_LOW_MAXDIV_BMSK                                                   0x7
#define HWIO_AGGRE_NOC_A2NOC_DCD_EAST_MAXDIV_LOW_MAXDIV_SHFT                                                   0x0
...
#define HWIO_AGGRE_NOC_A2NOC_DCD_WEST_MAXDIV_LOW_ADDR                                                   (AGGRE_NOC_A2NOC_SERVICE_NETWORK_REG_BASE      + 0x0001f108)
#define HWIO_AGGRE_NOC_A2NOC_DCD_WEST_MAXDIV_LOW_RMSK                                                          0x7
#define HWIO_AGGRE_NOC_A2NOC_DCD_WEST_MAXDIV_LOW_IN          \
        in_dword_masked(HWIO_AGGRE_NOC_A2NOC_DCD_WEST_MAXDIV_LOW_ADDR, HWIO_AGGRE_NOC_A2NOC_DCD_WEST_MAXDIV_LOW_RMSK)
#define HWIO_AGGRE_NOC_A2NOC_DCD_WEST_MAXDIV_LOW_INM(m)      \
        in_dword_masked(HWIO_AGGRE_NOC_A2NOC_DCD_WEST_MAXDIV_LOW_ADDR, m)
#define HWIO_AGGRE_NOC_A2NOC_DCD_WEST_MAXDIV_LOW_OUT(v)      \
        out_dword(HWIO_AGGRE_NOC_A2NOC_DCD_WEST_MAXDIV_LOW_ADDR,v)
#define HWIO_AGGRE_NOC_A2NOC_DCD_WEST_MAXDIV_LOW_OUTM(m,v) \
        out_dword_masked_ns(HWIO_AGGRE_NOC_A2NOC_DCD_WEST_MAXDIV_LOW_ADDR,m,v,HWIO_AGGRE_NOC_A2NOC_DCD_WEST_MAXDIV_LOW_IN)
#define HWIO_AGGRE_NOC_A2NOC_DCD_WEST_MAXDIV_LOW_MAXDIV_BMSK                                                   0x7
#define HWIO_AGGRE_NOC_A2NOC_DCD_WEST_MAXDIV_LOW_MAXDIV_SHFT                                                   0x0
...
#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_LPASS_MAXDIV_LOW_ADDR                                               (AGGRE_NOC_A2NOC_SERVICE_NETWORK_REG_BASE      + 0x0001f208)
#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_LPASS_MAXDIV_LOW_RMSK                                                      0x7
#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_LPASS_MAXDIV_LOW_IN          \
        in_dword_masked(HWIO_AGGRE_NOC_A2NOC_DCD_SF_LPASS_MAXDIV_LOW_ADDR, HWIO_AGGRE_NOC_A2NOC_DCD_SF_LPASS_MAXDIV_LOW_RMSK)
#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_LPASS_MAXDIV_LOW_INM(m)      \
        in_dword_masked(HWIO_AGGRE_NOC_A2NOC_DCD_SF_LPASS_MAXDIV_LOW_ADDR, m)
#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_LPASS_MAXDIV_LOW_OUT(v)      \
        out_dword(HWIO_AGGRE_NOC_A2NOC_DCD_SF_LPASS_MAXDIV_LOW_ADDR,v)
#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_LPASS_MAXDIV_LOW_OUTM(m,v) \
        out_dword_masked_ns(HWIO_AGGRE_NOC_A2NOC_DCD_SF_LPASS_MAXDIV_LOW_ADDR,m,v,HWIO_AGGRE_NOC_A2NOC_DCD_SF_LPASS_MAXDIV_LOW_IN)
#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_LPASS_MAXDIV_LOW_MAXDIV_BMSK                                               0x7
#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_LPASS_MAXDIV_LOW_MAXDIV_SHFT                                               0x0

#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_PCIE3_MAXDIV_LOW_ADDR                                               (AGGRE_NOC_A2NOC_SERVICE_NETWORK_REG_BASE      + 0x0001f288)
#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_PCIE3_MAXDIV_LOW_RMSK                                                      0x7
#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_PCIE3_MAXDIV_LOW_IN          \
        in_dword_masked(HWIO_AGGRE_NOC_A2NOC_DCD_SF_PCIE3_MAXDIV_LOW_ADDR, HWIO_AGGRE_NOC_A2NOC_DCD_SF_PCIE3_MAXDIV_LOW_RMSK)
#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_PCIE3_MAXDIV_LOW_INM(m)      \
        in_dword_masked(HWIO_AGGRE_NOC_A2NOC_DCD_SF_PCIE3_MAXDIV_LOW_ADDR, m)
#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_PCIE3_MAXDIV_LOW_OUT(v)      \
        out_dword(HWIO_AGGRE_NOC_A2NOC_DCD_SF_PCIE3_MAXDIV_LOW_ADDR,v)
#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_PCIE3_MAXDIV_LOW_OUTM(m,v) \
        out_dword_masked_ns(HWIO_AGGRE_NOC_A2NOC_DCD_SF_PCIE3_MAXDIV_LOW_ADDR,m,v,HWIO_AGGRE_NOC_A2NOC_DCD_SF_PCIE3_MAXDIV_LOW_IN)
#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_PCIE3_MAXDIV_LOW_MAXDIV_BMSK                                               0x7
#define HWIO_AGGRE_NOC_A2NOC_DCD_SF_PCIE3_MAXDIV_LOW_MAXDIV_SHFT                                               0x0
...
#define HWIO_SNOC_DCD_EAST_QX_CLK_MAXDIV_LOW_ADDR                                             (SYSTEM_NOC_REG_BASE      + 0x0000d208)
#define HWIO_SNOC_DCD_EAST_QX_CLK_MAXDIV_LOW_RMSK                                                    0x7
#define HWIO_SNOC_DCD_EAST_QX_CLK_MAXDIV_LOW_IN          \
        in_dword_masked(HWIO_SNOC_DCD_EAST_QX_CLK_MAXDIV_LOW_ADDR, HWIO_SNOC_DCD_EAST_QX_CLK_MAXDIV_LOW_RMSK)
#define HWIO_SNOC_DCD_EAST_QX_CLK_MAXDIV_LOW_INM(m)      \
        in_dword_masked(HWIO_SNOC_DCD_EAST_QX_CLK_MAXDIV_LOW_ADDR, m)
#define HWIO_SNOC_DCD_EAST_QX_CLK_MAXDIV_LOW_OUT(v)      \
        out_dword(HWIO_SNOC_DCD_EAST_QX_CLK_MAXDIV_LOW_ADDR,v)
#define HWIO_SNOC_DCD_EAST_QX_CLK_MAXDIV_LOW_OUTM(m,v) \
        out_dword_masked_ns(HWIO_SNOC_DCD_EAST_QX_CLK_MAXDIV_LOW_ADDR,m,v,HWIO_SNOC_DCD_EAST_QX_CLK_MAXDIV_LOW_IN)
#define HWIO_SNOC_DCD_EAST_QX_CLK_MAXDIV_LOW_MAXDIV_BMSK                                             0x7
#define HWIO_SNOC_DCD_EAST_QX_CLK_MAXDIV_LOW_MAXDIV_SHFT                                             0x0
