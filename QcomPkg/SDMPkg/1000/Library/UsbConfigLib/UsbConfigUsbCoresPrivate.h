...
// TI RUMI Phy Base Address for primary, sec and MP controllers
#define TI_Base_PRIM       (0x0A720000)   /*to be changed with release*/
#define TI_Base_SEC        (0x0A920000)   /*to be changed with release*/
#define TI_Base_MP(PhyNum) ((PhyNum == 0)?0x0A520000:0x0A522000)
...
// TBD - Check if we need anymore functions for MP core
/**
Performs initialization common to host and device mode on a Synopsys
super speed USB Multi Port core.
