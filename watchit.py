...
build_files_sha1=[["buildex.py", "0615f2e05896886346020b0761877309c786ef5c", True]]

if (platform.system().lower() == "linux"):
  # folder_files_sha structure, <Folder Name>, <Hash>, <Mandatory Existance>
  folder_files_sha=[["boot_images/QcomPkg/Include/Protocol", "fa559a68a71e7a53e8d566a018ba50a6711ec30f", True]]
else:
  # folder_files_sha structure, <Folder Name>, <Hash>, <Mandatory Existance>
  folder_files_sha=[["boot_images/QcomPkg/Include/Protocol", "d4db96fd6d09fb3d15a834dec9c4fe9326c190a7", True]]
