...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 05/22/18   mt      Added check for PXE boot based on uefiplat parameter and NV variable
 02/05/18   prema   Changes to initialize OsIndicationsSupported and OsIndications
