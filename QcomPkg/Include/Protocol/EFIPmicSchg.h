...
--------   ---     -----------------------------------------------------------
02/01/18   mr      Added flag for S/w Role select in .cfg file
11/09/17   pbitra  Added DISABLEBATTERY and BatteryUnlockTime varaibles
...
typedef struct
{
  ...
  /**< For Debug mode: If this variable is set, do not use the presence of the battery 
       to determine if the system should automatically boot or remain powered on */

  UINT32  BatteryUnlockTime;
  /**< Time to wait until the battery unlocks */  

  BOOLEAN SWRoleSelectEnable;
  /**< For VBUS reverse Voltage WA. 0: TypeC Dual Role, 1: UFP/DFP (Conditional) */
