...
Copyright 2013-2018 by Qualcomm Technologies Incorporated.  All Rights Reserved.
============================================================================*/
/*===========================================================================
...
/**
 * @brief This function will enable secure WDT
 *
 * @param[in]
 *   None
 *
 ...
 *
 */
void boot_qsee_enable_secure_wdt(uint32 * time)
{

    boot_tzt_result_regs_t result;

    boot_fastcall_tz(XBL_SEC_SET_WDT_ID,
                     XBL_SEC_SET_WDT_ID_PARAM_ID,
                     *time,
                     0,0,0, &result);
}
