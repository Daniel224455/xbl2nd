...
#define NUM_GPII                     6
#else
#define MAX_NUM_GPII_PER_QUP         13
#define NUM_GPII                     MAX_NUM_QUP_BLOCKS*MAX_NUM_GPII_PER_QUP
#endif

#define QUPV3_HW_VERSION             0x10000000
#define NUM_RINGS_PER_GPII           2
#define NUM_EVT_RINGS_PER_GPII       1
#define NUM_GPI_EVT_RING_ELEM        NUM_RINGS_PER_GPII*MAX_NUM_GPI_RING_ELEM
