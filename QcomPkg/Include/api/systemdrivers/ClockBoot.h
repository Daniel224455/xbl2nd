...
/**
@brief List of PCIE clocks that the XBL Loader clock driver supports.
*/
typedef enum
{
   CLK_PCIE0,
   ...
   CLK_PCIE3,
   CLK_PCIE_NUM_CLKS,
   CLK_PCIE_NONE = CLK_PCIE_NUM_CLKS,
} ClockPCIEType;
...
/*!
    ...
    @param
      eClock           - PCIE interface to configure
...
** ======================================================================*/
/*
    Description: Enable UFS_2 card clocks, and set it to certain performance levels
