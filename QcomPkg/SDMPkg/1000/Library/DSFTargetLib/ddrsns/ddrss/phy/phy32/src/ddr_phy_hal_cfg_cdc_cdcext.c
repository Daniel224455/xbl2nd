...
{  
  fine_delay = (fine_delay < WRITE_FINE_CDC_MIN) ? WRITE_FINE_CDC_MIN : fine_delay;
  fine_delay = (fine_delay > WRITE_FINE_CDC_MAX) ? WRITE_FINE_CDC_MAX : fine_delay;
...
uint16  DDR_PHY_hal_wr_io_dqsdcc_get_CSR (uint32 _inst_, uint8 rank,uint8 prfs_x)
{
    uint16 dcc_val = 0;
    if(rank==0)    
    {
        switch  (prfs_x)
        {
            case 0 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_0_CTL_CFG, PADDCC_ADJ_DQS); break;}
            case 1 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_1_CTL_CFG, PADDCC_ADJ_DQS); break;}
            case 2 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_2_CTL_CFG, PADDCC_ADJ_DQS); break;}
            case 3 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_3_CTL_CFG, PADDCC_ADJ_DQS); break;}
            case 4 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_4_CTL_CFG, PADDCC_ADJ_DQS); break;}
            case 5 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_5_CTL_CFG, PADDCC_ADJ_DQS); break;}
            case 6 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_6_CTL_CFG, PADDCC_ADJ_DQS); break;}
            case 7 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_7_CTL_CFG, PADDCC_ADJ_DQS); break;}
        }
    }
    else
    {  
        switch  (prfs_x)
        {
            case 0 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_0_CTL_CFG, PADDCC_ADJ_DQS_R1); break;}
            case 1 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_1_CTL_CFG, PADDCC_ADJ_DQS_R1); break;}
            case 2 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_2_CTL_CFG, PADDCC_ADJ_DQS_R1); break;}
            case 3 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_3_CTL_CFG, PADDCC_ADJ_DQS_R1); break;}
            case 4 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_4_CTL_CFG, PADDCC_ADJ_DQS_R1); break;}
            case 5 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_5_CTL_CFG, PADDCC_ADJ_DQS_R1); break;}
            case 6 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_6_CTL_CFG, PADDCC_ADJ_DQS_R1); break;}
            case 7 :{dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_PADDCC_7_CTL_CFG, PADDCC_ADJ_DQS_R1); break;}
        }
    }
    return(dcc_val);
}  
...
{
	HWIO_OUTXF2(_inst_, DDR_PHY_DDRPHY_DCC_TOP_4_CFG,IO_SW_OVRRD_UPDT_INT_CLK_CGC_EN,CM_SW_OVRRD_UPDT_INT_CLK_CGC_EN,1,1);
	HWIO_OUTXF2(_inst_, DDR_PHY_DDRPHY_DCC_TOP_4_CFG,IO_SW_OVRRD_UPDT_INT_CLK_CGC_EN_SEL, CM_SW_OVRRD_UPDT_INT_CLK_CGC_EN_SEL,1,1);
	HWIO_OUTXF (_inst_, DDR_PHY_DDRPHY_DCC_TOP_4_CFG, PAD_DCC_DQS_LAT_EN, 1);
        seq_wait(20, US);
	if(rank==0)    
    {
		HWIO_OUTXF (_inst_, DDR_PHY_DDRPHY_DCC_PAD_ADJ_CTL_CFG, PADDCC_ADJ_DQS, dcc_adj);
        switch  (prfs_x)
        {
    ...
    {  
		HWIO_OUTXF (_inst_, DDR_PHY_DDRPHY_DCC_PAD_ADJ_CTL_CFG, PADDCC_ADJ_DQS_R1, dcc_adj);
        switch  (prfs_x)
        {
	...
	HWIO_OUTXF2(_inst_, DDR_PHY_DDRPHY_DCC_TOP_4_CFG,IO_SW_OVRRD_UPDT_INT_CLK_CGC_EN_SEL, CM_SW_OVRRD_UPDT_INT_CLK_CGC_EN_SEL,0,0);
	HWIO_OUTXF2(_inst_, DDR_PHY_DDRPHY_DCC_TOP_4_CFG,IO_SW_OVRRD_UPDT_INT_CLK_CGC_EN,CM_SW_OVRRD_UPDT_INT_CLK_CGC_EN,0,0);
}  


uint16  DDR_PHY_hal_wr_t90_dq_dcc_get_CSR (uint32 _inst_, uint8 prfs_x)
{
    uint16 dcc_val = 0;
	
    switch  (prfs_x)
    {
        case 0 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_0_CTL_CFG, CMDCC_ADJ_WR); break;
        case 1 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_1_CTL_CFG, CMDCC_ADJ_WR); break;
        case 2 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_2_CTL_CFG, CMDCC_ADJ_WR); break;
        case 3 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_3_CTL_CFG, CMDCC_ADJ_WR); break;
        case 4 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_4_CTL_CFG, CMDCC_ADJ_WR); break;
        case 5 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_5_CTL_CFG, CMDCC_ADJ_WR); break;
        case 6 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_6_CTL_CFG, CMDCC_ADJ_WR); break;
        case 7 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_7_CTL_CFG, CMDCC_ADJ_WR); break;
    }
    return(dcc_val);
...
uint16  DDR_PHY_hal_wr_wrlvl_dcc_get_CSR (uint32 _inst_, uint8 prfs_x)
{
    uint16 dcc_val = 0;
	
    switch  (prfs_x)
    {
        case 0 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_0_CTL_CFG, CMDCC_ADJ_WRLVL); break;
        case 1 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_1_CTL_CFG, CMDCC_ADJ_WRLVL); break;
        case 2 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_2_CTL_CFG, CMDCC_ADJ_WRLVL); break;
        case 3 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_3_CTL_CFG, CMDCC_ADJ_WRLVL); break;
        case 4 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_4_CTL_CFG, CMDCC_ADJ_WRLVL); break;
        case 5 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_5_CTL_CFG, CMDCC_ADJ_WRLVL); break;
        case 6 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_6_CTL_CFG, CMDCC_ADJ_WRLVL); break;
        case 7 :   dcc_val = HWIO_INXF(_inst_, DDR_PHY_DDRPHY_DCCEXT_CMDCC_7_CTL_CFG, CMDCC_ADJ_WRLVL); break;
    }
    return(dcc_val);
...
void Get_LUT_band_DDRCC (uint32 _inst_,  uint32 *DDRCC_prfs_indx_fmax)
{
    //uint8 prfs_indx = 6;
    uint32 PRFSLUT0 =0;
    uint32 PRFSLUT1 =0;
