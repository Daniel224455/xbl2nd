...
} Clock_RD_MMSS_ClockCfg[] =
{
  ...
  {"disp_cc_mdss_pclk0_clk", HWIO_ADDR(DISP_CC_MDSS_PCLK0_CBCR), 
    262500, {HWIO_ADDR(DISP_CC_MDSS_PCLK0_CMD_RCGR), 0, MUX_DISP, SRC_EXT1, 0, 0, 0, 0}},
  {"disp_cc_mdss_byte0_clk", HWIO_ADDR(DISP_CC_MDSS_BYTE0_CBCR), 
    262500, {HWIO_ADDR(DISP_CC_MDSS_BYTE0_CMD_RCGR), 0, MUX_DISP, SRC_EXT1, 0, 0, 0, 0}},
  ...
  {"disp_cc_mdss_pclk1_clk", HWIO_ADDR(DISP_CC_MDSS_PCLK1_CBCR), 
    262500, {HWIO_ADDR(DISP_CC_MDSS_PCLK1_CMD_RCGR), 0, MUX_DISP, SRC_EXT1, 0, 0, 0, 0}},
  {"disp_cc_mdss_byte1_clk", HWIO_ADDR(DISP_CC_MDSS_BYTE1_CBCR), 
    262500, {HWIO_ADDR(DISP_CC_MDSS_BYTE1_CMD_RCGR), 0, MUX_DISP, SRC_EXT1, 0, 0, 0, 0}},
  ...
  {"gcc_disp_axi_clk", HWIO_ADDR(GCC_DISP_AXI_CBCR), 
    200000, {HWIO_ADDR(GCC_MMNOC_HF_QX_CMD_RCGR), 0, MUX_GCC, SRC_GPLL0, DIV(3), 0, 0, 0}},
  ...
  {"disp_cc_mdss_mdp_clk", HWIO_ADDR(DISP_CC_MDSS_MDP_CBCR),
    412500, {HWIO_ADDR(DISP_CC_MDSS_MDP_CMD_RCGR), 0, MUX_DISP, SRC_DISP_PLL0, DIV(1), 0, 0, 0}}, 
  ...
  {"gcc_mmnoc_sf_qx_clk", HWIO_ADDR(GCC_MMNOC_SF_QX_CBCR), 
    200000, {HWIO_ADDR(GCC_MMNOC_SF_QX_CMD_RCGR), 0, MUX_GCC, SRC_GPLL0, DIV(3), 0, 0, 0}},
