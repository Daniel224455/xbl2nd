...
*
**************************************************************************************************************/
MDP_Status ExtDisp_GetModeInfo(MDP_Display_IDType eDisplayId, uint32 uModeIndex, MDP_Panel_AttrType *pModeInfo)
{  
  MDP_Status          eStatus       = MDP_STATUS_OK;  
  ...
  { 
    case PCD_EXTERNAL_DISPLAY_DP:
      eStatus = DPDriver_GetModeInfo(eDisplayId, uModeIndex, pModeInfo);      
      break;
...
*
**************************************************************************************************************/
MDP_Status ExtDisp_SetMode(MDP_Display_IDType eDisplayId, uint32 uModeIndex)
{
  MDP_Status  eStatus = MDP_STATUS_OK;  
  ...
  { 
    case PCD_EXTERNAL_DISPLAY_DP:
      eStatus = DPDriver_SetMode(eDisplayId, uModeIndex);
      break;
