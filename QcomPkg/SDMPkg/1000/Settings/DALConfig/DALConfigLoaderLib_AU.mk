...
XML_DEPS = $(WORKSPACE)/QcomPkg/SDMPkg/Settings/DALSystem/$(MACRO_NAME)/dalsystem_$(MACRO_NAME).xml \
           ...
           $(WORKSPACE)/QcomPkg/SDMPkg/1000/Settings/PMIC/AU/pm_config_target_loader.xml \
           ...
           $(WORKSPACE)/QcomPkg/SDMPkg/Settings/UFS/ufs_config_au.xml \
...
INC = @$(MODULE_BUILD_DIR)/../DALGenLibLoader_AU/OUTPUT/inc_list.qti
...
CALLING_MAKE_FILE = $(WORKSPACE)/QcomPkg/SDMPkg/1000/Settings/DALConfig/DALConfigLoaderLib_AU.mk
