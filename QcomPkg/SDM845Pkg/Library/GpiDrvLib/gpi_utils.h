 ...
 * @param[out]
 */
uint32 nbr_avail_ring_elem(gpii_info *gpii, uint8 chan, ptr_type base,
                           ptr_type wp, ptr_type rp, ptr_type size);
 ...
 */
ptr_type get_ring_ptr(gpii_info *gpii, uint8 chan,
