...
#define RSCC_RSC_REG_BASE_USED                                                                                  0x254c
...
#define HWIO_TCSm_CMDn_DRV0_READ_RESPONSE_DATA_MAXm                                                                      3
...
#define DISPLAY_PDC_REG_BASE                                                                        (AOSS_BASE      + 0x00290000)
...
#define DISPLAY_PDC_SEQ_MEM_REG_BASE                                    (AOSS_BASE      + 0x00490000)
