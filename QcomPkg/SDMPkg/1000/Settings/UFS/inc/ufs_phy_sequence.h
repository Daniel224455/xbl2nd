...
----------   ---     ----------------------------------------------------------  
2021-06-21   bb      HS-G4 PHY updates and G4 Init fix after G3 init 
2019-05-14   jt      Poipu updates
...
static struct ufs_mphy_init_item ufs_bsp_mphy_init_table[] = {
   ...
   { CONDITIONAL_FLAG(RATE_A, 0, 0), 
           HWIO_UFS_MEM_QSERDES_COM_VCO_TUNE_MAP_OFFS,                  0x02},
   { CONDITIONAL_FLAG(RATE_B, 0, 0),
   ...
   { CONDITIONAL_FLAG(0, 0, CONTROLLER_VER_4_0), 
           HWIO_UFS_MEM_QSERDES_TX0_LANE_MODE_1_OFFS,                   0x05}, 
   { CONDITIONAL_FLAG(0, HS_G4, CONTROLLER_VER_4_1), 
           HWIO_UFS_MEM_QSERDES_TX0_LANE_MODE_1_OFFS,                   0x75}, 
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR, CONTROLLER_VER_4_1), 
   ...
   { CONDITIONAL_FLAG(0, 0, CONTROLLER_VER_4_0), 
           HWIO_UFS_MEM_QSERDES_RX0_UCDR_SO_SATURATION_AND_ENABLE_OFFS, 0x4B},
   { CONDITIONAL_FLAG(0, 0, CONTROLLER_VER_4_1),
           HWIO_UFS_MEM_QSERDES_RX0_UCDR_SO_SATURATION_AND_ENABLE_OFFS, 0x5A},
   { 0x00, HWIO_UFS_MEM_QSERDES_RX0_UCDR_PI_CONTROLS_OFFS,              0xF1},
   { 0x00, HWIO_UFS_MEM_QSERDES_RX0_UCDR_FASTLOCK_COUNT_LOW_OFFS,       0x80},
   { CONDITIONAL_FLAG(0, HS_G4, 0),
           HWIO_UFS_MEM_QSERDES_RX0_UCDR_PI_CTRL2_OFFS,                 0x81},
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR, 0),
           HWIO_UFS_MEM_QSERDES_RX0_UCDR_PI_CTRL2_OFFS,                 0x80},
   { CONDITIONAL_FLAG(0, 0, CONTROLLER_VER_4_0),
           HWIO_UFS_MEM_QSERDES_RX0_UCDR_FO_GAIN_OFFS,                  0x0C},
   { CONDITIONAL_FLAG(0, 0, CONTROLLER_VER_4_1),
           HWIO_UFS_MEM_QSERDES_RX0_UCDR_FO_GAIN_OFFS,                  0x0E},
   ...
   { 0x00, HWIO_UFS_MEM_QSERDES_RX0_RX_EQU_ADAPTOR_CNTRL2_OFFS,         0x06},
   { 0x00, HWIO_UFS_MEM_QSERDES_RX0_RX_EQU_ADAPTOR_CNTRL3_OFFS,         0x04},
   { 0x00, HWIO_UFS_MEM_QSERDES_RX0_RX_EQU_ADAPTOR_CNTRL4_OFFS,         0x1D},
   ...
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR, CONTROLLER_VER_4_0), 
         HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_LOW_OFFS,                  0x36},
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR, CONTROLLER_VER_4_1),
         HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_LOW_OFFS,                  0x6D},
   { CONDITIONAL_FLAG(0, HS_G4, 0),
        HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_HIGH_OFFS,                  0xFF}, 
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR, CONTROLLER_VER_4_0), 
        HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_HIGH_OFFS,                  0x36}, 
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR, CONTROLLER_VER_4_1),
        HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_HIGH_OFFS,                  0x6D}, 
   { CONDITIONAL_FLAG(0, HS_G4, 0), 
        HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_HIGH2_OFFS,                 0xFF},
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR, CONTROLLER_VER_4_0), 
        HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_HIGH2_OFFS,                 0xF6},
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR, CONTROLLER_VER_4_1),
   ...
   { CONDITIONAL_FLAG(0, HS_G4, CONTROLLER_VER_4_0),
        HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_HIGH4_OFFS,                 0x6D},
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR, CONTROLLER_VER_4_0), 
        HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_HIGH4_OFFS,                 0x3D},
   { CONDITIONAL_FLAG(0, HS_G4, CONTROLLER_VER_4_1),
        HWIO_UFS_MEM_QSERDES_RX0_RX_MODE_00_HIGH4_OFFS,                 0x3E},
   { CONDITIONAL_FLAG(0, DEFAULT_GEAR, CONTROLLER_VER_4_1),
   ...
   { CONDITIONAL_FLAG(0, 0, CONTROLLER_VER_4_0), 
           HWIO_UFS_MEM_QSERDES_RX0_AC_JTAG_ENABLE_OFFS,                0x01}, 
   { CONDITIONAL_FLAG(0, 0, CONTROLLER_VER_4_0), 
           HWIO_UFS_MEM_QSERDES_RX0_AC_JTAG_MODE_OFFS,                  0x01},  
   { CONDITIONAL_FLAG(0, HS_G4, CONTROLLER_VER_4_1),
           HWIO_UFS_MEM_QSERDES_RX0_GM_CAL_OFFS,                        0x11},
   { STOP_CONDITION, 0,0}};
...
static struct ufs_mphy_init_item ufs_bsp_mphy_2_lane_init_table[] = {
     ...
     { CONDITIONAL_FLAG(0, 0, CONTROLLER_VER_4_0),
             HWIO_UFS_MEM_QSERDES_TX1_LANE_MODE_1_OFFS,                       0x05},
     { CONDITIONAL_FLAG(0, HS_G4, CONTROLLER_VER_4_1),
             HWIO_UFS_MEM_QSERDES_TX1_LANE_MODE_1_OFFS,                       0x75},
     { CONDITIONAL_FLAG(0, DEFAULT_GEAR, CONTROLLER_VER_4_1),
     ...
     { CONDITIONAL_FLAG(0, 0, CONTROLLER_VER_4_0),
             HWIO_UFS_MEM_QSERDES_RX1_UCDR_SO_SATURATION_AND_ENABLE_OFFS,     0x4B},
     { CONDITIONAL_FLAG(0, 0, CONTROLLER_VER_4_1),
             HWIO_UFS_MEM_QSERDES_RX1_UCDR_SO_SATURATION_AND_ENABLE_OFFS,     0x5A},
     ...
     { CONDITIONAL_FLAG(0, 0, CONTROLLER_VER_4_0),
             HWIO_UFS_MEM_QSERDES_RX1_UCDR_FO_GAIN_OFFS,                      0x0C}, 
     { CONDITIONAL_FLAG(0, 0, CONTROLLER_VER_4_1),
             HWIO_UFS_MEM_QSERDES_RX1_UCDR_FO_GAIN_OFFS,                      0x0E},
     ...
     { 0x00, HWIO_UFS_MEM_QSERDES_RX1_RX_EQU_ADAPTOR_CNTRL2_OFFS,             0x06},
     { 0x00, HWIO_UFS_MEM_QSERDES_RX1_RX_EQU_ADAPTOR_CNTRL3_OFFS,             0x04},
     { 0x00, HWIO_UFS_MEM_QSERDES_RX1_RX_EQU_ADAPTOR_CNTRL4_OFFS,             0x1D},
     ...
     { CONDITIONAL_FLAG(0, HS_G4, CONTROLLER_VER_4_0),
             HWIO_UFS_MEM_QSERDES_RX1_RX_MODE_00_HIGH4_OFFS,                  0x6D},
     { CONDITIONAL_FLAG(0, DEFAULT_GEAR, CONTROLLER_VER_4_0), 
             HWIO_UFS_MEM_QSERDES_RX1_RX_MODE_00_HIGH4_OFFS,                  0x3D},
     { CONDITIONAL_FLAG(0, HS_G4, CONTROLLER_VER_4_1),
             HWIO_UFS_MEM_QSERDES_RX1_RX_MODE_00_HIGH4_OFFS,                  0x3E},
     { CONDITIONAL_FLAG(0, DEFAULT_GEAR, CONTROLLER_VER_4_1),
     ...
     { CONDITIONAL_FLAG(0, 0, CONTROLLER_VER_4_0), 
             HWIO_UFS_MEM_QSERDES_RX1_AC_JTAG_ENABLE_OFFS,                    0x01},
     { CONDITIONAL_FLAG(0, 0, CONTROLLER_VER_4_0),
             HWIO_UFS_MEM_QSERDES_RX1_AC_JTAG_MODE_OFFS,                      0x01},
     { CONDITIONAL_FLAG(0, HS_G4, CONTROLLER_VER_4_1),
             HWIO_UFS_MEM_QSERDES_RX1_GM_CAL_OFFS,                            0x11},
