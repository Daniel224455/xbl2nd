/** @file AppCmds.c
  ...
  Copyright 2012 - 2018 Qualcomm Technologies, Inc.  All Rights Reserved.
...
/*=============================================================================
 ...
 14/03/18   mt      Add ToggleEnableMemMap
 02/07/18   dc      Update DISABLEBATTERY UEFI Variable Attribute for Runtime Access
 ...
 11/14/17   dc      Add Toggle DISABLEBATTERY UEFI Variable through BDS MENU
 10/25/17   pm      Removed support to set UsbHLOSPortRole value
...
/*
 * Handler for ToggleForceQcUsbFnHlos Command
 */
...
/*
 * Handler for EnableHSUsbforDP Command
 */
EFI_STATUS
...
ToggleDISABLEBATTERY (CHAR8* Arg)
{
  ...
  if (Flag == 0 && bVariablePresent == TRUE)
  {
    //Request Clear the UEFI Variable and the flag is currently exist
    VarSize = 0; //Set the size to 0 to clear the flag
  ...
  else if (Flag != 0 && bVariablePresent == FALSE)
  {
