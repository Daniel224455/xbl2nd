...
CPR_CONFIG_DIR = $(SILICON_PATH)/QcomPkg/SDMPkg/$(CHIP_ID)/Settings/CPR/$(VAR)
...
INC =  \
    ...
    -I$(SILICON_PATH)/QcomPkg/SDMPkg/$(CHIP_ID)/Settings/CPR/$(VAR) \
...
$(OUTPUT_DIR)/image/core/target/$(TARGET_ID)/cpr_image_target_init.obj : $(SILICON_PATH)/QcomPkg/SDMPkg/$(CHIP_ID)/Library/CPRTargetLib/image/core/target/$(TARGET_ID)/cpr_image_target_init_au.c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(SILICON_PATH)/QcomPkg/SDMPkg/$(CHIP_ID)/Library/CPRTargetLib/image/core/target/$(TARGET_ID)/cpr_image_target_init_au.c
