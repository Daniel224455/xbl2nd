...
{  //  PMC1000#1             PM855B#1           PM855L/A/P         PM8002              PMC1000#2           PM855B#2                   
   {PON_WARM_RST,      PON_NO_CFG_NEEDED,  PON_NO_CFG_NEEDED,  PON_NO_CFG_NEEDED,  PON_NO_CFG_NEEDED,  PON_NO_CFG_NEEDED, PON_NO_CFG_NEEDED}, //Warm Reset @mapped to hard reset for bringup WA
...
{  //PMC1000#1  PM855B#1 PM855L/A/P  PM8002  PMC1000#2  PM855B#2  
   { 1,            1,      0,          0,       0,        1,        0},    //KPDPWR_N
   { 1,            1,      0,          0,       0,        1,        0},    //RESIN_N
   { 1,            1,      0,          0,       0,        1,        0},    //KPDPWR_AND_RESIN
   { 1,            1,      0,          0,       0,        1,        0}     //KPDPWR_OR_RESIN
};
