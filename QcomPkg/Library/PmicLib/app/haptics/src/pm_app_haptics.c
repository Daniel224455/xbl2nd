...
--------   ---     ---------------------------------------------------------- 
01/08/19   xmp     Return PM_ERR_FLAG_FAILURE if pm_app_haptics_vib_ctrl is called before driver init
...
pm_app_haptics_vib_ctrl(pm_on_off_type state) 
{
  ...
  {
    // This API should be called after pm_driver_init.
    // Return failure error code if it was called in early stage
