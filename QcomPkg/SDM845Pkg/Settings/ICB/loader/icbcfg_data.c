...
$Header: //components/rel/boot.xf/2.2/QcomPkg/SDM845Pkg/Settings/ICB/loader/icbcfg_data.c#3 $ 
$DateTime: 2018/01/24 02:33:03 $
$Author: pwbldsvc $
$Change: 15307627 $ 

When        Who    What, where, why
----------  ---    -----------------------------------------------------------
2018/01/19  sds    WP specific TCU overrides
...
icbcfg_data_type icbcfg_boot_data_sdm845_v1[] = 
{
  ...
  /* Force IC=0, OC=1, CACHED hint set for RD/WR. */
  ICBCFG_HWIO_DW(MEMNOC_TCU_DYN_ATTR_ADDRMSBVAL_LOW, 0x1), /**< IC=0, OC=1 */
  ICBCFG_HWIO_DW(MEMNOC_TCU_DYN_ATTR_ADDRMSBOV_LOW,  0x3), 
  ICBCFG_HWIO_DW(MEMNOC_TCU_DYN_ATTR_ALLOC_LOW, 0x101), /* CACHE hint for RD/WR */
  ICBCFG_HWIOF_DW(MEMNOC_TCU_DYN_ATTR_MAINCTL_LOW, ALLOCRDOV, 0x1),
  ICBCFG_HWIOF_DW(MEMNOC_TCU_DYN_ATTR_MAINCTL_LOW, ALLOCWROV, 0x1),
