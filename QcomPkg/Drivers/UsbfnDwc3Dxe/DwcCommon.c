...
#define USB3_VER_TYPE_EA      (0x65613036)
      ...
      if ( (DWC_HWIO_IN(Dev->CoreBaseAddr, VER_NUMBER) == USB3_VER_NUMBER_170A)
        || (DWC_HWIO_IN(Dev->CoreBaseAddr, VER_TYPE) == USB3_VER_TYPE_EA) )
      {
        ...
        {
          print_oncer=0;
          TraceErr(CommonEvent, "UEFI AXI reordering");
        }
        DWC_PLAT_DELAY(1000);
      }
