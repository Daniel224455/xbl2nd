...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 03/20/18   pbitra  Added EFI_QCOM_CHARGER_ACTION_RESET_COLD
 11/09/17   pbitra  Added PowerKeypress variable to charger action info structure
 10/16/17   pbitra  Added support for SmartChargerDxe for CLS platform
...
#define EFI_QCOM_CHARGER_PROTOCOL_GUID \
  ...
  /** @ingroup efi_qcomcharger_protocol */
#define EFI_SMART_CHARGER_PROTOCOL_GUID \
  { 0x8BC91B42, 0x0D26, 0x4892, { 0x97, 0x02, 0x1C, 0x9F, 0xBB, 0x36, 0xAA, 0x43 } }
...
extern EFI_GUID gSmartChargerProtocolGuid;
