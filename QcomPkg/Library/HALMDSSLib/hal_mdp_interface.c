                                                          ...
                                                          uint32                                     uSetupFlags)
{
  ...
  if(pDualInterfaceConfig->bEnableDualInterface)
  {
    if (HAL_MDP_INTERFACE_MODE_VIDEO == pDualInterfaceConfig->eInterfaceMode )
    {
      ...
      uSplitCTRLVal = HWIO_OUT_FLD(uSplitCTRLVal,MDP_SPLIT_DISPLAY_UPPER_PIPE_CTRL, INTF_1_SW_TRG_MUX,    ((HAL_MDP_FLAGS_DSI_1_MASTER & uSetupFlags) ? 0x0 : 0x1));
      uSplitCTRLVal = HWIO_OUT_FLD(uSplitCTRLVal,MDP_SPLIT_DISPLAY_UPPER_PIPE_CTRL, INTF_2_SW_TRG_MUX,    ((HAL_MDP_FLAGS_DSI_1_MASTER & uSetupFlags) ? 0x1 : 0x0));
      ...
      uSplitCTRLVal = HWIO_OUT_FLD(uSplitCTRLVal,MDP_SPLIT_DISPLAY_LOWER_PIPE_CTRL, INTF_1_TIM_GEN_SYNC_MODE,   ((HAL_MDP_FLAGS_DSI_1_MASTER & uSetupFlags) ? 0x1 : 0x0));
      uSplitCTRLVal = HWIO_OUT_FLD(uSplitCTRLVal,MDP_SPLIT_DISPLAY_LOWER_PIPE_CTRL, INTF_2_TIM_GEN_SYNC_MODE,   ((HAL_MDP_FLAGS_DSI_1_MASTER & uSetupFlags) ? 0x0 : 0x1));
