...
**  Function :  boot_flash_trans_sdcc_write
...
*
* @brief
*   Function to copy a region of data from the destination address to
*   a logical byte address.
*
* @param[in] trans_if Pointer to the translation interface
* @param[in] dest_addr Destination address
* @param[in] byte_offset Logical source byte address
...
*
*/
static boolean boot_flash_trans_sdcc_write
(
  flash_trans_if_type *trans_if,  /* Pointer to the translation interface */
  void   *dest_addr,              /* Destination address */
  uint32  byte_offset,            /* Logical source byte address */
...
)
{
  ...
  if ( size>0 )
  {
	/* Call the boot sdcc write function. */
	status = dev_sdcc_write_bytes ( dest_addr,
	                                byte_offset,
									size,
									GEN_IMG);
  }
...
)
{
  ...
  static boot_flash_trans_vtbl_type vtbl =
  {
    ...
    NULL,                                        /* read_appsimage */
	boot_flash_trans_sdcc_write                  /* write */
  };
