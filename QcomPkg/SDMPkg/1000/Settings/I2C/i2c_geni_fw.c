...
DESCRIPTION: I2C GENI FW
                      ...
                      Copyright (c) 2017-18 Qualcomm Technologies, Incorporated.
                                        All rights reserved.
...
--------   ---     --------------------------------------------------------
12/13/17   UNR     Created for Hana
11/28/18   bng     Updated for new QUP hw version for Hana
==================================================================================================*/
...
uint8  __attribute__ ((aligned (4))) qup_v1_3_i2c_fw[] =
{
    0x53, 0x45, 0x46, 0x57, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x10, 0x03, 0x00, 0x03, 0x01, 
    0x04, 0x00, 0x2f, 0x01, 0x1c, 0x00, 0x42, 0x00, 0xe0, 0x05, 0xd8, 0x04, 0xde, 0x00, 0x00, 0x00, 
...
uint8  __attribute__ ((aligned (4))) qup_v1_2_i2c_fw[] =
{
    0x53, 0x45, 0x46, 0x57, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x10, 0x03, 0x00, 0x3c, 0x00, 
...
i2c_status i2c_get_fw (uint8 **base_ptr, uint32 version)
{
   ...
   {
      *base_ptr = qup_v1_2_i2c_fw;
   }
   else if (version == 0x10030000)
   {
      *base_ptr = qup_v1_3_i2c_fw;
   }
   else
   {
