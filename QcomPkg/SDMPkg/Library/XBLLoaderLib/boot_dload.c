...
/* this variable is used in ramdump path instead of relying on shared imem value */
uint32 boot_shared_uefi_ram_dump_magic = 0xFF;
/*=============================================================================
...
/*===========================================================================
**  Function :  boot_dload_set_rawdump_cookie
** ==========================================================================
*/
/*!
* 
* @brief
*   Set the SBL dload mode cookie for rawdump
**        
* @par Dependencies
*  None
*   
*/
void boot_dload_set_rawdump_cookie()
{
...
**  Function :  boot_set_shared_uefi_ram_dump_magic
...
* 
* @brief
*   This function reads the uefi_ram_dump_magic from the shared imem
*   and updates the shared variable boot_shared_uefi_ram_dump_magic.
*   This value is set during the start of the XBL ramdump path.
* 
* @par Dependencies
*   None
*   
...
void boot_set_shared_uefi_ram_dump_magic()
{
  if(boot_shared_imem_cookie_ptr != NULL)
  {
    boot_shared_uefi_ram_dump_magic = boot_shared_imem_cookie_ptr->uefi_ram_dump_magic;
  }
} /* boot_set_shared_uefi_ram_dump_magic() */

/*=============================================================================

**  Function :  boot_get_shared_uefi_ram_dump_magic
...
* 
* @brief
*   This function returns the value of the shared variable
*   boot_shared_uefi_ram_dump_magic. This avoids relying on shared imem value during the ramdump path.
* 
* @par Dependencies
*   None
*   
...
{
  return boot_shared_uefi_ram_dump_magic;
} /* boot_get_shared_uefi_ram_dump_magic */