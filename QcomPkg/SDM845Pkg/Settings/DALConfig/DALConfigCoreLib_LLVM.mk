...
XML_DEPS = $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/DALSystem/$(MACRO_NAME)/dalsystem_$(MACRO_NAME).xml \
	   ...
	   $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/I2C/$(MACRO_NAME)/i2c_devcfg_Sdm845.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/Clock/ClockChipset.xml \
           $(WORKSPACE)/QcomPkg/Settings/Clock/$(MACRO_NAME)/DalClock.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/HWIO/$(MACRO_NAME)/DalHWIO.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/PMIC/pm_config_target_$(MACRO_NAME).xml \
           ...
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/ADC/internal/core/adc_props.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/ADC/internal/core/vadc_props.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/ADC/internal/core/fgadc_props.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/ICB/core/icbcfg_arb.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/GPI/core/gpi_props.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/BAM/bam_config.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/Qusb/qusb.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/PCIE/core/pcie_props.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/SMMU/iort.xml \
...
$(OUTPUT_DIR)/DALConfigLib.lib : $(OBJECT_FILES)
	"$(SLINK)" -cr $(OUTPUT_DIR)/DALConfigLib.lib $(SLINK_FLAGS) $(OUTPUT_DIR)/DALConfig_$(MACRO_NAME).obj
