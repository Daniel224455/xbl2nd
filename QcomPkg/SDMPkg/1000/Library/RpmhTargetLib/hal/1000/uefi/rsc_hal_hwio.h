...
#define APSS_RSC_RSCC_RSCC_RSC_REG_BASE                                                                              (APSS_HM_POIPU_BASE      + 0x00a00000)
#define APSS_RSC_RSCC_RSCC_RSC_REG_BASE_PHYS                                                                         (APSS_HM_POIPU_BASE_PHYS + 0x00a00000)
...
#define HWIO_APSS_RSC_RSCC_RSC_ID_DRVd_POR                                                                           0x00010700
...
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRVd_MAXd                                                                      2
