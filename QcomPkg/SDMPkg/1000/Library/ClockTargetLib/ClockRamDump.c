...
ClockConfigPLLType plls[] = 
{
  /* disp_cc_pll0_out_main : 1380.0 MHz */
  {
  ...
  /* disp_cc_pll1_out_main : 600.0 MHz */
  {
    .nPLLModeAddr  = HWIO_ADDR(DISP_CC_PLL1_MODE),
    .nPreDiv       = 1,
    .nPostDivOdd   = 0,
    .nPostDivEven  = 2,
    .nL            = 31,
...
} Clock_RD_MMSS_ClockCfg[] =
{
  {"disp_cc_mdss_esc0_clk", HWIO_ADDR(DISP_CC_MDSS_ESC0_CBCR),
   19200, {HWIO_ADDR(DISP_CC_MDSS_ESC0_CMD_RCGR), 0, MUX_DISP, SRC_CXO, DIV(1.0), 0, 0, 0}},
  {"disp_cc_mdss_ahb_clk", HWIO_ADDR(DISP_CC_MDSS_AHB_CBCR),
   75000, {HWIO_ADDR(DISP_CC_MDSS_AHB_CMD_RCGR), 0, MUX_DISP, SRC_DISP_PLL1, DIV(8.0), 0, 0, 0}},
  {"disp_cc_mdss_pclk0_clk", HWIO_ADDR(DISP_CC_MDSS_PCLK0_CBCR),
   262500, {HWIO_ADDR(DISP_CC_MDSS_PCLK0_CMD_RCGR), 0, MUX_DISP, SRC_EXT1, DIV(1), 0, 0, 0}},
  {"disp_cc_mdss_byte0_intf_clk", HWIO_ADDR(DISP_CC_MDSS_BYTE0_INTF_CBCR),
   262500, {HWIO_ADDR(DISP_CC_MDSS_BYTE0_CMD_RCGR), 0, MUX_DISP, SRC_EXT1, DIV(1), 0, 0, 0}},
  {"disp_cc_mdss_rot_clk", HWIO_ADDR(DISP_CC_MDSS_ROT_CBCR),
   19200, {HWIO_ADDR(DISP_CC_MDSS_ROT_CMD_RCGR), 0, MUX_DISP, SRC_CXO, DIV(1.0), 0, 0, 0}},
  {"gcc_disp_hf_axi_clk", HWIO_ADDR(GCC_DISP_HF_AXI_CBCR),
   240000, {HWIO_ADDR(GCC_MMNOC_HF_QX_CMD_RCGR), 0, MUX_GCC, SRC_GPLL0, DIV(2.5), 0, 0, 0}},
  {"disp_cc_mdss_byte0_clk", HWIO_ADDR(DISP_CC_MDSS_BYTE0_CBCR),
   262500, {HWIO_ADDR(DISP_CC_MDSS_BYTE0_CMD_RCGR), 0, MUX_DISP, SRC_EXT1, DIV(1), 0, 0, 0}},
  {"disp_cc_mdss_pclk1_clk", HWIO_ADDR(DISP_CC_MDSS_PCLK1_CBCR),
   262500, {HWIO_ADDR(DISP_CC_MDSS_PCLK1_CMD_RCGR), 0, MUX_DISP, SRC_EXT1, DIV(1), 0, 0, 0}},
  {"disp_cc_xo_clk", HWIO_ADDR(DISP_CC_XO_CBCR),
   19200, {HWIO_ADDR(DISP_CC_XO_CMD_RCGR), 0, MUX_DISP, SRC_CXO, DIV(1.0), 0, 0, 0}},
  {"disp_cc_mdss_byte1_intf_clk", HWIO_ADDR(DISP_CC_MDSS_BYTE1_INTF_CBCR),
   262500, {HWIO_ADDR(DISP_CC_MDSS_BYTE1_CMD_RCGR), 0, MUX_DISP, SRC_EXT1, DIV(1), 0, 0, 0}},
  {"disp_cc_mdss_vsync_clk", HWIO_ADDR(DISP_CC_MDSS_VSYNC_CBCR),
   19200, {HWIO_ADDR(DISP_CC_MDSS_VSYNC_CMD_RCGR), 0, MUX_DISP, SRC_CXO, DIV(1.0), 0, 0, 0}},
  {"disp_cc_mdss_esc1_clk", HWIO_ADDR(DISP_CC_MDSS_ESC1_CBCR),
   19200, {HWIO_ADDR(DISP_CC_MDSS_ESC1_CMD_RCGR), 0, MUX_DISP, SRC_CXO, DIV(1.0), 0, 0, 0}},
  {"gcc_disp_ahb_clk", HWIO_ADDR(GCC_DISP_AHB_CBCR),
   75000, {HWIO_ADDR(GCC_CONFIG_NOC_CMD_RCGR), 0, MUX_GCC, SRC_GPLL0, DIV(8.0), 0, 0, 0}},
  {"disp_cc_mdss_byte1_clk", HWIO_ADDR(DISP_CC_MDSS_BYTE1_CBCR),
   262500, {HWIO_ADDR(DISP_CC_MDSS_BYTE1_CMD_RCGR), 0, MUX_DISP, SRC_EXT1, DIV(1), 0, 0, 0}},
  {"disp_cc_mdss_mdp_clk", HWIO_ADDR(DISP_CC_MDSS_MDP_CBCR),
   345000, {HWIO_ADDR(DISP_CC_MDSS_MDP_CMD_RCGR), 0, MUX_DISP, SRC_DISP_PLL0, DIV(4.0), 0, 0, 0}},
  {"gcc_disp_xo_clk", HWIO_ADDR(GCC_DISP_XO_CBCR),
   19200, {HWIO_ADDR(GCC_XO_CMD_RCGR), 0, MUX_GCC, SRC_CXO, DIV(1.0), 0, 0, 0}},
  {"disp_cc_mdss_edp_aux_clk", HWIO_ADDR(DISP_CC_MDSS_EDP_AUX_CBCR),
   19200, {HWIO_ADDR(DISP_CC_MDSS_EDP_AUX_CMD_RCGR), 0, MUX_DISP, SRC_CXO, DIV(1.0), 0, 0, 0}},
  {"disp_cc_mdss_edp_gtc_clk", HWIO_ADDR(DISP_CC_MDSS_EDP_GTC_CBCR),
   19200, {HWIO_ADDR(DISP_CC_MDSS_EDP_GTC_CMD_RCGR), 0, MUX_DISP, SRC_CXO, DIV(1.0), 0, 0, 0}},
  {"disp_cc_mdss_edp_link_clk", HWIO_ADDR(DISP_CC_MDSS_EDP_LINK_CBCR),
   19200, {HWIO_ADDR(DISP_CC_MDSS_EDP_LINK_CMD_RCGR), 0, MUX_DISP, SRC_CXO, DIV(1.0), 0, 0, 0}},
  {"disp_cc_mdss_edp_link_intf_clk", HWIO_ADDR(DISP_CC_MDSS_EDP_LINK_INTF_CBCR),
   19200, {HWIO_ADDR(DISP_CC_MDSS_EDP_LINK_CMD_RCGR), 0, MUX_DISP, SRC_CXO, DIV(1.0), 0, 0, 0}},
  {"disp_cc_mdss_edp_pixel_clk", HWIO_ADDR(DISP_CC_MDSS_EDP_PIXEL_CBCR),
   19200, {HWIO_ADDR(DISP_CC_MDSS_EDP_PIXEL_CMD_RCGR), 0, MUX_DISP, SRC_CXO, DIV(1.0), 0, 0, 0}},
};


/*=========================================================================
  End autogenerated data from ramdump.py generator
==========================================================================*/
...
static int Clock_RD_InitSources( void )
{
  ...
  if( source_init_complete == FALSE)
  {
    ...
    for( i = 0; i<ARRAY_LEN(plls); i++)
    {
      if( Clock_EnablePLL(&plls[i]) != TRUE) return FALSE;
    }
...
// #define CLK_RD_UNIT_TEST
#ifdef CLK_RD_UNIT_TEST
