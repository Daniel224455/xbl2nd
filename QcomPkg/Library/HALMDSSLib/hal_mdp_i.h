...
typedef struct _HAL_MDP_UBWCConfigInfo
{
  ...
  uint32 uLvl1BankSwizzling;         /* Swizzling mode */
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_TrafficCtrl_SetClientWatermarkLvl_5_0_0()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_MDP_TrafficCtrl_SetClientWatermarkLvl_5_0_0 (
                              HAL_MDP_TrafficCtrl_LatencyType  eLatency,
                              uint32                           uTotalSMPBytes,
                              uint32                           uFlags,
                              uintPtr                          uRegAddr);
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_MDP_TrafficCtrl_SetClientWatermarkLvl__0_0 (
                              HAL_MDP_TrafficCtrl_LatencyType  eLatency,
                              uint32                           uTotalSMPBytes,
                              uint32                           uFlags,
                              uintPtr                          uRegAddr);
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_SwapMacroTileColorComponent_5_0_0()
*/
/*!
* \brief
...
*
****************************************************************************/
uint32 HAL_MDP_SwapMacroTileColorComponent_5_0_0(HAL_MDP_PixelFormatType ePixelFormat, uint32 uPatternValue);

/****************************************************************************
*
** FUNCTION: HAL_MDP_SSPP_SetQosConfig_5_0_0()
*/
/*!
* \brief
...
*
****************************************************************************/
void HAL_MDP_SSPP_SetQosConfig_5_0_0 (HAL_MDP_SourcePipeId              eSourcePipe,
                                      HAL_MDP_TrafficCtrl_LatencyType   eLatency,
                                      HAL_MDP_Qos_ConfigType           *psQoSInfo,
                                      uint32                            uFlags);
