...
#include "pm_app_rgb.h"
 ...
 /************************************************ DRIVER DATA *********************************/
                         //PMM8195AU_1, NO_PMIC, PMM8195AU_3, NO_PMIC, PMM8195AU_2
uint32 num_of_ldo[]        = {18,          0,        18,          0,        18 };
uint32 num_of_smps[]       = {10,          0,        10,          0,        10 };
uint32 num_of_gpio[]       = {10,          0,        10,          0,        10 };
uint32 num_of_rtc[]        = { 1,          0,         1,          0,         1 };
uint32 num_of_megaxo[]     = { 0,          0,         0,          0,         0 };
uint32 num_of_boost[]      = { 0,          0,         0,          0,         0 };
uint32 num_of_bob[]        = { 0,          0,         0,          0,         0 };
uint32 num_of_vs[]         = { 0,          0,         0,          0,         0 };
uint32 num_of_lpg_chan[]   = { 0,          0,         0,          0,         0 };
uint32 num_of_pwron[]      = { 1,          0,         1,          0,         1 };
uint32 num_of_misc[]       = { 1,          0,         1,          0,         1 };
uint32 num_of_rgb[]        = { 0,          0,         0,          0,         0 };
uint32 num_of_wled[]       = { 0,          0,         0,          0,         0 };
uint32 num_of_schg[]       = { 0,          0,         0,          0,         0 };
uint32 num_of_bmd[]        = { 0,          0,         0,          0,         0 };
uint32 num_of_coincell[]   = { 1,          0,         1,          0,         1 };
uint32 num_of_fg[]         = { 0,          0,         0,          0,         0 };
uint32 num_of_ibb[]        = { 0,          0,         0,          0,         0 };
uint32 num_of_lab[]        = { 0,          0,         0,          0,         0 };
uint32 num_of_ab[]         = { 0,          0,         0,          0,         0 };
uint32 num_of_oledb[]      = { 0,          0,         0,          0,         0 };
uint32 num_of_vib[]        = { 0,          0,         0,          0,         0 };
uint32 num_of_pbs_client[] = { 2,          0,         2,          0,         2 };
uint32 num_of_haptics[]    = { 0,          0,         0,          0,         0 };
uint32 num_of_lcdb[]       = { 0,          0,         0,          0,         0 };
uint32 num_of_pwm[]        = { 0,          0,         0,          0,         0 };
uint32 num_of_sdam[]       = { 8,          0,         8,          0,         8 };
...
{
   0,  //Primary PMIC Device Index   (PMM8195AU_1)
   1,  //Interface PMIC Device Index (PMM8195AU_3)
   2,  //Secondary PMIC Device Index (PMM8195AU_2)
};
...
pm_pbs_info_data_type *pm_pbs_info_data[] = {&pm_pbs_info_data_a, &pm_pbs_info_data_b, &pm_pbs_info_data_c, &pm_pbs_info_data_d, &pm_pbs_info_data_e};
...
{
   {
      ...
      .dbnc_time_msec = 50,                      // valid debounce time msec
      .sdam_dbnc_supported = FALSE,               // SDAM support for reading dbnc time
