...
[Defines]
  ...
  FLASH_DEFINITION               = QcomPkg/SDMPkg/1000/LA/Core.fdf

[Defines.ARM]
  OUTPUT_DIRECTORY               = Build/SDM1000LA_Core_32

[Defines.AARCH64]
  OUTPUT_DIRECTORY               = Build/SDM1000LA_Core
...
[BuildOptions.AARCH64]
  GCC:*_*_AARCH64_ARCHCC_FLAGS  == -fno-common -mtune=cortex-a53 -I$(WORKSPACE)/QcomPkg/SDMPkg/Include -I$(WORKSPACE)/QcomPkg/SDMPkg/1000/Include -include $(WORKSPACE)/QcomPkg/Include/Library/DebugLib.h -DQCOM_EDK2_PATCH -DDISABLE_DEP $(FEATURE_FLAGS) -DENABLE_XN -DENABLE_DEP_64 -DENABLE_ASLR -DENABLE_EXEC_CODE_READY_TO_BOOT
  GCC:*_*_AARCH64_ARCHPP_FLAGS  == -I$(WORKSPACE)/QcomPkg/SDMPkg/Include -I$(WORKSPACE)/QcomPkg/SDMPkg/1000/Include -include $(WORKSPACE)/QcomPkg/Include/Library/DebugLib.h -DQCOM_EDK2_PATCH -DDISABLE_DEP $(FEATURE_FLAGS) -DENABLE_XN -DENABLE_DEP_64 -DENABLE_ASLR -DENABLE_EXEC_CODE_READY_TO_BOOT
...
#
  ...
  QcomPkg/Drivers/CPRDxe/CPRDxe.inf {
    <LibraryClasses>
    # CPR Library
    CPRLib|QcomPkg/SDMPkg/1000/Library/CPRTargetLib/Core/CPRTargetLib.inf
  }
