...
==============================================================================
  ...
  $Header: //components/rel/boot.xf/2.0/QcomPkg/SDM845Pkg/Library/ClockTargetLib/ClockDriver.h#9 $
...
*/
/*!
 * Uses the TCSR_SOC_HW_VERSION to return the major version of the chip
 * to choose a clock plan

    @return
      int32 - An index into ClockBSP data that matches this chip version
