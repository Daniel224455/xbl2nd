...
uint32 ddr_boot_up_freq = 1555200;
...
void updatemsm_info()
{
  msm_info.chip_id = ChipInfo_GetChipId();
  msm_info.chip_version = ChipInfo_GetChipVersion();
  
  msm_info.feature_sku = BOOT_HWIO_IN(QFPROM_CORR_PTE_ROW0_LSB,0);
  msm_info.feature_sku = msm_info.feature_sku >> 20;
  msm_info.feature_sku = msm_info.feature_sku&(0xff); 
}
...
void ddr_target_init()
{
  ...
  updatemsm_info(); //function call to get MSM details
  ...
  if (platform != DALPLATFORMINFO_TYPE_RUMI)
  {
    ...
    if (PcdGet32 (PcdBuildType) == 0)
    {
      ...
      err = pm_smps_sw_mode(0, PM_SMPS_9, PM_SW_MODE_NPM); // CX SMPS9 to PWM
  ...
  ddrsns_share_data->shrm_ddr_ptr->misc.platform_id  = chip_plat_ver_info >> 16 /*& 0xFFFF0000*/ ;
   ...
   if ( ((msm_info.chip_version == CHIPINFO_VERSION(2,1)) && (msm_info.chip_id == CHIPINFO_ID_SC8180X) && (msm_info.feature_sku == 0x02)) || 
        ((msm_info.chip_version == CHIPINFO_VERSION(2,1)) && (msm_info.chip_id == CHIPINFO_ID_SC8180XP) && (msm_info.feature_sku == 0x01)) )
		{
	  ddrsns_share_data->shrm_ddr_ptr->misc.platform_id = 0x60AA; 
  }
...
void ddr_target_sdi_pass_init(uint32 clk_speed)
{
  ...
  */
            ...
            HWIO_INF(AOSS_CC_RESET_FSM_STATUS, FIRST_PASS_EXPIRE)||(!HWIO_INF(AOSS_CC_RESET_FSM_CTRL, FIRST_PASS_COMPLETE)))
  {
	...
	if (ddrsns_share_data->shrm_ddr_ptr->misc.num_channel == 4)
		snprintf(ddr_log_string, 200, "ALT_ARES Set,HAL_DDR_Init() completed: Freeze IOs = 0x%x, 0x%x, 0x%x, 0x%x, DBG PDC Tr = 0x%x, First Pass expire = 0x%x, First Pass complete = 0x%x , BIMC Alt ARES  = 0x%x , PASS2 Cookie = 0x%x ", (HWIO_INF(DDRCC_CH45_DDRCC_PCC_PC_STA, PC_FREEZE_IO_0)), (HWIO_INF(DDRCC_CH45_DDRCC_PCC_PC_STA, PC_FREEZE_IO_1)), (HWIO_INF(DDRCC_CH67_DDRCC_PCC_PC_STA, PC_FREEZE_IO_0)), (HWIO_INF(DDRCC_CH67_DDRCC_PCC_PC_STA, PC_FREEZE_IO_1)), (HWIO_INF(AOSS_CC_RESET_FSM_STATUS, DBG_PDC_TRIGGER)), (HWIO_INF(AOSS_CC_RESET_FSM_STATUS, FIRST_PASS_EXPIRE)), (HWIO_INF(AOSS_CC_RESET_FSM_CTRL, FIRST_PASS_COMPLETE))  , HWIO_AOSS_CC_ALT_RESET_ENABLE_INM(HWIO_AOSS_CC_ALT_RESET_ENABLE_ALLOW_BIMC_ALT_ARES_BMSK), ddr_sdi_logs_ptr->pass2_cookie->p_cookie_value);
	else
  ...
  else
  {
	...
	if (ddrsns_share_data->shrm_ddr_ptr->misc.num_channel == 4)
		snprintf(ddr_log_string, 200, "HAL_DDR_SDI_Recover() start: Freeze IOs = 0x%x, 0x%x, 0x%x, 0x%x, DBG PDC Tr = 0x%x, First Pass expire = 0x%x, First Pass complete = 0x%x , BIMC Alt ARES  = 0x%x , PASS2 Cookie = 0x%x ", (HWIO_INF(DDRCC_CH45_DDRCC_PCC_PC_STA, PC_FREEZE_IO_0)), (HWIO_INF(DDRCC_CH45_DDRCC_PCC_PC_STA, PC_FREEZE_IO_1)), (HWIO_INF(DDRCC_CH67_DDRCC_PCC_PC_STA, PC_FREEZE_IO_0)), (HWIO_INF(DDRCC_CH67_DDRCC_PCC_PC_STA, PC_FREEZE_IO_1)), (HWIO_INF(AOSS_CC_RESET_FSM_STATUS, DBG_PDC_TRIGGER)), (HWIO_INF(AOSS_CC_RESET_FSM_STATUS, FIRST_PASS_EXPIRE)), (HWIO_INF(AOSS_CC_RESET_FSM_CTRL, FIRST_PASS_COMPLETE))  , HWIO_AOSS_CC_ALT_RESET_ENABLE_INM(HWIO_AOSS_CC_ALT_RESET_ENABLE_ALLOW_BIMC_ALT_ARES_BMSK), ddr_sdi_logs_ptr->pass2_cookie->p_cookie_value);
	else
	...
	if (ddrsns_share_data->shrm_ddr_ptr->misc.num_channel == 4)
		snprintf(ddr_log_string, 200, "HAL_DDR_SDI_Recover() end: Freeze IOs = 0x%x, 0x%x, 0x%x, 0x%x, DBG PDC Tr = 0x%x, First Pass expire = 0x%x, First Pass complete = 0x%x , BIMC Alt ARES  = 0x%x , PASS2 Cookie = 0x%x ", (HWIO_INF(DDRCC_CH45_DDRCC_PCC_PC_STA, PC_FREEZE_IO_0)), (HWIO_INF(DDRCC_CH45_DDRCC_PCC_PC_STA, PC_FREEZE_IO_1)), (HWIO_INF(DDRCC_CH67_DDRCC_PCC_PC_STA, PC_FREEZE_IO_0)), (HWIO_INF(DDRCC_CH67_DDRCC_PCC_PC_STA, PC_FREEZE_IO_1)), (HWIO_INF(AOSS_CC_RESET_FSM_STATUS, DBG_PDC_TRIGGER)), (HWIO_INF(AOSS_CC_RESET_FSM_STATUS, FIRST_PASS_EXPIRE)), (HWIO_INF(AOSS_CC_RESET_FSM_CTRL, FIRST_PASS_COMPLETE))  , HWIO_AOSS_CC_ALT_RESET_ENABLE_INM(HWIO_AOSS_CC_ALT_RESET_ENABLE_ALLOW_BIMC_ALT_ARES_BMSK), ddr_sdi_logs_ptr->pass2_cookie->p_cookie_value);
	else
...
boolean ddr_post_init()
{
  ...
  if ( ((msm_info.chip_version == CHIPINFO_VERSION(2,1)) && (msm_info.chip_id == CHIPINFO_ID_SC8180X) && (msm_info.feature_sku == 0x02)) || 
       ((msm_info.chip_version == CHIPINFO_VERSION(2,1)) && (msm_info.chip_id == CHIPINFO_ID_SC8180XP) && (msm_info.feature_sku == 0x01)) ) 
  {
	  ddrsns_share_data->shrm_ddr_ptr->misc.platform_id = 0x6006; 
  }
...
void ddr_post_setup()
{
   ...
   if ( ((msm_info.chip_version == CHIPINFO_VERSION(2,0)) && (msm_info.chip_id == CHIPINFO_ID_SC8180X) && (msm_info.feature_sku == 0x05)) || 
        ((msm_info.chip_version == CHIPINFO_VERSION(2,1)) && (msm_info.chip_id == CHIPINFO_ID_SC8180X) && (msm_info.feature_sku == 0x02)) || 
        ((msm_info.chip_version == CHIPINFO_VERSION(2,1)) && (msm_info.chip_id == CHIPINFO_ID_SC8180XP) && (msm_info.feature_sku == 0x01)) )
