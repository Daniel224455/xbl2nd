...
typedef enum
{
  ...
  CLOCK_CONFIG_PARAM_GET_DCVS_MODE_TYPE,
  CLOCK_CONFIG_PARAM_SET_DCVS_MODE_TYPE,
  CLOCK_CONFIG_PARAM_TOTAL,
} eConfigParamType;


/*
 * Clock Driver DCVS Mode types.
 */
typedef enum
{
  CLOCK_DCVS_MODE_HW_ALL,
  CLOCK_DCVS_MODE_SW_ALL,
  CLOCK_DCVS_MODE_SW_ANY,
  CLOCK_DCVS_MODE_TOTAL,
} eDcvsModeType;
