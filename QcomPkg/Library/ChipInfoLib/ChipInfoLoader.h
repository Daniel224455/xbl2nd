...
#define CHIPINFO_PARTNUM_SA6145P	      CHIPINFO_PARTNUM_SA6155P
#define CHIPINFO_PARTNUM_SA6150P    	  CHIPINFO_PARTNUM_SA6155P
#define CHIPINFO_PARTNUM_SA6155P	      0x0EE
#define CHIPINFO_PARTNUM_SA8150         0x0E8
#define CHIPINFO_PARTNUM_SA8150P        0x0E9
#define CHIPINFO_PARTNUM_SA8195P        0x123
#define CHIPINFO_PARTNUM_SC8180X        CHIPINFO_PARTNUM_SDM1000
#define CHIPINFO_PARTNUM_SC8180XP       0x0DA
...
/*
 * The part numbers above are arranged in alphabetical order of the chip name
