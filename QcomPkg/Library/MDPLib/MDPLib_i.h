...
#define       MDP_CEIL(x, y)                                (((double)(x) + ((double)(y)-1)) / (double)(y))
...
*/
#define MDP_MAX_NUM_DYNAMIC_REFRESH                         8
#define MDP_PLL_CODES_NUM_PER_FREQ                          3
#define MDP_MAX_NUM_DSI_DEVICE                              2
#define MDP_MAX_PLLCODES_SIZE                               0x1000
...
#define MDP_DRIVER_DP_DEVICE_ID_DP                          3
...
typedef enum
{
  MDSS_DEVICE_VERSION_05_00 = 0,   /**< Device 5.0.x */
  MDSS_DEVICE_VERSION_05_01,       /**< Device 5.1.x */
  MDSS_DEVICE_VERSION_05_02,       /**< Device 5.2.x */
  MDSS_DEVICE_VERSION_05_03,       /**< Device 5.3.x */
  MDSS_DEVICE_VERSION_05_04,       /**< Device 5.4.x */
  MDSS_DEVICE_VERSION_05_05,       /**< Device 5.5.x */
  MDSS_DEVICE_VERSION_05_06,       /**< Device 5.6.x */
  MDSS_DEVICE_VERSION_05_07,       /**< Device 5.7.x */
  MDSS_DEVICE_VERSION_05_08,       /**< Device 5.8.x */  
  MDSS_DEVICE_VERSION_05_09,       /**< Device 5.9.x */
...
typedef struct
{
    ...
    uint32                         uPixelPerClock;         /**< transmit 2 pixle per pclk at dp_intf     */
    bool32                         bDTOEnable;             /**< DTO enabled with DTO count calculated */
    ...
    HAL_MDP_DSC_EncoderConfigType  *pDSCEncCfg;            /**< DSC Encoder Config */
    HAL_MDP_DSC_EncParamsType      *pDSCEncParams;         /**< DSC Encoder Params Type */
    HAL_MDP_DSC_EncoderPacketType  *pDSCEncPktType;        /**< DSC Encoder Packet Type */
...
typedef struct
{
  ...
  DSCDescType                     sDSCDesc;                                       /**< contains DSC related info   */
  ...
  bool32                          bIsSupported;                                   /**< Is this display supported */	
} MDP_Panel_AttrType;
