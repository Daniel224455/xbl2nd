...
$Header: //components/rel/boot.xf/3.0.1.c1/QcomPkg/SDMPkg/1000/Library/DSFTargetLib/ddrsns/ddrss/header/ddrss.h#1 $
...
// DSF Version
#define DSF_MAJOR_VERSION 104
#define DSF_BRANCH_NUMBER 0
#define DSF_REV_IN_BRANCH 5

#define DSF_MAJOR_VERSION_SHIFT 16
#define DSF_BRANCH_NUMBER_SHIFT 8
#define DSF_VERSION ((DSF_MAJOR_VERSION << DSF_MAJOR_VERSION_SHIFT) | \
    (DSF_BRANCH_NUMBER << DSF_BRANCH_NUMBER_SHIFT) | DSF_REV_IN_BRANCH)
...
extern char g_str_default[]; // define in ddrss_training.c; declare extern in ddrss.h
extern char g_str_dcc_pll0[];
extern char g_str_dcc_pll1[];
extern char *tmp_string_p;
//extern uint16 tmp_string_array_p;
extern char g_str_write[];
extern char g_str_read[];
extern char g_str_error[];
extern char g_str_unit_ps[];
extern char g_str_unit_mV[];
extern char g_str_print_s[];
extern char g_str_print_d[];
 
//extern uint8 *tmp_string_int_p;
...
void DDRSS_SED_prints(char training[10],
                             char  param_name[25],
                             uint32  param_steps,
                             uint32  param_value,    
                             char  param_units[25],                          
...
typedef struct sed_print_struct
{
    char    *training;
    char    *param_name;
    uint32  param_steps;
...
sed_print_struct_t;
extern uint8 g_abort_flag;
extern uint8 g_sed_flag;
extern sed_print_struct_t g_sed_struct_val;
void DDRSS_SED_prints_struct(void);
