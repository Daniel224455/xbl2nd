...
{
   // Use MDSS_MDP V5.0.0 as the base info
   HAL_MDP_ReadHardwareInfo_5_0_0(psHwInfo, psMdpHwInfo);
}
...
static void HAL_MDP_ConfigUBWCSettings()
{
  ...
  // UBWC AMSBC Setting - HW uses this to decide whether to use UBWC ver 2.0 (AMSBC = 0) or 3.0 (AMSBC = 1)
  uRegValue = HWIO_OUT_FLD(uRegValue,
                           MDSS_HW_UBWC_STATIC_CTRL,
                           UBWC_AMSBC,
                           uAmsbc);
