...
/*=========================================================================
      Data
==========================================================================*/
#define MAX_DDR_LEVELS 13

ClockSrcDynCfgType SrcCfg[] =
{
  /* =============================================================
  **  nFreqKHz, nSource,                   nL,   nAlpha, nDiv2x }
  ** =============================================================*/
...
)
{
  ...
  /* Set new L and nAlpha value */
  pDynPLLCfg = &SrcCfg[nSrcIndex];
  pPLLCfg->nL = pDynPLLCfg->nL;
  pPLLCfg->nAlpha = pDynPLLCfg->nAlpha;
...
)
{
  ...
  {
    for ( index = MAX_DDR_LEVELS-1; index > 0; index-- )
    {
