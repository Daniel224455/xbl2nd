...
--------   ---     -----------------------------------------------------------
02/01/18   mr      Added low level GPIO config API
11/09/17   pbitra  Removed Battery status APIs
10/16/17   pbitra  Added charging functionality support
...
typedef EFI_STATUS (*CHARGER_EXT_ENABLE_CHARGER) (BOOLEAN bEnable);
typedef EFI_STATUS (*CHARGER_EXT_GET_CHARGING_STATUS)(BOOLEAN *pChargingSts);
typedef EFI_STATUS (*CHARGER_EXT_SET_CHARGING_TERM_CURRENT) (UINT32 ChargingTermCurrentMA);
typedef EFI_STATUS (*CHARGER_EXT_SET_FCCMAX) (UINT32 FCCMaxCurrentMA);
typedef EFI_STATUS (*CHARGER_EXT_SET_FVMAX) (UINT32 FVMaxMV);
typedef EFI_STATUS (*CHARGER_EXT_SET_SINK_EN) (BOOLEAN bSinkEn);
...
typedef struct _CHARGER_EXT_HW_FUNC
{
    ...
    CHARGER_EXT_ENABLE_CHARGER EnableCharger;
    CHARGER_EXT_GET_CHARGING_STATUS GetChargingStatus;
    CHARGER_EXT_SET_CHARGING_TERM_CURRENT SetChargingTermCurrent;
    CHARGER_EXT_SET_FCCMAX SetFCCMax;
    CHARGER_EXT_SET_FVMAX SetFVMax;
    CHARGER_EXT_SET_SINK_EN SetSinkEn;
} CHARGER_EXT_HW_FUNC;
