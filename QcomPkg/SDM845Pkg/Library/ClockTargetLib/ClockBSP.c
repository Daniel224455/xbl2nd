...
==============================================================================
  ...
  $Header: //components/rel/boot.xf/2.0/QcomPkg/SDM845Pkg/Library/ClockTargetLib/ClockBSP.c#19 $
...
Clock_ConfigType Clock_ConfigData =
{
  ...
  .CPU_Cfg =
  {
    ...
    {APCS_SOURCE_AG_EARLY,   79,     0,        0,      1516800 },  /* MAX       - 1516.8MHz  */
  ...
  .L3_Cfg =
  {
    ...
    {APCS_SOURCE_AG_EARLY,     46,   0,        0,       883200},  /* MAX       - 883.2MHz  */
    {APCS_SOURCE_AG_EARLY,     46,   0,        0,       883200},  /* DEFAULT   - 883.2MHz  */
  },
  .SNOC_Cfg[V1] = 
  {
    {HWIO_ADDR(GCC_SYS_NOC_CMD_RCGR), 1, MUX_GCC, SRC_CXO,     0, 0, 0, 0},  /* PERF NONE */
    {HWIO_ADDR(GCC_SYS_NOC_CMD_RCGR), 5, MUX_GCC, SRC_GPLL1,  16, 0, 0, 0},  /* NOM - 133.25 MHz (NOM)         */
    {HWIO_ADDR(GCC_SYS_NOC_CMD_RCGR), 6, MUX_GCC, SRC_GPLL1,  14, 0, 0, 0},  /* MAX - 152.29 MHz (TURBO)       */
    {HWIO_ADDR(GCC_SYS_NOC_CMD_RCGR), 5, MUX_GCC, SRC_GPLL1,  16, 0, 0, 0}   /* DEFAULT -133.25 MHz (Max Nom)  */
  },
  .SNOC_Cfg[V2] = 
  {
    {HWIO_ADDR(GCC_SYS_NOC_CMD_RCGR), 1, MUX_GCC, SRC_CXO,     0, 0, 0, 0},  /* PERF NONE */
  ...
  .SNOC_SF_Cfg[V1] = 
  {
    ...
    {HWIO_ADDR(GCC_SYS_NOC_SF_AXI_CMD_RCGR), 5, MUX_GCC, SRC_GPLL0,  4, 0, 0, 0},  /* NOM - 300 MHz (NOM)        */
    {HWIO_ADDR(GCC_SYS_NOC_SF_AXI_CMD_RCGR), 6, MUX_GCC, SRC_GPLL1,  6, 0, 0, 0},  /* MAX - 355.33 MHz (TURBO)   */
    {HWIO_ADDR(GCC_SYS_NOC_SF_AXI_CMD_RCGR), 5, MUX_GCC, SRC_GPLL0,  4, 0, 0, 0}   /* DEFAULT -300 MHz (Max Nom) */
  },
  .SNOC_SF_Cfg[V2] = 
  {
    {HWIO_ADDR(GCC_SYS_NOC_SF_AXI_CMD_RCGR), 1, MUX_GCC, SRC_CXO,    0, 0, 0, 0},  /* PERF NONE */
  ...
  .AGNOC_Cfg[V1] = 
  {
    ...
    {HWIO_ADDR(GCC_AGGRE_NOC_CMD_RCGR), 5, MUX_GCC, SRC_GPLL0,  8, 0, 0, 0},  /* NOM - 150 MHz (NOM)         */
    {HWIO_ADDR(GCC_AGGRE_NOC_CMD_RCGR), 6, MUX_GCC, SRC_GPLL0,  6, 0, 0, 0},  /* MAX - 200 MHz (TURBO)       */
    {HWIO_ADDR(GCC_AGGRE_NOC_CMD_RCGR), 5, MUX_GCC, SRC_GPLL0,  8, 0, 0, 0}   /* DEFAULT - 150 MHz (Max Nom) */
  },
  .AGNOC_Cfg[V2] = 
  {
    {HWIO_ADDR(GCC_AGGRE_NOC_CMD_RCGR), 1, MUX_GCC, SRC_CXO,    0, 0, 0, 0},  /* PERF NONE */
  ...
  .AGNOC_EAST_Cfg[V1] = 
  {
    ...
    {HWIO_ADDR(GCC_AGGRE_NOC_EAST_SF_CMD_RCGR), 5, MUX_GCC, SRC_GPLL0,  4, 0, 0, 0},  /* NOM - 300 MHz (NOM)         */
    {HWIO_ADDR(GCC_AGGRE_NOC_EAST_SF_CMD_RCGR), 6, MUX_GCC, SRC_GPLL0,  4, 0, 0, 0},  /* MAX - 300 MHz (TURBO)       */
    {HWIO_ADDR(GCC_AGGRE_NOC_EAST_SF_CMD_RCGR), 5, MUX_GCC, SRC_GPLL0,  4, 0, 0, 0}   /* DEFAULT - 300 MHz (Max Nom) */
  },
  .AGNOC_EAST_Cfg[V2] = 
  {
    {HWIO_ADDR(GCC_AGGRE_NOC_EAST_SF_CMD_RCGR), 1, MUX_GCC, SRC_CXO,    0, 0, 0, 0},  /* PERF NONE */
  ...
  .AGNOC_NORTH_Cfg[V1] = 
  {
    ...
    {HWIO_ADDR(GCC_AGGRE_NOC_NORTH_SF_CMD_RCGR), 5, MUX_GCC, SRC_GPLL0,  4, 0, 0, 0},  /* NOM - 300 MHz (NOM)         */
    {HWIO_ADDR(GCC_AGGRE_NOC_NORTH_SF_CMD_RCGR), 6, MUX_GCC, SRC_GPLL0,  4, 0, 0, 0},  /* MAX - 300 MHz (TURBO)       */
    {HWIO_ADDR(GCC_AGGRE_NOC_NORTH_SF_CMD_RCGR), 5, MUX_GCC, SRC_GPLL0,  4, 0, 0, 0}   /* DEFAULT - 300 MHz (Max Nom) */
  },
  .AGNOC_NORTH_Cfg[V2] = 
  {
    {HWIO_ADDR(GCC_AGGRE_NOC_NORTH_SF_CMD_RCGR), 1, MUX_GCC, SRC_CXO,    0, 0, 0, 0},  /* PERF NONE */
    ...
    {HWIO_ADDR(GCC_AGGRE_NOC_NORTH_SF_CMD_RCGR), 5, MUX_GCC, SRC_GPLL0,  3, 0, 0, 0}   /* DEFAULT - 400 MHz (Max Nom) */
  },
  .CNOC_Cfg = 
  {
    {HWIO_ADDR(GCC_CONFIG_NOC_CMD_RCGR), 1, MUX_GCC, SRC_CXO,    0, 0, 0, 0},  /* PERF NONE                    */
    {HWIO_ADDR(GCC_CONFIG_NOC_CMD_RCGR), 3, MUX_GCC, SRC_GPLL0, 16, 0, 0, 0},  /* NOM - 75 MHz (NOM)           */
    {HWIO_ADDR(GCC_CONFIG_NOC_CMD_RCGR), 3, MUX_GCC, SRC_GPLL0, 16, 0, 0, 0},  /* MAX - 75 MHz (TURBO)         */
    {HWIO_ADDR(GCC_CONFIG_NOC_CMD_RCGR), 3, MUX_GCC, SRC_GPLL0, 16, 0, 0, 0}   /* DEFAULT - 75 MHz (Max Nom)   */
  },
  .CNOC_Periph_Cfg =
  {
    {HWIO_ADDR(GCC_CNOC_PERIPH_CMD_RCGR), 1, MUX_GCC, SRC_CXO,    0, 0, 0, 0}, /* PERF NONE                     */
    {HWIO_ADDR(GCC_CNOC_PERIPH_CMD_RCGR), 3, MUX_GCC, SRC_GPLL0, 12, 0, 0, 0}, /* NOM - 100 MHz (NOM)           */
    {HWIO_ADDR(GCC_CNOC_PERIPH_CMD_RCGR), 3, MUX_GCC, SRC_GPLL0, 12, 0, 0, 0}, /* MAX - 100 MHz (TURBO)         */
    {HWIO_ADDR(GCC_CNOC_PERIPH_CMD_RCGR), 3, MUX_GCC, SRC_GPLL0, 12, 0, 0, 0}  /* DEFAULT - 100 MHz (Max Nom)   */
  },
  .CPU_AXI_Cfg = 
  {
    {HWIO_ADDR(GCC_CPUSS_AXI_CMD_RCGR), 1, MUX_GCC, SRC_CXO,    0, 0, 0, 0},  /* PERF NONE                     */
    {HWIO_ADDR(GCC_CPUSS_AXI_CMD_RCGR), 5, MUX_GCC, SRC_GPLL5,  0, 0, 0, 0},  /* NOM - 700MHz (NOM)            */
    {HWIO_ADDR(GCC_CPUSS_AXI_CMD_RCGR), 6, MUX_GCC, SRC_GPLL4,  0, 0, 0, 0},  /* MAX - 806MHz (TURBO)          */
    {HWIO_ADDR(GCC_CPUSS_AXI_CMD_RCGR), 5, MUX_GCC, SRC_GPLL5,  0, 0, 0, 0}   /* DEFAULT - 700MHz (Max Nom)    */
  },
  .TURING_AXI_Cfg = 
  {
    {HWIO_ADDR(GCC_TURING_AXI_CMD_RCGR), 1, MUX_GCC, SRC_CXO,    0, 0, 0, 0},  /* PERF NONE                     */
    {HWIO_ADDR(GCC_TURING_AXI_CMD_RCGR), 5, MUX_GCC, SRC_GPLL5,  6, 0, 0, 0},  /* NOM - 233.33MHz (NOM)         */
    {HWIO_ADDR(GCC_TURING_AXI_CMD_RCGR), 6, MUX_GCC, SRC_GPLL4,  6, 0, 0, 0},  /* MAX - 268.67MHz (TURBO)       */
    {HWIO_ADDR(GCC_TURING_AXI_CMD_RCGR), 5, MUX_GCC, SRC_GPLL5,  6, 0, 0, 0}   /* DEFAULT - 233.33MHz (Max Nom) */
  },
  .MEMNOC_Cfg[V1]=
  {
    {HWIO_ADDR(GCC_MEMNOC_CMD_RCGR), 1, MUX_GCC, SRC_CXO,    0, 0, 0, 0},  /* PERF NONE                         */
    {HWIO_ADDR(GCC_MEMNOC_CMD_RCGR), 5, MUX_GCC, SRC_GPLL0,  0, 0, 0, 0},  /* NOM - 600MHz (NOM)                */
    {HWIO_ADDR(GCC_MEMNOC_CMD_RCGR), 6, MUX_GCC, SRC_GPLL5,  0, 0, 0, 0},  /* MAX - 700MHz (TURBO)              */
    {HWIO_ADDR(GCC_MEMNOC_CMD_RCGR), 5, MUX_GCC, SRC_GPLL0,  0, 0, 0, 0},  /* DEFAULT - 600MHz (NOM)            */
  },
  .MEMNOC_Cfg[V2]=
  {
    {HWIO_ADDR(GCC_MEMNOC_CMD_RCGR), 1, MUX_GCC, SRC_CXO,    0, 0, 0, 0},  /* PERF NONE                         */
  ...
  .GPU_MEMNOC_Cfg[V1] =
  {
    ...
    {HWIO_ADDR(GCC_GPU_MEMNOC_GFX_CMD_RCGR), 5, MUX_GCC, SRC_GPLL1,  6, 0, 0, 0},  /* NOM - 355.33MHz (NOM)     */
    {HWIO_ADDR(GCC_GPU_MEMNOC_GFX_CMD_RCGR), 6, MUX_GCC, SRC_GPLL4,  4, 0, 0, 0},  /* MAX - 403MHz (TURBO)      */
    {HWIO_ADDR(GCC_GPU_MEMNOC_GFX_CMD_RCGR), 5, MUX_GCC, SRC_GPLL1,  6, 0, 0, 0},  /* DEFAULT - 355.33MHz (NOM) */
  },
  .GPU_MEMNOC_Cfg[V2] =
  {
    {HWIO_ADDR(GCC_GPU_MEMNOC_GFX_CMD_RCGR), 1, MUX_GCC, SRC_CXO,    0, 0, 0, 0},  /* PERF NONE                 */
  ...
  .Q6_MEMNOC_Cfg[V1] =
  {
    ...
    {HWIO_ADDR(GCC_MSS_Q6_MEMNOC_AXI_CMD_RCGR), 5, MUX_GCC, SRC_GPLL1,  4, 0, 0, 0},  /* NOM - 533MHz (NOM)      */
    {HWIO_ADDR(GCC_MSS_Q6_MEMNOC_AXI_CMD_RCGR), 6, MUX_GCC, SRC_GPLL0,  0, 0, 0, 0},  /* MAX - 600MHz (TURBO)    */
    {HWIO_ADDR(GCC_MSS_Q6_MEMNOC_AXI_CMD_RCGR), 5, MUX_GCC, SRC_GPLL1,  4, 0, 0, 0},  /* DEFAULT - 533MHz (NOM)  */
  },
  .Q6_MEMNOC_Cfg[V2] =
  {
    {HWIO_ADDR(GCC_MSS_Q6_MEMNOC_AXI_CMD_RCGR), 1, MUX_GCC, SRC_CXO,    0, 0, 0, 0},  /* PERF NONE               */
    {HWIO_ADDR(GCC_MSS_Q6_MEMNOC_AXI_CMD_RCGR), 5, MUX_GCC, SRC_GPLL0,  0, 0, 0, 0},  /* NOM - 600MHz (NOM)     */
    {HWIO_ADDR(GCC_MSS_Q6_MEMNOC_AXI_CMD_RCGR), 6, MUX_GCC, SRC_GPLL1,  3, 0, 0, 0},  /* MAX - 710MHz (TURBO)      */
  ...
  .CE_Cfg =
  {
    ...
    {HWIO_ADDR(GCC_CE1_CMD_RCGR), 2, MUX_GCC, SRC_GPLL0,  7, 0, 0, 0},  /* NOM - 171.43MHz (NOM)    */
    {HWIO_ADDR(GCC_CE1_CMD_RCGR), 2, MUX_GCC, SRC_GPLL0,  7, 0, 0, 0},  /* MAX - 171.43MHz (TURBO)  */
    {HWIO_ADDR(GCC_CE1_CMD_RCGR), 2, MUX_GCC, SRC_GPLL0,  7, 0, 0, 0},  /* DEFAULT - 171.43MHz (NOM)*/
  },
  .UFS_Cfg = 
  {
  ...
  .QUPV3Core2X_Cfg =
  {
    ...
    {HWIO_ADDR(GCC_QUPV3_WRAP0_CORE_2X_CMD_RCGR), 0, MUX_GCC, SRC_GPLL0, 12, 0, 0, 0},  /* NOM - 100MHz (NOM)       */
    {HWIO_ADDR(GCC_QUPV3_WRAP0_CORE_2X_CMD_RCGR), 0, MUX_GCC, SRC_GPLL1, 12, 0, 0, 0},  /* MAX - 100MHz (TURBO)  */
    {HWIO_ADDR(GCC_QUPV3_WRAP0_CORE_2X_CMD_RCGR), 0, MUX_GCC, SRC_GPLL0, 12, 0, 0, 0},  /* DEFAULT - 100MHz (NOM)   */
  },
  .QUPV3_Cfg =
  {
