 ...
 ******************************************************************************/
/*==============================================================================
$Header: //components/rel/boot.xf/2.0/QcomPkg/SDM845Pkg/Library/DSFTargetLib/ddrsns/ddrss/mc/mc40/src/mc_data.c#8 $
...
uint8   lpddr_geometry_table[][2][2] = {
  ...
  /* nrows, ncols      |  nrows, ncols     */
    ...
    {{17,    10},         {18,    10}},  // 12 Gb per channel
    {{17,    10},         {18,    10}}   // 16 Gb per channel
};
...
uint16   lpddr_size_table[][2][2] = {
  ...
  /* size_mb, addr_offset_bit | size_mb, addr_offset_bit*/
    ...
    {{0x600,       31},          {0xC00,       32}},  // 12 Gb per channel
    {{0x800,       31},          {0x1000,      32}}   // 16 Gb per channel
};
...
uint32   lpddr_timing_table[][2] = {
  /* tRFC_AB_in_ps, tRFC_PB_in_ps */
    ...
    {380000,        190000,},  // 12 Gb per channel
    {380000,        190000,}   // 16 Gb per channel
};
