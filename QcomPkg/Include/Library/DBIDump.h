...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 05/15/19   vb      fix the APREG size for the check in tzbsp_copy_dump_ctx API [CR2445093]
...
/* 8 CPU reg dump entries; 8 scan dump entries; ETB; RPMh; PMIC */
...
//RPMh code ram dump
#define RPMH_CODE_RAM_DUMP_START_OFFSET CPU_ETB_DUMP_END_OFFSET
