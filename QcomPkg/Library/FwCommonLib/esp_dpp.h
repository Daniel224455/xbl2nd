...
/*!
 * The path (from the root of the EFI System Partition) to the file containing
 * the update results defined by Qualcomm. This will give more specific info
 * on the error and/or stage of error encountered
 */
#define FWUPDATE_QCRESULT_FILE L"QCRESULT.FLG"
