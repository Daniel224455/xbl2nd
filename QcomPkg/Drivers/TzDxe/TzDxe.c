/** @file TzDxe.c
  ...
  Copyright (c) 2012-2014, 2021 Copyright Qualcomm Technologies, Inc.  All Rights Reserved.
...
/*=============================================================================
 ...
 --------   ---      ----------------------------------------------------------
 03/02/21   pj       Added KeyStoreLoader call back on Windows
 05/10/19   mj	     Removed LoadKeyStore as not being used on Windows Platform.
  ...
  )
{
  ...
  // DO NOT REMOVE this call on Windows, it is needed for OPM keys capsule update use case.
  Status = LoadKeyStore();
