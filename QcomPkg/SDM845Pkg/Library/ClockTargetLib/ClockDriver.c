...
==============================================================================
  ...
  $Header: //components/rel/boot.xf/2.0/QcomPkg/SDM845Pkg/Library/ClockTargetLib/ClockDriver.c#11 $
...
{
  static int32 nVersion = -1; // -1 is illegal, and requires 
...
boolean Clock_EnableSource( ClockSourceType eSource )
{
  ...
  switch( eSource )
  {
    ...
    case SRC_GPLL5:
      pPLLCfg = &Clock_ConfigData.PLL5_Cfg[nVer];
      break;
...
boolean Clock_ConfigureSource( ClockSourceType eSource )
{
  ...
  switch( eSource )
  {
    ...
    case SRC_GPLL5:
      rtrn = Clock_ConfigurePLL(&Clock_ConfigData.PLL5_Cfg[nVer]);
      break;
