...
--------     ---     --------------------------------------------------- 
2019-06-26   jt      Remove UHS-1 capability for CLS
...
{
  DalPlatformInfoPlatformType platform_type = sdcc_bsp_get_platform_type();
  ...
  {
    /* Support 1.8V (non-CLS only) and 3.0V for external SD card. */
    caps0 &= ~HAL_SDHCI_CAPS_VOLTAGE_SUPPORT_3_0V_BMSK;
    caps0 |= HAL_SDHCI_CAPS_VOLTAGE_SUPPORT_3_0V_BMSK;
    ...
    /* Support SDR50/SDR104/DDR50 only for non-CLS */
    caps1 &= ~HAL_SDHCI_CAPS_SDR_50_SUPPORT_BMSK;
    caps1 &= ~HAL_SDHCI_CAPS_SDR_104_SUPPORT_BMSK;
    caps1 &= ~HAL_SDHCI_CAPS_DDR_50_SUPPORT_BMSK;
