...
/* Used in uFlags param of HAL_MDP_ControlPath_Config() to release resources assigned to control path */
#define HAL_MDP_FLAGS_CONTROL_PATH_RELEASE_RESOURCES            0x80000000
...
typedef struct _HAL_MDP_PhyIntf_TimingGenConfigType
{
   ...
   // DSC related
   bool32                                 bDSCEnable;                    /**< DSC enable                                               */
   uint32                                 uPixelPerClock;                /**< DP interface multiple pixel per clock mode               */
   bool32                                 bDTOEnable;                    /**< DTO enable                                               */
...
typedef struct _HAL_MDP_DSC_Data 
{
   /** Control Parameters */
   bool32                           bVideoMode;
...
typedef struct _HAL_MDP_Interface_EngineStatusType
{
   ...
   bool32            bIsInterfaceDone;                   /**< Interface done status                      */
...
*
****************************************************************************/
void HAL_MDP_DSC_Setup(HAL_MDP_DSCId                       eDSCEncEngineId,
