...
* 
* @brief
* This funcion will power off the uart driver.
*
* @par Dependencies
*   None
*   
...
* 
* @brief
* This funcion will power on the uart driver.
*
* @par Dependencies
*   None
*   
