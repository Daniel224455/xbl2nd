...
{  //  PM8998                  PMI8998           PM8005                    
   {PON_WARM_RST,        PON_NO_CFG_NEEDED, PON_NO_CFG_NEEDED, 0,0,0,0}, //Warm Reset
   {PON_HARD_RST,        PON_NO_CFG_NEEDED, PON_NO_CFG_NEEDED, 0,0,0,0}, //Hard Reset
   {PON_SHDN,            PON_NO_CFG_NEEDED, PON_NO_CFG_NEEDED, 0,0,0,0}, //Shutdown
   {PON_DVDD_HARD_RST,   PON_NO_CFG_NEEDED, PON_NO_CFG_NEEDED, 0,0,0,0}, //Dvdd hard reset
   {PON_DVDD_SHDN,       PON_NO_CFG_NEEDED, PON_NO_CFG_NEEDED, 0,0,0,0}  //DVDD Shutdown
};
...
{  //   PM8998             PMI8998                      PM8005               
   {PON_NO_CFG_NEEDED, PON_NO_CFG_NEEDED,           PON_NO_CFG_NEEDED, 0,0,0,0}, //Warm Reset
   {PON_NO_CFG_NEEDED, PON_NO_CFG_NEEDED,           PON_NO_CFG_NEEDED, 0,0,0,0}, //Hard Reset
   {PON_NO_CFG_NEEDED, PON_NO_CFG_NEEDED,           PON_NO_CFG_NEEDED, 0,0,0,0}, //Shutdown
   {PON_NO_CFG_NEEDED, PON_WARM_RST_THEN_DVDD_SHDN, PON_NO_CFG_NEEDED, 0,0,0,0}, //Dvdd hard reset
   {PON_NO_CFG_NEEDED, PON_WARM_RST_THEN_DVDD_SHDN, PON_NO_CFG_NEEDED, 0,0,0,0}  //DVDD Shutdown
};
...
{  //PM8998, PMI8998, PM8005, PMK8001, ...
   { 1,          1,      0,      3,     0,  0,  0},    //KPDPWR_N
   { 1,          1,      0,      3,     0,  0,  0},    //RESIN_N
   { 1,          1,      0,      3,     0,  0,  0},    //KPDPWR_AND_RESIN
   { 1,          1,      0,      3,     0,  0,  0}     //KPDPWR_OR_RESIN
};
