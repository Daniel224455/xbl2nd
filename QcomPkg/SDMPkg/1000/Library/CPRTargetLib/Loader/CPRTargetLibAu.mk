...
CPR_CONFIG_DIR = $(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Settings/CPR/$(VAR)
CPR_FUSES_DIR  = $(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Library/CPRTargetLib/target/$(TARGET_ID)
...
INC =  \
    -I$(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Library/CPRTargetLib/target/$(TARGET_ID) \
    -I$(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Library/CPRTargetLib/target/$(TARGET_ID)/hwio \
    -I$(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Library/CPRTargetLib/image/xbl/target/$(TARGET_ID) \
    -I$(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Settings/CPR/$(VAR) \
    ...
    -I$(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Library/CPRTargetLib \
    -I$(DEBUG_DIR) \
    -I$(WORKSPACE)/MdePkg \
...
$(OUTPUT_DIR)/cpr_voltage_plan_$(TARGET_ID).obj : $(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Settings/CPR/$(VAR)/cpr_voltage_plan_$(TARGET_ID).c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Settings/CPR/$(VAR)/cpr_voltage_plan_$(TARGET_ID).c

$(OUTPUT_DIR)/image/xbl/target/$(TARGET_ID)/cpr_image_target_init.obj : $(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Library/CPRTargetLib/image/xbl/target/$(TARGET_ID)/cpr_image_target_init.c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Library/CPRTargetLib/image/xbl/target/$(TARGET_ID)/cpr_image_target_init.c
...
$(OUTPUT_DIR)/image/xbl/target/$(TARGET_ID)/cpr_image_target.obj : $(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Library/CPRTargetLib/image/xbl/target/$(TARGET_ID)/cpr_image_target_au.c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Library/CPRTargetLib/image/xbl/target/$(TARGET_ID)/cpr_image_target_au.c
