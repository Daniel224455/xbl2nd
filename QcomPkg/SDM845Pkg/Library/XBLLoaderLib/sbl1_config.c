...
#define AOP_BOOT_LOG_STR (uint8 *)"AOP Image Loaded, Delta"
...
boot_procedure_func_type load_apdp_image_pre_procs[] = 
{
  ...
  /*Boot to DDI-> In XBL builds or any other builds the function below is stubbed out - does nothing)*/
//plc   boot_hand_control_to_DDR_Debug_Image_main,
...
===========================================================================*/
boot_procedure_func_type load_aop_pre_procs[] = 
{  
...
boot_configuration_table_entry sbl1_config_table[] = 
{
  ...
  {                               
    ...
    apdp_img_whitelist                  /* witelist_ptr*/
  },  
  ...
  /* SBL1 -> AOP */
  {
    ...
    GEN_IMG,                            /* target_img_id */
    CONFIG_IMG_ELF,                     /* target_img_type */
    SECBOOT_AOP_SW_TYPE,                /* target_img_sec_type */ 
    TRUE,                               /* load */
    TRUE,                               /* auth */
    FALSE,                              /* exec */
    FALSE,                              /* jump */
    NULL,                               /* exec_func */
    NULL,                               /* jump_func */
    load_aop_pre_procs,                               /* pre_procs */ 
    NULL,                               /* post_procs */
    aop_load_cancel,                    /* load_cancel */
    aop_partition_id,                   /* target_img_partition_id */
    (uint8*)AOP_BOOT_LOG_STR,           /* target_img_str */
    FALSE,                              /* boot_ssa_enabled */
    FALSE,                              /* enable_xpu */
    0x0,                                /* xpu_proc_id*/    
    0x0,                                /* sbl_qsee_interface_index */
    0x0,                                /* seg_elf_entry_point*/
    aop_img_whitelist                  /* witelist_ptr*/
  },
  ...
  /* SBL1 -> Qsee Dev config image  */
  {
    ...
    0x0,                                /* sbl_qsee_interface_index */
    0x0,                                /* seg_elf_entry_point*/
    devcfg_img_whitelist                /* witelist_ptr*/
  },
 ...
 /* SBL1 -> QSEE */
  {
    ...
    0x0,                                /* sbl_qsee_interface_index */
    0x0,                                /* seg_elf_entry_point*/
    qsee_img_whitelist                  /* witelist_ptr*/
  },
  ...
  /* SBL1 -> QHEE */
  {
    ...
    0x0,                                /* sbl_qsee_interface_index */
    0x0,                                /* seg_elf_entry_point*/
    qhee_img_whitelist                  /* witelist_ptr*/
  },
  ...
  /* SBL1 -> STI */
  {
    ...
    0x0,                                /* sbl_qsee_interface_index */
    0x0,                                /* seg_elf_entry_point*/
    sti_img_whitelist                   /* witelist_ptr*/
  },
  ...
  /* SBL1 -> ABL */
  {
    ...
    abl_img_whitelist                  /* witelist_ptr*/
  },  
  ...
  /* SBL1 -> APPSBL */
  {
    ...
    0x0,                                /* sbl_qsee_interface_index */
    SCL_XBL_CORE_CODE_BASE,             /* seg_elf_entry_point*/
    xbl_core_img_whitelist              /* witelist_ptr*/
  },
