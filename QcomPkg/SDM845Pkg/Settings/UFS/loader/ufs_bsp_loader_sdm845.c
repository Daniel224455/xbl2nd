/**********************************************************************
* ufs_bsp_boot_sdm845.c
*
* Board support file for SDM845
*
...
---------------------------------------------------------------------- 
2018-01-19   jt      Add cache invalidate option  
...
static struct ufs_mphy_init_item ufs_bsp_mphy_init_table[] = {
   ...
   { HWIO_UFS_MEM_UFS_PHY_RX_SIGDET_CTRL2_ADDR, 0x6E},
   ...
   { HWIO_UFS_MEM_UFS_PHY_RX_MIN_HIBERN8_TIME_ADDR, 0x9A},  
   {0,0}};
...
static struct ufs_mphy_init_item ufs_bsp_mphy_2_lane_init_table[] = {
     { HWIO_UFS_MEM_QSERDES_TX1_LANE_MODE_1_ADDR,                       0x06},
     { HWIO_UFS_MEM_QSERDES_RX1_SIGDET_LVL_ADDR,                        0x24},
     { HWIO_UFS_MEM_QSERDES_RX1_SIGDET_CNTRL_ADDR,                      0x0F},
     { HWIO_UFS_MEM_QSERDES_RX1_SIGDET_DEGLITCH_CNTRL_ADDR,             0x1E},
     { HWIO_UFS_MEM_QSERDES_RX1_RX_INTERFACE_MODE_ADDR,                 0x40},
     { HWIO_UFS_MEM_QSERDES_RX1_UCDR_FASTLOCK_FO_GAIN_ADDR,             0x0B},
     { HWIO_UFS_MEM_QSERDES_RX1_RX_TERM_BW_ADDR,                        0x5B},
     { HWIO_UFS_MEM_QSERDES_RX1_RX_EQU_ADAPTOR_CNTRL2_ADDR,             0x06},
     { HWIO_UFS_MEM_QSERDES_RX1_RX_EQU_ADAPTOR_CNTRL3_ADDR,             0x04},
     { HWIO_UFS_MEM_QSERDES_RX1_RX_EQU_ADAPTOR_CNTRL4_ADDR,             0x1B},
     { HWIO_UFS_MEM_QSERDES_RX1_UCDR_SVS_SO_GAIN_HALF_ADDR,             0x04},
     { HWIO_UFS_MEM_QSERDES_RX1_UCDR_SVS_SO_GAIN_QUARTER_ADDR,          0x04},
     { HWIO_UFS_MEM_QSERDES_RX1_UCDR_SVS_SO_GAIN_ADDR,                  0x04},
     { HWIO_UFS_MEM_QSERDES_RX1_UCDR_SO_SATURATION_AND_ENABLE_ADDR,     0x4B},
     { HWIO_UFS_MEM_QSERDES_RX1_UCDR_PI_CONTROLS_ADDR,                  0x81},
     { HWIO_UFS_MEM_QSERDES_RX1_UCDR_FASTLOCK_COUNT_LOW_ADDR,           0x80},  
     { HWIO_UFS_MEM_UFS_PHY_MULTI_LANE_CTRL1_ADDR,                      0x02},
     { HWIO_UFS_MEM_QSERDES_TX1_RES_CODE_LANE_OFFSET_TX_ADDR,           0x04}, 
     { HWIO_UFS_MEM_QSERDES_TX1_RES_CODE_LANE_OFFSET_RX_ADDR,           0x07}, 
     { HWIO_UFS_MEM_QSERDES_RX1_RX_MODE_00_ADDR,                        0x59}, 
     {0,0}};

static struct ufs_mphy_init_item ufs_bsp_mphy_2_lane_init_table_rumi[] = {
     { HWIO_QSERDES_RX1_PWM_CNTRL1_ADDR,                        0x08},
     { HWIO_QSERDES_RX1_PWM_CNTRL2_ADDR,                        0x40},
     { HWIO_QSERDES_RX1_PWM_NDIV_ADDR,                          0x30},
     { HWIO_QSERDES_RX1_CDR_CONTROL_ADDR,                       0x40},
     { HWIO_QSERDES_RX1_CDR_CONTROL_HALF_ADDR,                  0x0C},
     { HWIO_QSERDES_RX1_CDR_CONTROL_QUARTER_ADDR,               0x12},
     { HWIO_QSERDES_RX1_SIGDET_CNTRL_ADDR,                      0xc0},
     { HWIO_QSERDES_RX1_SIGDET_CNTRL2_ADDR,                     0x07},
     { HWIO_QSERDES_RX1_RX_BAND_ADDR,                           0x06},
     { HWIO_QSERDES_RX1_UFS_CNTRL_ADDR,                         0x00},
     { HWIO_QSERDES_RX1_RX_IQ_RXDET_EN_ADDR,                    0xf3},
     { HWIO_UFS_PHY_MULTI_LANE_CTRL1_ADDR,                      0x02},
     {0,0}};
