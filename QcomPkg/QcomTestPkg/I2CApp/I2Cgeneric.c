...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 30/01/17   ska     Test code enhance, KPI calculation
...
static void i2c_test_cmd_help (void)
{
  ...
  DEBUG((EFI_D_ERROR,"  -d, --detect <1>           To can the I2C core for Slave devices\n"));
  ...
  DEBUG((EFI_D_ERROR,"  // Scans the CORE for the Slaves connected.\n"));
  DEBUG((EFI_D_ERROR,"  start I2CTest \"-c 12 -d 1\"\n\n"));
...
i2c_status i2c_bus_scan (uint32 i2c_core_number)
{
  ...
  DEBUG((EFI_D_ERROR, "===========SCANNING THE BUS FOR SLAVES===========\n"));
  DEBUG((EFI_D_ERROR, "Below are the Slave device found :::: \n"));
  ...
  DEBUG((EFI_D_ERROR, "No of Slave devices found : %d \n", no_slvs_detected));
...
error:
  ...
  DEBUG((EFI_D_ERROR, "******* Done Scanning for Slaves *************\n\n"));
