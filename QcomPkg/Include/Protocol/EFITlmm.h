...
*/
/*=============================================================================
  Copyright (c) 2011-2012, 2021 Qualcomm Technologies, Incorporated.
  All rights reserved.
...
/* This is a duplicate of the DAL_GPIO_CFG_EX structure from DDITlmm.h used 
  on DAL environments.  */
#define EFI_GPIO_CFG_EX(gpio, func, dir, pull, drive, type) \
         (((gpio) & 0x3FF)<< 4 | \
          ((func) & 0xF)|        \
          ((dir)  & 0x1) << 14|  \
          ((pull) & 0x3) << 15|  \
          ((drive)& 0xF) << 17|  \
          ((type) & 0x1) << 23| 0x20000000)
