...
/**
  ...
  Header description for the SC8180X apps clock driver BSP format.
*/
/*
  ====================================================================
...
#include "../../Library/HALclkLib/HALclkAPCS.h"
...
#define PEP_INITIAL_GFX_VOLTAGE 752000      // NOMINAL GFX voltage in uV
...
typedef enum
{
  ...
  CLOCK_APPS_CPU_C4  = HAL_CLK_APCS_CPU_CLUSTER1_C0,
  CLOCK_APPS_CPU_C5  = HAL_CLK_APCS_CPU_CLUSTER1_C1,
  CLOCK_APPS_CPU_C6  = HAL_CLK_APCS_CPU_CLUSTER1_C2,
  CLOCK_APPS_CPU_C7  = HAL_CLK_APCS_CPU_CLUSTER1_C3,
  CLOCK_APPS_CPU_L3  = HAL_CLK_APCS_CPU_L3,
  CLOCK_APPS_CPU_TOTAL,
  CLOCK_APPS_CPU_CLUSTER_0_TOTAL = CLOCK_APPS_CPU_C4,
