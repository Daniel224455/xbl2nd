...
#define MEMORY_REGION26 {SCL_IPA_GSI_SHRAM_BASE ,  SCL_IPA_GSI_SHRAM_SIZE,  "IPA SHRAM region",  "IPASHRAM.BIN"}
...
#define DEVCFG_IMG_WHITELIST {{DEVCFG_META_SECTION_BASE,0x14},{DEVCFG_DATA_SECTION_BASE,DEVCFG_DATA_SECTION_SIZE},{SCL_TZ_STAT_BASE,SCL_TZ_STAT_BASE_SIZE},{SCL_pIMEM_BASE,SCL_pIMEM_SIZE},{SCL_QHEE_CODE_BASE,SCL_QHEE_TOTAL_SIZE},{0,0}}
...
#define DDI_DATA_WHITELIST {{SCL_SBL1_DDR_DSF_DATA_BASE,SCL_SBL1_DDR_DSF_DATA_SIZE},{0,0}}
