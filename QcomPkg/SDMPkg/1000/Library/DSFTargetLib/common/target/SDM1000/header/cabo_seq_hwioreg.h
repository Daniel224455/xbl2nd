...
///////////////////////////////////////////////////////////////////////////////////////////////
//
// cabo_seq_hwioreg.h : automatically generated by Autoseq  3.5 11/3/2017 
// User Name:amareshc
//
...
#define HWIO_CBU_TOP_CLK_CTRL_RMSK                                   0x001fffff
...
#define HWIO_CBU_TOP_CLK_CTRL_ASRA_CG_EN_BMSK                        0x00100000
#define HWIO_CBU_TOP_CLK_CTRL_ASRA_CG_EN_SHFT                              0x14
...
#define HWIO_CBU_TOP_RWOPT_CFG_m_RMSK                                0x000001ff
...
#define HWIO_CBU_TOP_RWOPT_CFG_m_BANK_PEND_DEP_ON_UNAVBL_BMSK        0x00000100
#define HWIO_CBU_TOP_RWOPT_CFG_m_BANK_PEND_DEP_ON_UNAVBL_SHFT               0x8
...
#define HWIO_CBU_TOP_ASRA_CFG_m_ADDR(base, m)                        (base+0x270+0x4*m)
#define HWIO_CBU_TOP_ASRA_CFG_m_PHYS(base, m)                        (base+0x270+0x4*m)
#define HWIO_CBU_TOP_ASRA_CFG_m_RMSK                                 0x000000ff
#define HWIO_CBU_TOP_ASRA_CFG_m_SHFT                                          0
#define HWIO_CBU_TOP_ASRA_CFG_m_MAXm                                          3
#define HWIO_CBU_TOP_ASRA_CFG_m_INI(base, m)                         \
	in_dword_masked ( HWIO_CBU_TOP_ASRA_CFG_m_ADDR(base, m), HWIO_CBU_TOP_ASRA_CFG_m_RMSK)
#define HWIO_CBU_TOP_ASRA_CFG_m_INMI(base, m, mask)                  \
	in_dword_masked ( HWIO_CBU_TOP_ASRA_CFG_m_ADDR(base, m), mask) 
#define HWIO_CBU_TOP_ASRA_CFG_m_OUTI(base, m, val)                   \
	out_dword( HWIO_CBU_TOP_ASRA_CFG_m_ADDR(base, m), val)
#define HWIO_CBU_TOP_ASRA_CFG_m_OUTMI(base, m, mask, val)            \
	do {\
		HWIO_INTLOCK(); \
		out_dword_masked_ns(HWIO_CBU_TOP_ASRA_CFG_m_ADDR(base, m), mask, val, HWIO_CBU_TOP_ASRA_CFG_m_INI(base, m)); \
		HWIO_INTFREE();\
	} while (0) 

#define HWIO_CBU_TOP_ASRA_CFG_m_ASRA_BL16_TH_BMSK                    0x000000f0
#define HWIO_CBU_TOP_ASRA_CFG_m_ASRA_BL16_TH_SHFT                           0x4

#define HWIO_CBU_TOP_ASRA_CFG_m_RFU_3_1_BMSK                         0x0000000e
#define HWIO_CBU_TOP_ASRA_CFG_m_RFU_3_1_SHFT                                0x1

#define HWIO_CBU_TOP_ASRA_CFG_m_EN_BMSK                              0x00000001
#define HWIO_CBU_TOP_ASRA_CFG_m_EN_SHFT                                     0x0
...
//// Register PD_TIMING_CFG_TCKFSPE_SE ////

#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ADDR(x)                    (x+0x00000420)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_PHYS(x)                    (x+0x00000420)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_RMSK                       0x0ff0ffff
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_SHFT                                0
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_IN(x)                      \
	in_dword_masked ( HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ADDR(x), HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_RMSK)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_INM(x, mask)               \
	in_dword_masked ( HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ADDR(x), mask) 
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_OUT(x, val)                \
	out_dword( HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ADDR(x), val)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_OUTM(x, mask, val)         \
	do {\
		HWIO_INTLOCK(); \
		out_dword_masked_ns(HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ADDR(x), mask, val, HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_IN(x)); \
		HWIO_INTFREE();\
	} while (0) 

#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_MIN_CK_BMSK                0x0ff00000
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_MIN_CK_SHFT                      0x14

#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_IN_PS_BMSK                 0x0000ffff
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_IN_PS_SHFT                        0x0

//// Register PD_TIMING_CFG_TCKFSPX_SE ////

#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ADDR(x)                    (x+0x00000424)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_PHYS(x)                    (x+0x00000424)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_RMSK                       0x0ff0ffff
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_SHFT                                0
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_IN(x)                      \
	in_dword_masked ( HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ADDR(x), HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_RMSK)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_INM(x, mask)               \
	in_dword_masked ( HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ADDR(x), mask) 
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_OUT(x, val)                \
	out_dword( HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ADDR(x), val)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_OUTM(x, mask, val)         \
	do {\
		HWIO_INTLOCK(); \
		out_dword_masked_ns(HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ADDR(x), mask, val, HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_IN(x)); \
		HWIO_INTFREE();\
	} while (0) 

#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_MIN_CK_BMSK                0x0ff00000
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_MIN_CK_SHFT                      0x14

#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_IN_PS_BMSK                 0x0000ffff
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_IN_PS_SHFT                        0x0
...
//// Register PD_TIMING_CFG_TCKFSPE_SE_ACT ////

#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_ADDR(x)                (x+0x00000b18)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_PHYS(x)                (x+0x00000b18)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_RMSK                   0x000000ff
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_SHFT                            0
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_IN(x)                  \
	in_dword_masked ( HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_ADDR(x), HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_RMSK)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_INM(x, mask)           \
	in_dword_masked ( HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_ADDR(x), mask) 
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_OUT(x, val)            \
	out_dword( HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_ADDR(x), val)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_OUTM(x, mask, val)     \
	do {\
		HWIO_INTLOCK(); \
		out_dword_masked_ns(HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_ADDR(x), mask, val, HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_IN(x)); \
		HWIO_INTFREE();\
	} while (0) 

#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_UPDATE_VALUE_BMSK      0x000000ff
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPE_SE_ACT_UPDATE_VALUE_SHFT             0x0

//// Register PD_TIMING_CFG_TCKFSPX_SE_ACT ////

#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_ADDR(x)                (x+0x00000b1c)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_PHYS(x)                (x+0x00000b1c)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_RMSK                   0x000000ff
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_SHFT                            0
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_IN(x)                  \
	in_dword_masked ( HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_ADDR(x), HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_RMSK)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_INM(x, mask)           \
	in_dword_masked ( HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_ADDR(x), mask) 
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_OUT(x, val)            \
	out_dword( HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_ADDR(x), val)
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_OUTM(x, mask, val)     \
	do {\
		HWIO_INTLOCK(); \
		out_dword_masked_ns(HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_ADDR(x), mask, val, HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_IN(x)); \
		HWIO_INTFREE();\
	} while (0) 

#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_UPDATE_VALUE_BMSK      0x000000ff
#define HWIO_DTC_PD_TIMING_CFG_TCKFSPX_SE_ACT_UPDATE_VALUE_SHFT             0x0
...
#define HWIO_GLOBAL_CLK_CTRL_RMSK                                    0x0000031f
...
#define HWIO_GLOBAL_CLK_CTRL_PEG_CG_EN_BMSK                          0x00000200
#define HWIO_GLOBAL_CLK_CTRL_PEG_CG_EN_SHFT                                 0x9
...
#define HWIO_GLOBAL_IDLE_STATUS_RMSK                                 0xc003ffff
...
#define HWIO_GLOBAL_IDLE_STATUS_IDLE_BMSK                            0x40000000
#define HWIO_GLOBAL_IDLE_STATUS_IDLE_SHFT                                  0x1e
...
#define HWIO_ISU_RDP_CFG_RMSK                                        0x000001ff
...
#define HWIO_ISU_RDP_CFG_ERR_CREDIT_DBG_EN_BMSK                      0x00000100
#define HWIO_ISU_RDP_CFG_ERR_CREDIT_DBG_EN_SHFT                             0x8
...
#define HWIO_MPE_CCP_OPT_CFG_RMSK                                    0x00000f33
...
#define HWIO_MPE_CCP_OPT_CFG_RTR_SR_OPT_WINDOW_CTRL_BMSK             0x00000c00
#define HWIO_MPE_CCP_OPT_CFG_RTR_SR_OPT_WINDOW_CTRL_SHFT                    0xa

#define HWIO_MPE_CCP_OPT_CFG_WR_OPT_WINDOW_EN_BMSK                   0x00000200
#define HWIO_MPE_CCP_OPT_CFG_WR_OPT_WINDOW_EN_SHFT                          0x9

#define HWIO_MPE_CCP_OPT_CFG_RD_OPT_WINDOW_EN_BMSK                   0x00000100
#define HWIO_MPE_CCP_OPT_CFG_RD_OPT_WINDOW_EN_SHFT                          0x8
...
#define HWIO_MPE_HKS_OPT_CFG_RMSK                                    0x00011f01
...
#define HWIO_MPE_HKS_OPT_CFG_SE_CK_SUPPORT_BMSK                      0x00010000
#define HWIO_MPE_HKS_OPT_CFG_SE_CK_SUPPORT_SHFT                            0x10
...
#define HWIO_OSU_CLK_CTRL_RMSK                                       0x003113ff
...
#define HWIO_OSU_CLK_CTRL_PWRS_IDLE_CNTR_CLK_CG_EN_BMSK              0x00200000
#define HWIO_OSU_CLK_CTRL_PWRS_IDLE_CNTR_CLK_CG_EN_SHFT                    0x15
...
#define HWIO_OSU_PWRS_TRANS_LAT_CFG_CPWRS_m_NPWRS_n_RMSK             0x00000fff
...
#define HWIO_OSU_PWRS_TRANS_LAT_CFG_CPWRS_m_NPWRS_n_LATENCY_BMSK     0x00000fff
...
#define HWIO_OSU_IDLE_STATUS_RMSK                                    0x00000007
...
#define HWIO_OSU_IDLE_STATUS_IDLE_BMSK                               0x00000004
#define HWIO_OSU_IDLE_STATUS_IDLE_SHFT                                      0x2
...
//// Register PWRS_IDLE_CNTR_CTRL ////

#define HWIO_OSU_PWRS_IDLE_CNTR_CTRL_ADDR(x)                         (x+0x00000424)
#define HWIO_OSU_PWRS_IDLE_CNTR_CTRL_PHYS(x)                         (x+0x00000424)
#define HWIO_OSU_PWRS_IDLE_CNTR_CTRL_RMSK                            0x0000000f
#define HWIO_OSU_PWRS_IDLE_CNTR_CTRL_SHFT                                     0
#define HWIO_OSU_PWRS_IDLE_CNTR_CTRL_IN(x)                           \
	in_dword_masked ( HWIO_OSU_PWRS_IDLE_CNTR_CTRL_ADDR(x), HWIO_OSU_PWRS_IDLE_CNTR_CTRL_RMSK)
#define HWIO_OSU_PWRS_IDLE_CNTR_CTRL_INM(x, mask)                    \
	in_dword_masked ( HWIO_OSU_PWRS_IDLE_CNTR_CTRL_ADDR(x), mask) 
#define HWIO_OSU_PWRS_IDLE_CNTR_CTRL_OUT(x, val)                     \
	out_dword( HWIO_OSU_PWRS_IDLE_CNTR_CTRL_ADDR(x), val)
#define HWIO_OSU_PWRS_IDLE_CNTR_CTRL_OUTM(x, mask, val)              \
	do {\
		HWIO_INTLOCK(); \
		out_dword_masked_ns(HWIO_OSU_PWRS_IDLE_CNTR_CTRL_ADDR(x), mask, val, HWIO_OSU_PWRS_IDLE_CNTR_CTRL_IN(x)); \
		HWIO_INTFREE();\
	} while (0) 

#define HWIO_OSU_PWRS_IDLE_CNTR_CTRL_PWRS_IDLE_CNTR_EN_BMSK          0x0000000f
#define HWIO_OSU_PWRS_IDLE_CNTR_CTRL_PWRS_IDLE_CNTR_EN_SHFT                 0x0

//// Register PWRS_IDLE_CNTR_m_n_CFG ////

#define HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_ADDR(base, m, n)             (base+0x430+0x20*m+0x4*n)
#define HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_PHYS(base, m, n)             (base+0x430+0x20*m+0x4*n)
#define HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_RMSK                         0x000000ff
#define HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_SHFT                                  0
#define HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_MAXm                                  3
#define HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_MAXn                                  3
#define HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_INI2(base, m, n)             \
	in_dword_masked ( HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_ADDR(base, m, n), HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_RMSK)
#define HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_INMI2(base, m, n, mask)      \
	in_dword_masked ( HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_ADDR(base, m, n), mask) 
#define HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_OUTI2(base, m, n, val)       \
	out_dword( HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_ADDR(base, m, n), val)
#define HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_OUTMI2(base, m, n, mask, val) \
	do {\
		HWIO_INTLOCK(); \
		out_dword_masked_ns(HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_ADDR(base, m, n), mask, val, HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_INI2(base, m, n)); \
		HWIO_INTFREE();\
	} while (0) 

#define HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_PWRS_IDLE_CNTR_LOAD_VAL_BMSK 0x000000ff
#define HWIO_OSU_PWRS_IDLE_CNTR_m_n_CFG_PWRS_IDLE_CNTR_LOAD_VAL_SHFT        0x0
...
//// Register ATB_DUMP_CTRL ////

#define HWIO_PERFMON_ATB_DUMP_CTRL_ADDR(x)                           (x+0x00000044)
#define HWIO_PERFMON_ATB_DUMP_CTRL_PHYS(x)                           (x+0x00000044)
#define HWIO_PERFMON_ATB_DUMP_CTRL_RMSK                              0xf000ffff
#define HWIO_PERFMON_ATB_DUMP_CTRL_SHFT                                       0
#define HWIO_PERFMON_ATB_DUMP_CTRL_IN(x)                             \
	in_dword_masked ( HWIO_PERFMON_ATB_DUMP_CTRL_ADDR(x), HWIO_PERFMON_ATB_DUMP_CTRL_RMSK)
#define HWIO_PERFMON_ATB_DUMP_CTRL_INM(x, mask)                      \
	in_dword_masked ( HWIO_PERFMON_ATB_DUMP_CTRL_ADDR(x), mask) 
#define HWIO_PERFMON_ATB_DUMP_CTRL_OUT(x, val)                       \
	out_dword( HWIO_PERFMON_ATB_DUMP_CTRL_ADDR(x), val)
#define HWIO_PERFMON_ATB_DUMP_CTRL_OUTM(x, mask, val)                \
	do {\
		HWIO_INTLOCK(); \
		out_dword_masked_ns(HWIO_PERFMON_ATB_DUMP_CTRL_ADDR(x), mask, val, HWIO_PERFMON_ATB_DUMP_CTRL_IN(x)); \
		HWIO_INTFREE();\
	} while (0) 

#define HWIO_PERFMON_ATB_DUMP_CTRL_NUM_COUNTERS_BMSK                 0xf0000000
#define HWIO_PERFMON_ATB_DUMP_CTRL_NUM_COUNTERS_SHFT                       0x1c

#define HWIO_PERFMON_ATB_DUMP_CTRL_COUNTER_SELECT_BMSK               0x0000ffff
#define HWIO_PERFMON_ATB_DUMP_CTRL_COUNTER_SELECT_SHFT                      0x0
...
//// Register GLOBAL_IDLE_FILTER_CFG ////

#define HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_ADDR(x)                  (x+0x00000120)
#define HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_PHYS(x)                  (x+0x00000120)
#define HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_RMSK                     0xc000ffff
#define HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_SHFT                              0
#define HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_IN(x)                    \
	in_dword_masked ( HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_ADDR(x), HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_RMSK)
#define HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_INM(x, mask)             \
	in_dword_masked ( HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_ADDR(x), mask) 
#define HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_OUT(x, val)              \
	out_dword( HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_ADDR(x), val)
#define HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_OUTM(x, mask, val)       \
	do {\
		HWIO_INTLOCK(); \
		out_dword_masked_ns(HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_ADDR(x), mask, val, HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_IN(x)); \
		HWIO_INTFREE();\
	} while (0) 

#define HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_RANK_MATCH_BMSK          0xc0000000
#define HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_RANK_MATCH_SHFT                0x1e

#define HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_RANK_BANK_MATCH_BMSK     0x0000ffff
#define HWIO_PERFMON_GLOBAL_IDLE_FILTER_CFG_RANK_BANK_MATCH_SHFT            0x0

//// Register GLOBAL_IDLE_HIST_CFG_m ////

#define HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_ADDR(base, m)            (base+0x124+0x4*m)
#define HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_PHYS(base, m)            (base+0x124+0x4*m)
#define HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_RMSK                     0x000000ff
#define HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_SHFT                              0
#define HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_MAXm                              2
#define HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_INI(base, m)             \
	in_dword_masked ( HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_ADDR(base, m), HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_RMSK)
#define HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_INMI(base, m, mask)      \
	in_dword_masked ( HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_ADDR(base, m), mask) 
#define HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_OUTI(base, m, val)       \
	out_dword( HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_ADDR(base, m), val)
#define HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_OUTMI(base, m, mask, val) \
	do {\
		HWIO_INTLOCK(); \
		out_dword_masked_ns(HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_ADDR(base, m), mask, val, HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_INI(base, m)); \
		HWIO_INTFREE();\
	} while (0) 

#define HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_BIN_THRESHOLD_BMSK       0x000000ff
#define HWIO_PERFMON_GLOBAL_IDLE_HIST_CFG_m_BIN_THRESHOLD_SHFT              0x0
...
//// Register ISU_OCC_FILTER_CFG ////

#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_ADDR(x)                      (x+0x00000600)
#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_PHYS(x)                      (x+0x00000600)
#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_RMSK                         0x007fffff
#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_SHFT                                  0
#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_IN(x)                        \
	in_dword_masked ( HWIO_PERFMON_ISU_OCC_FILTER_CFG_ADDR(x), HWIO_PERFMON_ISU_OCC_FILTER_CFG_RMSK)
#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_INM(x, mask)                 \
	in_dword_masked ( HWIO_PERFMON_ISU_OCC_FILTER_CFG_ADDR(x), mask) 
#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_OUT(x, val)                  \
	out_dword( HWIO_PERFMON_ISU_OCC_FILTER_CFG_ADDR(x), val)
#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_OUTM(x, mask, val)           \
	do {\
		HWIO_INTLOCK(); \
		out_dword_masked_ns(HWIO_PERFMON_ISU_OCC_FILTER_CFG_ADDR(x), mask, val, HWIO_PERFMON_ISU_OCC_FILTER_CFG_IN(x)); \
		HWIO_INTFREE();\
	} while (0) 

#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_RCH_THRESHOLD_BMSK           0x007f0000
#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_RCH_THRESHOLD_SHFT                 0x10

#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_RFU_15_12_BMSK               0x0000f000
#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_RFU_15_12_SHFT                      0xc

#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_CMDQ_THRESHOLD_BMSK          0x00000f00
#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_CMDQ_THRESHOLD_SHFT                 0x8

#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_RFU_7_BMSK                   0x00000080
#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_RFU_7_SHFT                          0x7

#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_WBUF_THRESHOLD_BMSK          0x0000007f
#define HWIO_PERFMON_ISU_OCC_FILTER_CFG_WBUF_THRESHOLD_SHFT                 0x0

//// Register ISU_PL_FILTER_CFG ////

#define HWIO_PERFMON_ISU_PL_FILTER_CFG_ADDR(x)                       (x+0x00000604)
#define HWIO_PERFMON_ISU_PL_FILTER_CFG_PHYS(x)                       (x+0x00000604)
#define HWIO_PERFMON_ISU_PL_FILTER_CFG_RMSK                          0xffffffff
#define HWIO_PERFMON_ISU_PL_FILTER_CFG_SHFT                                   0
#define HWIO_PERFMON_ISU_PL_FILTER_CFG_IN(x)                         \
	in_dword_masked ( HWIO_PERFMON_ISU_PL_FILTER_CFG_ADDR(x), HWIO_PERFMON_ISU_PL_FILTER_CFG_RMSK)
#define HWIO_PERFMON_ISU_PL_FILTER_CFG_INM(x, mask)                  \
	in_dword_masked ( HWIO_PERFMON_ISU_PL_FILTER_CFG_ADDR(x), mask) 
#define HWIO_PERFMON_ISU_PL_FILTER_CFG_OUT(x, val)                   \
	out_dword( HWIO_PERFMON_ISU_PL_FILTER_CFG_ADDR(x), val)
#define HWIO_PERFMON_ISU_PL_FILTER_CFG_OUTM(x, mask, val)            \
	do {\
		HWIO_INTLOCK(); \
		out_dword_masked_ns(HWIO_PERFMON_ISU_PL_FILTER_CFG_ADDR(x), mask, val, HWIO_PERFMON_ISU_PL_FILTER_CFG_IN(x)); \
		HWIO_INTFREE();\
	} while (0) 

#define HWIO_PERFMON_ISU_PL_FILTER_CFG_SHUB_RDPL_AREQP_MATCH_BMSK    0xff000000
#define HWIO_PERFMON_ISU_PL_FILTER_CFG_SHUB_RDPL_AREQP_MATCH_SHFT          0x18

#define HWIO_PERFMON_ISU_PL_FILTER_CFG_SHUB_WRPL_AREQP_MATCH_BMSK    0x00ff0000
#define HWIO_PERFMON_ISU_PL_FILTER_CFG_SHUB_WRPL_AREQP_MATCH_SHFT          0x10

#define HWIO_PERFMON_ISU_PL_FILTER_CFG_INTRN_RDPL_AREQP_MATCH_BMSK   0x0000ff00
#define HWIO_PERFMON_ISU_PL_FILTER_CFG_INTRN_RDPL_AREQP_MATCH_SHFT          0x8

#define HWIO_PERFMON_ISU_PL_FILTER_CFG_INTRN_WRPL_AREQP_MATCH_BMSK   0x000000ff
#define HWIO_PERFMON_ISU_PL_FILTER_CFG_INTRN_WRPL_AREQP_MATCH_SHFT          0x0

//// Register ISU_URGENCY_FILTER_CFG ////

#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_ADDR(x)                  (x+0x00000608)
#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_PHYS(x)                  (x+0x00000608)
#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_RMSK                     0x0000ffff
#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_SHFT                              0
#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_IN(x)                    \
	in_dword_masked ( HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_ADDR(x), HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_RMSK)
#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_INM(x, mask)             \
	in_dword_masked ( HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_ADDR(x), mask) 
#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_OUT(x, val)              \
	out_dword( HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_ADDR(x), val)
#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_OUTM(x, mask, val)       \
	do {\
		HWIO_INTLOCK(); \
		out_dword_masked_ns(HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_ADDR(x), mask, val, HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_IN(x)); \
		HWIO_INTFREE();\
	} while (0) 

#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_AREQP_MATCH_BMSK         0x0000ff00
#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_AREQP_MATCH_SHFT                0x8

#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_RFU_7_BMSK               0x00000080
#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_RFU_7_SHFT                      0x7

#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_MP_TH_BMSK               0x00000070
#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_MP_TH_SHFT                      0x4

#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_RFU_3_BMSK               0x00000008
#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_RFU_3_SHFT                      0x3

#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_HP_TH_BMSK               0x00000007
#define HWIO_PERFMON_ISU_URGENCY_FILTER_CFG_HP_TH_SHFT                      0x0
...
#define HWIO_SHKE_DT_REQ_CTRL_RMSK                                   0x01ff0731
...
#define HWIO_SHKE_DT_REQ_CTRL_STALL_DT_B4_FSW_DT_BMSK                0x01000000
#define HWIO_SHKE_DT_REQ_CTRL_STALL_DT_B4_FSW_DT_SHFT                      0x18
...
#define HWIO_SHKE_FSW_MRW_BF_ZQCAL_RMSK                              0xffffffff
...
#define HWIO_SHKE_FSW_MRW_BF_ZQCAL_CMD_SELECT_BMSK                   0xffffffff
...
#define HWIO_SHKE_FSW_MRW_BF_STALL_RMSK                              0xffffffff
...
#define HWIO_SHKE_FSW_MRW_BF_STALL_CMD_SELECT_BMSK                   0xffffffff
...
#define HWIO_SHKE_FSW_MRW_DUR_STALL_RMSK                             0xffffffff
...
#define HWIO_SHKE_FSW_MRW_DUR_STALL_CMD_SELECT_BMSK                  0xffffffff
...
#define HWIO_SHKE_FSW_MRW_BF_UNSTALL_RMSK                            0xffffffff
...
#define HWIO_SHKE_FSW_MRW_BF_UNSTALL_CMD_SELECT_BMSK                 0xffffffff
...
#define HWIO_SHKE_CMD_SET_CFG_n_MAXn                                         31
...
#define HWIO_SHKE_CMD_SET_STAGGER_CFG_n_MAXn                                 31
...
#define HWIO_SHKE_SW_CMD_SEQ_RMSK                                    0xffffffff
...
#define HWIO_SHKE_SW_CMD_SEQ_CMD_SELECT_BMSK                         0xffffffff
...
//// Register SW_CMD_SEQ_PRIORITY ////

#define HWIO_SHKE_SW_CMD_SEQ_PRIORITY_ADDR(x)                        (x+0x00000814)
#define HWIO_SHKE_SW_CMD_SEQ_PRIORITY_PHYS(x)                        (x+0x00000814)
#define HWIO_SHKE_SW_CMD_SEQ_PRIORITY_RMSK                           0x00000003
#define HWIO_SHKE_SW_CMD_SEQ_PRIORITY_SHFT                                    0
#define HWIO_SHKE_SW_CMD_SEQ_PRIORITY_IN(x)                          \
	in_dword_masked ( HWIO_SHKE_SW_CMD_SEQ_PRIORITY_ADDR(x), HWIO_SHKE_SW_CMD_SEQ_PRIORITY_RMSK)
#define HWIO_SHKE_SW_CMD_SEQ_PRIORITY_INM(x, mask)                   \
	in_dword_masked ( HWIO_SHKE_SW_CMD_SEQ_PRIORITY_ADDR(x), mask) 
#define HWIO_SHKE_SW_CMD_SEQ_PRIORITY_OUT(x, val)                    \
	out_dword( HWIO_SHKE_SW_CMD_SEQ_PRIORITY_ADDR(x), val)
#define HWIO_SHKE_SW_CMD_SEQ_PRIORITY_OUTM(x, mask, val)             \
	do {\
		HWIO_INTLOCK(); \
		out_dword_masked_ns(HWIO_SHKE_SW_CMD_SEQ_PRIORITY_ADDR(x), mask, val, HWIO_SHKE_SW_CMD_SEQ_PRIORITY_IN(x)); \
		HWIO_INTFREE();\
	} while (0) 

#define HWIO_SHKE_SW_CMD_SEQ_PRIORITY_PRIORITY_BMSK                  0x00000003
#define HWIO_SHKE_SW_CMD_SEQ_PRIORITY_PRIORITY_SHFT                         0x0

//// Register WDOG_CMD_SEQ ////

#define HWIO_SHKE_WDOG_CMD_SEQ_ADDR(x)                               (x+0x00000820)
#define HWIO_SHKE_WDOG_CMD_SEQ_PHYS(x)                               (x+0x00000820)
#define HWIO_SHKE_WDOG_CMD_SEQ_RMSK                                  0xffffffff
...
#define HWIO_SHKE_WDOG_CMD_SEQ_CMD_SELECT_BMSK                       0xffffffff
...
#define HWIO_SHKE_STALL_STATUS_RMSK                                  0x00000003
...
#define HWIO_SHKE_STALL_STATUS_FSM_STATE_BMSK                        0x00000003
