...
function(tablegen project ofn)
  ...
  # Silver .td files are not in the regular place.
  if (QUIC_SILVER)
    set(HEXAGON_TD_INC -I "${CMAKE_CURRENT_SOURCE_DIR}/Silver" ${HEXAGON_TD_INC})
    file(GLOB ag_tds "${CMAKE_CURRENT_SOURCE_DIR}/Silver/*.td")
    set(global_tds ${ag_tds} ${global_tds})
  endif()
  ...
  add_custom_command(OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${ofn}.tmp
    ...
    -I ${LLVM_MAIN_SRC_DIR}/lib/Target
