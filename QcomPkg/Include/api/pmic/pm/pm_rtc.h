...
/**
 * @brief This function sets the millisec after which alarm
 *        triggers
 * 
 * @param[in] pmic_chip: Primary: 0. Secondary: 1
 * @param[in] time_ptr:  Number of seconds and milliseconds
 *                       after which RTC alarm triggers. Refer
 *                       #pm_rtc_time_type for more info
 *  
 *
 * @return  pm_err_flag_type 
 *          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available on this
...
/**
 * @brief This function enables/disables RTC alarm
 * 
 * @param[in] pmic_chip: Primary: 0. Secondary: 1
