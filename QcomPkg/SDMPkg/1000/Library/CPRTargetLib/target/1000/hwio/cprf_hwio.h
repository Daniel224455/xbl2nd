...
#define HWIO_RPMH_CPRF_MISC_CTRL_PHYS                                                (RPMH_CPRF_CPRF_REG_BASE_PHYS + 0x0000003c)
...
#define HWIO_RPMH_CPRF_MISC_CTRL_IN          \
        in_dword_masked(HWIO_RPMH_CPRF_MISC_CTRL_ADDR, HWIO_RPMH_CPRF_MISC_CTRL_RMSK)
