...
/**
  Prints an assert message containing a filename, line number, and description.  
  Also prints the address which contains an incorrect signature and memory before 
  and after it
  This may be followed by a breakpoint or a dead loop.
...
#define _ASSERT_MEMDUMP(Expression, Address)  DebugAssert_MemDump (__FILE_BASENAME__, __LINE__, #Expression, Address)
...
**/
  ...
  #define CR(Record, TYPE, Field, TestSignature)                                              \
    ...
    (TYPE *) (_ASSERT_MEMDUMP (CR has Bad Signature,(UINTN)Record), Record) :                                       \
