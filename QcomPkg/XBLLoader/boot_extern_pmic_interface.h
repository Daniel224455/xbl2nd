...
--------   ---     ----------------------------------------------------------
12/21/17   aab     Added boot_pm_app_config_download_mode api.
...
**  Function :  boot_pm_app_config_download_mode

** ===========================================================================
*/
/*!
 * @brief This function executes the pmic initialization for dlownload mode
 * @return Error flag.
 *
 */
pm_err_flag_type boot_pm_app_config_download_mode(void);
