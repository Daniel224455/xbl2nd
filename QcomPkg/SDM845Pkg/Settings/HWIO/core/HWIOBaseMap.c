...
/*
  ...
  $Header: //components/rel/boot.xf/2.0/QcomPkg/SDM845Pkg/Settings/HWIO/core/HWIOBaseMap.c#8 $
...
{
  { "CM_QREFS_VBG_INT_VREF_SW",                    0x00000000, 0x00000080 },
...
{
  { "AGGRE_NOC_A1NOC_SERVICE_NETWORK",             0x00000000, 0x00015080 },
...
static HWIOModuleType HWIOModules_PCIE_0_PCIE20_WRAPPER_AHB[] =
{
  ...
  { "PCIE_0_CM_PCIE",                              0x00006000, 0x00001000 },
  { "PCIE_0_QSERDES_COM_QSERDES_COM_PCIE_USB3_UNI_QMP_PLL", 0x00006000, 0x0000018c },
  { "PCIE_0_QSERDES_TX_QSERDES_TX_PCIE_USB3_UNI_QMP_TX", 0x00006200, 0x00000128 },
  { "PCIE_0_QSERDES_RX_QSERDES_RX_PCIE_USB3_UNI_QMP_RX", 0x00006400, 0x000001fc },
  { "PCIE_0_PCIE_USB3_UNI_PCS_MISC_PCIE_USB3_UNI_PCS_MISC_PCIE_USB3_UNI_PCS_MISC", 0x00006600, 0x00000070 },
  { "PCIE_0_PCIE_USB3_UNI_PCS_PCIE_USB3_UNI_PCS_PCIE_USB3_UNI_PCS", 0x00006800, 0x00000218 },
  { "PCIE_0_PCIE20_MHI",                           0x00007000, 0x00001000 },
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_PCIE_GEN3_PCIE20_WRAPPER_AHB_W_PHY[] =
{
  { "PCIE_GEN3_PCIE20_PARF",                       0x00000000, 0x00002000 },
  { "PCIE_GEN3_CM_PCIE",                           0x00002000, 0x00001c00 },
  { "PCIE_GEN3_QHP_COM_QHP_COM_HP_PCIE_COM",       0x00002000, 0x0000026c },
  { "PCIE_GEN3_QHP_L0_QHP_L0_HP_PCIE_LANE",        0x00002800, 0x000002f0 },
  { "PCIE_GEN3_QHP_L1_QHP_L1_HP_PCIE_LANE",        0x00003000, 0x000002f0 },
  { "PCIE_GEN3_HP_PCIE_PHY_HP_PCIE_PHY_HP_PCIE_PCS", 0x00003800, 0x000002dc },
  { "PCIE_GEN3_PCIE20_MHI",                        0x00004000, 0x00001000 },
  { NULL, 0, 0 }
};
...
static HWIOModuleType HWIOModules_UFS_MEM_UFS_2LANE_REGS[] =
{
  ...
  { "UFS_MEM_QSERDES_TX1_QSERDES_TX1_UFS_QMP_TX",  0x00007800, 0x00000128 },
  { "UFS_MEM_QSERDES_RX1_QSERDES_RX1_UFS_QMP_RX",  0x00007a00, 0x000001fc },
...
static HWIOModuleType HWIOModules_UFS_CARD_UFS_1LANE_REGS[] =
{
  ...
  { "UFS_CARD_QSERDES_COM_QSERDES_COM_UFS_QMP_PLL", 0x00007000, 0x0000018c },
  { "UFS_CARD_QSERDES_TX0_QSERDES_TX0_UFS_QMP_TX", 0x00007400, 0x00000128 },
  { "UFS_CARD_QSERDES_RX0_QSERDES_RX0_UFS_QMP_RX", 0x00007600, 0x000001fc },
  { "UFS_CARD_UFS_PHY_UFS_PHY_UFS_PCS",            0x00007c00, 0x000001dc },
...
static HWIOModuleType HWIOModules_TLMM[] =
{
  ...
  { "TLMM_XPU_EAST_XE",                            0x00000000, 0x00006780 },
  { "TLMM_EAST",                                   0x00100000, 0x00300000 },
  { NULL, 0, 0 }
};
...
static HWIOModuleType HWIOModules_GFX[] =
{
  ...
  { "GPU_VBIF",                                    0x0000c000, 0x00003000 },
  { "GPU_VBIF_GPU",                                0x0000c000, 0x00003000 },
...
{
  { "USB3_2ND_DWC_USB3",                           0x00000000, 0x0000cd00 },
...
static HWIOModuleType HWIOModules_LPASS[] =
{
  ...
  { "LPASS_QSM",                                   0x000a0000, 0x00003000 },
...
static HWIOModuleType HWIOModules_PCIE_GEN3_SPACE[] =
{
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_PCIE_GEN3_PCIE_WRAPPER_AXI[] =
{
  { "PCIE_GEN3_PCIE20_DBI",                        0x00000000, 0x00000f1d },
  { "PCIE_GEN3_PCIE20_ELBI",                       0x00000f20, 0x000000a8 },
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_PCIE_GEN2_SPACE[] =
{
  { NULL, 0, 0 }
};
...
HWIOPhysRegionType HWIOBaseMap[] =
{
  ...
  {
    "PCIE_GEN3_PCIE20_WRAPPER_AHB_W_PHY",
    (DALSYSMemAddr)0x01c08000,
    0x00008000,
    (DALSYSMemAddr)0x01c08000,
    HWIOModules_PCIE_GEN3_PCIE20_WRAPPER_AHB_W_PHY
  },
  {
  ...
  },
  {
    ...
    0x100000000,
    (DALSYSMemAddr)0x40000000,
    HWIOModules_PCIE_GEN3_SPACE
  },
  {
    "PCIE_GEN3_PCIE_WRAPPER_AXI",
    (DALSYSMemAddr)0x40000000,
    0x02000000,
    (DALSYSMemAddr)0x40000000,
    HWIOModules_PCIE_GEN3_PCIE_WRAPPER_AXI
  },
  {
    "PCIE_GEN2_SPACE",
