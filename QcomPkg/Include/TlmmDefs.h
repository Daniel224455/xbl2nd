...
=============================================================================
Copyright (c) 2010 - 2014, 2021 QUALCOMM Technologies Incorporated.  All Rights Reserved.  
...
/** 
  Extended version of main configuration macro. 
  ...
  @param pull  [in] -- Pull value (up, down, or none).
  @param drive [in] -- Drive strength to program.
  @param type  [in] -- type of GPIO pin (like: TLMM or LPI)
...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
#define DAL_GPIO_CFG_EX(gpio, func, dir, pull, drive, type) \
         (((gpio) & 0x3FF)<< 4 | \
          ((func) & 0xF)|        \
          ((dir)  & 0x1) << 14|  \
          ((pull) & 0x3) << 15|  \
...
/** 
  GPIO Pin type extraction macro.
    
  Extraction macro used to retrieve the type of pin (like: TLMM or LPI) from a DAL_GPIO_CFG_EX formatted 
  configuration. 
    
  @param type [in] -- DAL_GPIO_CFG_EX format configuration.
    
  @sa
  DAL_GPIO_CFG 
*/ 
#ifndef DOXYGEN_SHOULD_SKIP_THIS
#define DAL_GPIO_DEVICE(type) (((type) >> 23) & 0x1)
#else
#define DAL_GPIO_DEVICE(type)
#endif /* end DOXYGEN_SHOULD_SKIP_THIS */
