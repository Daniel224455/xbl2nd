...
ASIX_DONGLE ASIX_DONGLES[] = {
  ...
  { 0x0B95, 0x7720, FLAG_TYPE_AX88772 }, // Other 88772 device
  // ASIX 88772B
...
**/
EFI_HANDLE ImageHandle_old;
EFI_SYSTEM_TABLE * pSystemTable_old;
  ...
  )
{
  ...
  //
  ImageHandle_old = ImageHandle;
  pSystemTable_old = pSystemTable; 
