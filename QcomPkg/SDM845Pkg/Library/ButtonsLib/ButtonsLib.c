...
//KeyMap for CDP
KEY_TYPE KeyMap_845_CDP[ NUMBER_OF_KEYS] =
{
   PWR, VOL_UP, VOL_DOWN, HOME, CAMERA
};

//KeyMap for MTP and FLUID
KEY_TYPE KeyMap_845_MTP_FLUID[ NUMBER_OF_KEYS] =
{
   PWR, VOL_UP, VOL_DOWN, NONE, CAMERA
};

//KeyMap for LIQUID
KEY_TYPE KeyMap_845_LIQUID[ NUMBER_OF_KEYS] =
{
   PWR, VOL_UP, VOL_DOWN, HOME, NONE
};

//KeyMap for QRD
KEY_TYPE KeyMap_845_QRD[ NUMBER_OF_KEYS] =
{
   PWR, VOL_UP, VOL_DOWN, NONE, NONE
};

//KeyMap for CLS
KEY_TYPE KeyMap_845_CLS[ NUMBER_OF_KEYS] =
{
   PWR, VOL_UP, VOL_DOWN, NONE, NONE
};

//KeyMap for HDK
KEY_TYPE KeyMap_845_HDK[ NUMBER_OF_KEYS] =
{
  PWR, VOL_UP, VOL_DOWN, NONE, NONE
};
   ...
   )
{
   ...
   case EFI_PLATFORMINFO_TYPE_CDP:
      CopyMem( pKeyMap, KeyMap_845_CDP, NUMBER_OF_KEYS*sizeof(KEY_TYPE) );
      break;
   case EFI_PLATFORMINFO_TYPE_MTP:
   case EFI_PLATFORMINFO_TYPE_FLUID:
      CopyMem( pKeyMap, KeyMap_845_MTP_FLUID, NUMBER_OF_KEYS*sizeof(KEY_TYPE) );
      break;
   case EFI_PLATFORMINFO_TYPE_LIQUID:
      CopyMem( pKeyMap, KeyMap_845_LIQUID, NUMBER_OF_KEYS*sizeof(KEY_TYPE) );
      break;
   case EFI_PLATFORMINFO_TYPE_QRD:
      CopyMem( pKeyMap, KeyMap_845_QRD, NUMBER_OF_KEYS*sizeof(KEY_TYPE) );
      break;
   case EFI_PLATFORMINFO_TYPE_CLS:
      CopyMem( pKeyMap, KeyMap_845_CLS, NUMBER_OF_KEYS*sizeof(KEY_TYPE) );
      break;
   case EFI_PLATFORMINFO_TYPE_HDK:
      CopyMem( pKeyMap, KeyMap_845_HDK, NUMBER_OF_KEYS*sizeof(KEY_TYPE) );
      break;      
   default:
      Status = EFI_INVALID_PARAMETER;
      goto ErrorExit;
