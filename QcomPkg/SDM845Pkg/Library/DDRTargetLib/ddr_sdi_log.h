...
typedef struct
{
  ...
  uint32 CABO2_CABO_GLOBAL_IDLE_STATUS;  
  uint32 CABO3_CABO_GLOBAL_IDLE_STATUS;

  uint32 CABO0_CABO_GLOBAL_DEVICE_STATUS;
  uint32 CABO1_CABO_GLOBAL_DEVICE_STATUS;
  uint32 CABO2_CABO_GLOBAL_DEVICE_STATUS;  
  uint32 CABO3_CABO_GLOBAL_DEVICE_STATUS;

  uint32 CABO0_CABO_GLOBAL_ISU_ACH_STATUS;
  uint32 CABO1_CABO_GLOBAL_ISU_ACH_STATUS;
  uint32 CABO2_CABO_GLOBAL_ISU_ACH_STATUS;
  uint32 CABO3_CABO_GLOBAL_ISU_ACH_STATUS;

  uint32 CABO0_CABO_GLOBAL_ISU_WCH_STATUS;
  uint32 CABO1_CABO_GLOBAL_ISU_WCH_STATUS;
  uint32 CABO2_CABO_GLOBAL_ISU_WCH_STATUS;
  uint32 CABO3_CABO_GLOBAL_ISU_WCH_STATUS;
  
  uint32 CABO0_CABO_GLOBAL_ISU_RCH_STATUS;
  uint32 CABO1_CABO_GLOBAL_ISU_RCH_STATUS;
  uint32 CABO2_CABO_GLOBAL_ISU_RCH_STATUS;
  uint32 CABO3_CABO_GLOBAL_ISU_RCH_STATUS;
  
  uint32 CABO0_CABO_GLOBAL_ISU_CMDBUF_STATUS;
  uint32 CABO1_CABO_GLOBAL_ISU_CMDBUF_STATUS;
  uint32 CABO2_CABO_GLOBAL_ISU_CMDBUF_STATUS;
  uint32 CABO3_CABO_GLOBAL_ISU_CMDBUF_STATUS;

  uint32 CABO0_CABO_GLOBAL_CBU_0_RDCQ_STATUS;
  uint32 CABO1_CABO_GLOBAL_CBU_0_RDCQ_STATUS;
  uint32 CABO2_CABO_GLOBAL_CBU_0_RDCQ_STATUS;
  uint32 CABO3_CABO_GLOBAL_CBU_0_RDCQ_STATUS;

  uint32 CABO0_CABO_GLOBAL_CBU_0_WRCQ_STATUS;
  uint32 CABO1_CABO_GLOBAL_CBU_0_WRCQ_STATUS;
  uint32 CABO2_CABO_GLOBAL_CBU_0_WRCQ_STATUS;
  uint32 CABO3_CABO_GLOBAL_CBU_0_WRCQ_STATUS;

  uint32 CABO0_CABO_GLOBAL_MPE_STATUS;
  uint32 CABO1_CABO_GLOBAL_MPE_STATUS;
  uint32 CABO2_CABO_GLOBAL_MPE_STATUS;
  uint32 CABO3_CABO_GLOBAL_MPE_STATUS;
  
  uint32 CABO0_CABO_GLOBAL_SHKE_STATUS;
  uint32 CABO1_CABO_GLOBAL_SHKE_STATUS;
  uint32 CABO2_CABO_GLOBAL_SHKE_STATUS;
  uint32 CABO3_CABO_GLOBAL_SHKE_STATUS;

  uint32 CABO0_CABO_GLOBAL_SHKE_FSW_STATUS;
  uint32 CABO1_CABO_GLOBAL_SHKE_FSW_STATUS;
  uint32 CABO2_CABO_GLOBAL_SHKE_FSW_STATUS;
  uint32 CABO3_CABO_GLOBAL_SHKE_FSW_STATUS;

  uint32 CABO0_CABO_GLOBAL_SHKE_WDOG_STATUS;
  uint32 CABO1_CABO_GLOBAL_SHKE_WDOG_STATUS;  
  uint32 CABO2_CABO_GLOBAL_SHKE_WDOG_STATUS;
  uint32 CABO3_CABO_GLOBAL_SHKE_WDOG_STATUS;
  
  uint32  CABO0_CABO_GLOBAL_OSU_STATUS;
  uint32  CABO1_CABO_GLOBAL_OSU_STATUS;
  uint32  CABO2_CABO_GLOBAL_OSU_STATUS;
  uint32  CABO3_CABO_GLOBAL_OSU_STATUS; 

  uint32 CABO0_CABO_GLOBAL_OSU_DQS_FIFO_STATUS;
  uint32 CABO1_CABO_GLOBAL_OSU_DQS_FIFO_STATUS;
  uint32 CABO2_CABO_GLOBAL_OSU_DQS_FIFO_STATUS;
  uint32 CABO3_CABO_GLOBAL_OSU_DQS_FIFO_STATUS;

  uint32 CABO0_CABO_CBU_TOP_CMD_STATUS;
  uint32 CABO1_CABO_CBU_TOP_CMD_STATUS;
  uint32 CABO2_CABO_CBU_TOP_CMD_STATUS;
  uint32 CABO3_CABO_CBU_TOP_CMD_STATUS;

  /* CABO MPE registers */  
  uint32 CABO0_CABO_MPE_CMD_STATUS;
  uint32 CABO1_CABO_MPE_CMD_STATUS;
  uint32 CABO2_CABO_MPE_CMD_STATUS;
  uint32 CABO3_CABO_MPE_CMD_STATUS;

  uint32 CABO0_CABO_MPE_APM_STATUS;
  uint32 CABO1_CABO_MPE_APM_STATUS;
  uint32 CABO2_CABO_MPE_APM_STATUS;
  uint32 CABO3_CABO_MPE_APM_STATUS;
  
  uint32 CABO0_CABO_GLOBAL_DDR_CLK_PERIOD_CFG;
  uint32 CABO1_CABO_GLOBAL_DDR_CLK_PERIOD_CFG;
  uint32 CABO2_CABO_GLOBAL_DDR_CLK_PERIOD_CFG;
  uint32 CABO3_CABO_GLOBAL_DDR_CLK_PERIOD_CFG;

  uint32 CABO0_CABO_SHKE_SW_CMD_STATUS;
  uint32 CABO1_CABO_SHKE_SW_CMD_STATUS;
  uint32 CABO2_CABO_SHKE_SW_CMD_STATUS;
  uint32 CABO3_CABO_SHKE_SW_CMD_STATUS;

  uint32 CABO0_CABO_SHKE_PDT_DIT_STATUS;
  uint32 CABO1_CABO_SHKE_PDT_DIT_STATUS;
  uint32 CABO2_CABO_SHKE_PDT_DIT_STATUS;
  uint32 CABO3_CABO_SHKE_PDT_DIT_STATUS;

  uint32 CABO0_CABO_SHKE_ZQCAL_STATUS;
  uint32 CABO1_CABO_SHKE_ZQCAL_STATUS;
  uint32 CABO2_CABO_SHKE_ZQCAL_STATUS;
  uint32 CABO3_CABO_SHKE_ZQCAL_STATUS;

  uint32 CABO0_CABO_GLOBAL_ISU_CMDBUF_STATUS0;
  uint32 CABO1_CABO_GLOBAL_ISU_CMDBUF_STATUS0;
  uint32 CABO2_CABO_GLOBAL_ISU_CMDBUF_STATUS0;
  uint32 CABO3_CABO_GLOBAL_ISU_CMDBUF_STATUS0;
  
  uint32 CABO0_CABO_GLOBAL_ISU_WRBUF_STATUS;
  uint32 CABO1_CABO_GLOBAL_ISU_WRBUF_STATUS;
  uint32 CABO2_CABO_GLOBAL_ISU_WRBUF_STATUS;
  uint32 CABO3_CABO_GLOBAL_ISU_WRBUF_STATUS;  	

  uint32 CABO0_CABO_GLOBAL_SHKE_BANK_UNAVAIL_STATUS;
  uint32 CABO1_CABO_GLOBAL_SHKE_BANK_UNAVAIL_STATUS;
  uint32 CABO2_CABO_GLOBAL_SHKE_BANK_UNAVAIL_STATUS;
  uint32 CABO3_CABO_GLOBAL_SHKE_BANK_UNAVAIL_STATUS;
  
  uint32 CABO0_CABO_ADDR_DECERR_ESYN_0;
  uint32 CABO1_CABO_ADDR_DECERR_ESYN_0;
  uint32 CABO2_CABO_ADDR_DECERR_ESYN_0;
  uint32 CABO3_CABO_ADDR_DECERR_ESYN_0; 

  uint32 CABO0_CABO_ADDR_DECERR_ESYN_1;
  uint32 CABO1_CABO_ADDR_DECERR_ESYN_1;
  uint32 CABO2_CABO_ADDR_DECERR_ESYN_1;
  uint32 CABO3_CABO_ADDR_DECERR_ESYN_1;
  
  uint32 CABO0_CABO_MEM_BUSHANG_ERR_ESYN;
  uint32 CABO1_CABO_MEM_BUSHANG_ERR_ESYN;
  uint32 CABO2_CABO_MEM_BUSHANG_ERR_ESYN;
  uint32 CABO3_CABO_MEM_BUSHANG_ERR_ESYN; 

  uint32 CABO0_CABO_RDQS_ERR_ESYN;
  uint32 CABO1_CABO_RDQS_ERR_ESYN;
  uint32 CABO2_CABO_RDQS_ERR_ESYN;
  uint32 CABO3_CABO_RDQS_ERR_ESYN;

  uint32 CABO0_CABO_REFRESH_ERR_ESYN;
  uint32 CABO1_CABO_REFRESH_ERR_ESYN;
  uint32 CABO2_CABO_REFRESH_ERR_ESYN;
  uint32 CABO3_CABO_REFRESH_ERR_ESYN;

  uint32 CABO0_CABO_MPE_IDLE_STATUS;
  uint32 CABO1_CABO_MPE_IDLE_STATUS;
  uint32 CABO2_CABO_MPE_IDLE_STATUS;
  uint32 CABO3_CABO_MPE_IDLE_STATUS;

  /* DDRCC registers */
  uint32 DDRCC_CH01_DDRCC_PCC_PC_STA;
  uint32 DDRCC_CH23_DDRCC_PCC_PC_STA;
