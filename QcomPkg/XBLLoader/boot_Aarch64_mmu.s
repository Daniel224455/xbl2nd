...
//                                functions.
//
// Copyright 2013-2015,2017-2018 Qualcomm Technologies, Incorporated.  
//                           All Rights Reserved 
//============================================================================
...
// --------  -----   ---------------------------------------------------------
// 09/25/18  vk      Use #define instead of .set
// 09/10/18  vk      Mark device memory as nGnRnE
// 01/25/18  vk      Add DSB and DMB API
...
//                             MODULE EQUATES
//============================================================================
#define SCTLR_EL3_REG_DEFAULT  (0x0)

#define MAIR_EL3_ATTR          (MMU_PAGETABLE_MAIR_7 | MMU_PAGETABLE_MAIR_6 |  MMU_PAGETABLE_MAIR_5 | MMU_PAGETABLE_MAIR_4 | MMU_PAGETABLE_MAIR_3 | MMU_PAGETABLE_MAIR_2 | MMU_PAGETABLE_MAIR_1 | MMU_PAGETABLE_MAIR_0)
...
#define TT_S1_DEVICE_nGnRnE    (0x00000000000000409)    // Index = 2, AF=1
...
// DEPENDENCIES
//============================================================================
.type data_mem_barrier, @function
data_mem_barrier:
   DMB     SY
   ret
...
cache_mmu_init_page_table:
   ...
   MOV      x0, MMU_MAIR_DEVICE_nGnRnE// Entry template, normal, non-cacheable, non-shared
