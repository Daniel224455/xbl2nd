/** @file VarTest.c
  ...
  Copyright (c) 2012-2013,2015-2018, Qualcomm Technologies, Inc. All rights reserved.
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 08/02/18   pj      Updated call to Rng protocol to directly use raw Rng algo
...
BOOLEAN RandomGen (UINT8 *pNonce, UINT32 RandomSize)
{
   ...
   Status = RngProtocol->GetRNG(RngProtocol, NULL, RandomLen, pNonce);
