...
--------   ----    --------------------------------------------------- 
03/08/18   mt      Add GetTotalPhysicalMemory API
03/08/18   mt      Changed GetTotalPhysicalMemory to GetAvailablePhysicalMemory
...
EFI_STATUS
GetActualPhysicalMemory(UINTN *MemoryCapacity)
{
  EFI_STATUS Status;
