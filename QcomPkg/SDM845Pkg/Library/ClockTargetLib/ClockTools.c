...
==============================================================================
  ...
  $Header: //components/rel/boot.xf/2.0/QcomPkg/SDM845Pkg/Library/ClockTargetLib/ClockTools.c#11 $
...
void Clock_ReplaceUFSBootClockEnable()
{
  ...
  { 
    ...
    Clock_ToggleClock(HWIO_GCC_AGGRE_UFS_CARD_AXI_CBCR_ADDR, CLK_TOGGLE_ENABLE);
    ...
    Clock_ToggleClock(HWIO_GCC_UFS_PHY_RX_SYMBOL_1_CBCR_ADDR, CLK_TOGGLE_ENABLE);
...
boolean Clock_UFSInit( ClockBootPerfLevelType ePerfLevel )
{
  ...
  else
  {
    ...
    Clock_PowerDomainEnable( HWIO_GCC_UFS_CARD_GDSCR_ADDR );
    Clock_PowerDomainEnable( HWIO_GCC_UFS_CARD_CFG_GDSCR_ADDR );
    Clock_PowerDomainEnable( HWIO_GCC_UFS_PHY_GDSCR_ADDR );
    Clock_PowerDomainEnable( HWIO_GCC_UFS_PHY_CFG_GDSCR_ADDR );
  }

  Clock_ToggleClock(HWIO_GCC_AGGRE_UFS_CARD_AXI_CBCR_ADDR, enable);
  ...
  if ( ePerfLevel == CLOCK_BOOT_PERF_NONE )
  {
    Clock_PowerDomainDisable( HWIO_GCC_UFS_CARD_GDSCR_ADDR );
    Clock_PowerDomainDisable( HWIO_GCC_UFS_CARD_CFG_GDSCR_ADDR );
