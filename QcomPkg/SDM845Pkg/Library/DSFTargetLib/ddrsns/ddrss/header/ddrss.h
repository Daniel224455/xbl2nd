...
$Header: //components/rel/boot.xf/2.2/QcomPkg/SDM845Pkg/Library/DSFTargetLib/ddrsns/ddrss/header/ddrss.h#8 $
...
boolean DDRSS_eCDT_Read_Parameter_Values(BOOT_DDR_STRUCT *ddr);
