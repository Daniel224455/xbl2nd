...
[Defines]
  ...
  FLASH_DEFINITION               = QcomPkg/SDM845Pkg/LA/Core.fdf
...
[BuildOptions.AARCH64]
  GCC:*_*_AARCH64_ARCHCC_FLAGS  == -fno-common -mtune=cortex-a53 -I $(WORKSPACE)/QcomPkg/SDM845Pkg/Include -include $(WORKSPACE)/QcomPkg/SDM845Pkg/Include/Target_cust.h -include $(WORKSPACE)/QcomPkg/Include/Library/DebugLib.h -DQCOM_EDK2_PATCH -DDISABLE_DEP $(FEATURE_FLAGS) -DENABLE_DEP_64 -DENABLE_XN -DENABLE_ASLR -fstack-protector-strong
  GCC:*_*_AARCH64_ARCHPP_FLAGS  == -I $(WORKSPACE)/QcomPkg/SDM845Pkg/Include -include $(WORKSPACE)/QcomPkg/Msm8998Pkg/Include/Target_cust.h -include $(WORKSPACE)/QcomPkg/Include/Library/DebugLib.h -DQCOM_EDK2_PATCH -DDISABLE_DEP $(FEATURE_FLAGS) -DENABLE_DEP_64 -DENABLE_XN -DENABLE_ASLR -fstack-protector-strong
...
#
  ...
  QcomPkg/Drivers/PmicDxe/PmicDxeLa.inf {
    <LibraryClasses>
     #PMIC Library
    PmicCoreLib|QcomPkg/SDM845Pkg/Library/PmicLib/core/la/PmicCoreLibLa.inf
  }
