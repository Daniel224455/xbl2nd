...
{
  qusb_log_bus(QUSB_AL_FAST_ENUM_INIT_LOG);
  ...
  if (NULL == dev)
  {
    qusb_log_err__param(FAST_ENUM_NULL_PTR_ERROR_LOG, __LINE__);
  }
}
// ===========================================================================
/**
...
{
  qusb_log_bus(QUSB_AL_FAST_ENUM_SHUTDOWN_LOG);
...
void qusb_al_do_fast_enum(qusb_max_speed_required_t speed_required)
{
  ...
  qusb_log_bus(QUSB_AL_DO_FAST_ENUM_LOG);
...
#else
  qusb_log_bus(QUSB_AL_DO_FAST_ENUM_UNSUPPORTED_LOG);
#endif
}
