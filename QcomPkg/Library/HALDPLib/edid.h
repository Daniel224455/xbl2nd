...
#define EDID_MAX_NUM_OF_BLOCKS                       (0x01)   //Maximum number of pages for EDID structure
#define EDID_MAX_NUM_OF_CEA_EXTENSION_BLOCKS         (0x00)
#else
...
#define EDID_DISP_MODE_LIST_MAX_NUM                      24          //Maximunum Number of Modes for mode list
