...
Protocol version.
*/
#define PMIC_RTC_REVISION 0x0000000000010004
...
@par Summary
This function sets the number of seconds after which alarm will 
trigger. This function internally enables the alarm as 
well.
 
@param[in]  TimePtr: Number of seconds and milliseconds after 
 *      	     which RTC alarm will trigger. Refer
 *      	     #EFI_PM_RTC_TIME_TYPE for more info
@return 
EFI_SUCCESS        -- Function completed successfully. \n
EFI_PROTOCOL_ERROR -- Error occurred during the operation.
*/
...
(
 IN  EFI_PM_RTC_TIME_TYPE *TimePtr
 );
...
@par Summary
This function enables/disabled RTC alarm 
