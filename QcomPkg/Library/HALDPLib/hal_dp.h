...
/*!
 * \enum HAL_DP_HDP_ConnectionType
 *
 *
 * \brief
 ...
 *
 */
typedef enum _HAL_DP_HPD_ConnectionType
{
    HAL_HPD_STATUS_DISCONNECTED                    = 0,
    HAL_HPD_STATUS_CONNECT_PENDING                 = 1,
    HAL_HPD_STATUS_CONNECTED                       = 2,
    HAL_HPD_STATUS_HPD_IO_GLITH_COUNT              = 3,
    HAL_HPD_STATUS_IRQ_HPD_PULSE_COUNT             = 4,
    HAL_HPD_STATUS_HPD_REPLUG_COUNT                = 5,
} HAL_DP_HPD_ConnectionType;
...
* \param [in]   eControllerId   - DP core ID
*
* \retval HAL_DP_HDP_ConnectionType
*
****************************************************************************/
