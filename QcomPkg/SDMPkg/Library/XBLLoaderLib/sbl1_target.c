...
static void xbl_ramdump_pt_updates(void)
{
  ...
  /* Add PCIe region */
#define PCIE_GEN3X2_PCIE_WRAPPER_AXI_NO_EDMA 0x68000000
  xbl_ramdump_mem_block.p_base = PCIE_GEN3X2_PCIE_WRAPPER_AXI_NO_EDMA;
  xbl_ramdump_mem_block.v_base = PCIE_GEN3X2_PCIE_WRAPPER_AXI_NO_EDMA;
  xbl_ramdump_mem_block.size_in_kbytes = SIZE_32MB>> 10;
  xbl_ramdump_mem_block.memory_mapping = MMU_L2_SECTION_MAPPING;
  xbl_ramdump_mem_block.access = MMU_PAGETABLE_MEM_READ_WRITE;
  xbl_ramdump_mem_block.executable = MMU_PAGETABLE_NON_EXECUTABLE_REGION;
  xbl_ramdump_mem_block.cachetype = MMU_PAGETABLE_DEVICE_SHARED;
