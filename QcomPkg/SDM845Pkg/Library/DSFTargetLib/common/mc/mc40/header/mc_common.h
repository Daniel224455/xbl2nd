 ...
 ******************************************************************************/
/*==============================================================================
$Header: //components/rel/boot.xf/2.0/QcomPkg/SDM845Pkg/Library/DSFTargetLib/common/mc/mc40/header/mc_common.h#11 $
...
#define REG_OFFSET_MC(uint8)          ((uint8 == 0) ? \
                                       ...
                                       (uint8 == 2) ? \
                                       (SEQ_DDR_SS_CABO2_CABO_OFFSET) : \
                                       (uint8 == 3) ? \
                                       (SEQ_DDR_SS_CABO3_CABO_OFFSET) : \
...
#define REG_OFFSET_MC_GLOBAL(uint8)   ((uint8 == 0) ? \
                                       ...
                                       (uint8 == 2) ? \
                                       (SEQ_DDR_SS_CABO2_CABO_GLOBAL_OFFSET) : \
                                       (uint8 == 3) ? \
                                       (SEQ_DDR_SS_CABO3_CABO_GLOBAL_OFFSET) : \
...
#define REG_OFFSET_MC_ISU(uint8)      ((uint8 == 0) ? \
                                       ...
                                       (uint8 == 2) ? \
                                       (SEQ_DDR_SS_CABO2_CABO_ISU_OFFSET) : \
                                       (uint8 == 3) ? \
                                       (SEQ_DDR_SS_CABO3_CABO_ISU_OFFSET) : \
...
#define REG_OFFSET_MC_CBU_TOP(uint8)  ((uint8 == 0) ? \
                                       ...
                                       (uint8 == 2) ? \
                                       (SEQ_DDR_SS_CABO2_CABO_CBU_TOP_OFFSET) : \
                                       (uint8 == 3) ? \
                                       (SEQ_DDR_SS_CABO3_CABO_CBU_TOP_OFFSET) : \
...
#define REG_OFFSET_MC_DTC(uint8)      ((uint8 == 0) ? \
                                       ...
                                       (uint8 == 2) ? \
                                       (SEQ_DDR_SS_CABO2_CABO_DTC_OFFSET) : \
                                       (uint8 == 3) ? \
                                       (SEQ_DDR_SS_CABO3_CABO_DTC_OFFSET) : \
...
#define REG_OFFSET_MC_OSU(uint8)      ((uint8 == 0) ? \
                                       ...
                                       (uint8 == 2) ? \
                                       (SEQ_DDR_SS_CABO2_CABO_OSU_OFFSET) : \
                                       (uint8 == 3) ? \
                                       (SEQ_DDR_SS_CABO3_CABO_OSU_OFFSET) : \
...
#define REG_OFFSET_MC_PXI(uint8)      ((uint8 == 0) ? \
                                       ...
                                       (uint8 == 2) ? \
                                       (SEQ_DDR_SS_CABO2_CABO_PXI_OFFSET) : \
                                       (uint8 == 3) ? \
                                       (SEQ_DDR_SS_CABO3_CABO_PXI_OFFSET) : \
...
#define REG_OFFSET_MC_INTERRUPT(uint8) ((uint8 == 0) ? \
                                        ...
                                        (uint8 == 2) ? \
                                        (SEQ_DDR_SS_CABO2_CABO_INTERRUPT_OFFSET) : \
                                        (uint8 == 3) ? \
                                        (SEQ_DDR_SS_CABO3_CABO_INTERRUPT_OFFSET) : \
...
#define REG_OFFSET_MC_PERFMON(uint8)   ((uint8 == 0) ? \
                                        ...
                                        (uint8 == 2) ? \
                                        (SEQ_DDR_SS_CABO2_CABO_PERFMON_OFFSET) : \
                                        (uint8 == 3) ? \
                                        (SEQ_DDR_SS_CABO3_CABO_PERFMON_OFFSET) : \
...
#define REG_OFFSET_MC_GLOBAL_SEC(uint8) ((uint8 == 0) ? \
                                         ...
                                         (uint8 == 2) ? \
                                         (SEQ_DDR_SS_CABO2_CABO_GLOBAL_SEC_OFFSET) : \
                                         (uint8 == 3) ? \
                                         (SEQ_DDR_SS_CABO3_CABO_GLOBAL_SEC_OFFSET) : \
...
#define REG_OFFSET_MC_PXI_SECURE(uint8) ((uint8 == 0) ? \
                                         ...
                                         (uint8 == 2) ? \
                                         (SEQ_DDR_SS_CABO2_CABO_PXI_SECURE_OFFSET) : \
                                         (uint8 == 3) ? \
                                         (SEQ_DDR_SS_CABO3_CABO_PXI_SECURE_OFFSET) : \
