/** @file Variable.c
  ...
  Copyright (c) 2011-2015,2017-2019,2024 Qualcomm Technologies, Inc. All rights reserved.
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 01/10/24   ps      expose uefisecapp version to HLOS via duplicated variable
...
InitializeVariableTables ( VOID )
{
  ...
  /* Set variable for uefisecapp version for HLOS to read */
  Status = RuntimeSetVariable(L"UefiSecAppVersionRT",
                              &gEfiGlobalVariableGuid,
                              EFI_VARIABLE_BOOTSERVICE_ACCESS|EFI_VARIABLE_RUNTIME_ACCESS,
                              sizeof(mUefiSecAppVersion),
                              &mUefiSecAppVersion);
  /* Ignore error */
  ...
  )
{
  ...
  VarLock = InitRecursiveLock ("DxeLock");
