...
static uint32 boot_pbl_clock_mapV1[] =
{
  19200,
  600000,
  1200000
...
static uint32 boot_pbl_clock_mapV2[] =
{
  600000,
  19200,
  1200000
...
{
  if(((uint32) ChipInfo_GetChipVersion())<2)
  {
    return boot_pbl_clock_mapV1[boot_pbl_shared_data.proc_clk_speed];
  }
  else
  {
    return boot_pbl_clock_mapV2[boot_pbl_shared_data.proc_clk_speed];
  }
