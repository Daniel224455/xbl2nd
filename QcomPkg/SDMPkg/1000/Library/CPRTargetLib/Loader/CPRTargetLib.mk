...
CPR_CONFIG_DIR = $(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Settings/CPR
...
INC =  \
    ...
    -I$(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Settings/CPR \
...
$(OUTPUT_DIR)/cpr_voltage_plan_$(TARGET_ID).obj : $(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Settings/CPR/cpr_voltage_plan_$(TARGET_ID).c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Settings/CPR/cpr_voltage_plan_$(TARGET_ID).c
...
$(OUTPUT_DIR)/image/xbl/target/$(TARGET_ID)/cpr_image_target.obj : $(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Library/CPRTargetLib/image/xbl/target/$(TARGET_ID)/cpr_image_target.c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/SDMPkg/$(CHIP_ID)/Library/CPRTargetLib/image/xbl/target/$(TARGET_ID)/cpr_image_target.c
