...
#define HWIO_DDR_CC_DDRCC_QLINKPLL0_ALOG_OBSV_BUS_STATUS_1_ADDR(x)   (x+0x000008d0)
#define HWIO_DDR_CC_DDRCC_QLINKPLL0_ALOG_OBSV_BUS_STATUS_1_PHYS(x)   (x+0x000008d0)
