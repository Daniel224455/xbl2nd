...
$Header: //components/rel/boot.xf/2.0/QcomPkg/SDM845Pkg/Settings/PMIC/pm_pvc_config.c#1 $
...
{
   {0x1, 0x3840}, /* PM8998, S13_CTRL_VSET_LB */
   {0x1, 0x3841}, /* PM8998, S13_CTRL_VSET_UB */
   {0x1, 0x3845}, /* PM8998, S13_CTRL_MODE_CTL */
   {0x1, 0x3846}  /* PM8998, S13_CTRL_EN_CTL */
};
...
{
  {0x1, 0x3540}, /* PM8998, S12_CTRL_VSET_LB */
  {0x1, 0x3541}, /* PM8998, S12_CTRL_VSET_UB */
  {0x1, 0x3545}, /* PM8998, S12_CTRL_MODE_CTL */
  {0x1, 0x3546} /* PM8998, S12_CTRL_EN_CTL */
};
...
{
  {0x1, 0x4846}, /* PM8998, L9_EN_CTL */
  {0x1, 0x4946}  /* PM8998, L10_EN_CTL */
};
...
const SpmiBusCfg_VioctlCfg pm_vioctl_cfg0 =
{
   ...
   {0x02, 0x4100},       /* Positive edge PPID:  Slave id / Address */
