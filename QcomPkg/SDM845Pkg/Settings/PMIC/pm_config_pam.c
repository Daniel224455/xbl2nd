 ...
 *    Template Version: 
 *    $Header: //components/rel/boot.xf/2.0/QcomPkg/SDM845Pkg/Settings/PMIC/pm_config_pam.c#1 $ 
 *    $DateTime: 2017/08/10 03:45:31 $  $Author: pwbldsvc $
 *  
 *  &copy; Copyright March 21, 2017 Qualcomm Technologies Incorporated, All Rights Reserved
 */
...
pm_pam_pcie_a_rfclk3 [] =
{
     /* enable */ 
    { PM_PRM_DEV_DISABLE },  // PCIE_OFF
    { PM_PRM_DEV_DISABLE },  // PCIE_SUSPEND
    { PM_PRM_DEV_ENABLE },  // PCIE_ACTIVE_NOMINAL
    { PM_PRM_DEV_ENABLE },  // PCIE_ACTIVE_SVS
    { PM_PRM_DEV_ENABLE }  // PCIE_ACTIVE_TURBO
};
...
pm_pam_pcie_rails_info [] = 
{
    ...
    { (void*)pm_pam_pcie_a_rfclk3, PM_PRM_RSRC_VRM_CLK },
}; 
...
pm_pam_deps_pcie [] =
{
    PM_PRM_CLIENT_VREG_DEP ( a,  ldo, 1 ),
    PM_PRM_CLIENT_VREG_DEP ( a,  ldo, 26 ),
    PM_PRM_CLIENT_CLK_DEP ( a,  rfclk, 3 ),
};
...
pm_prm_device_rsrc_data [] =
{
    ...
    PM_PRM_DEV_RSRC_CLK ( a, rfclk, 3, PM_PRM_RSRC_CLK, PM_PRM_RPMH, PM_CLK_RF_3), 
