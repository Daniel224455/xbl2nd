...
void DDRSS_eCDT_Switchboard_Update(BOOT_DDR_STRUCT *ddr)

{
    ...
    // Disable 1804.8MHz via AOP

    ddr-> aop_params.mc_states[11].freq_enable = 0;

    

    // Set maximum frequency to 1555.2MHz

    new_max_ddr_frequency = 1555200;
    ...
    */
    ...
    //not needed as new_max_ddr_frequency is fixed
...

    {
...

        {
...

            {
                ...
                if(Triainig_pivot_plots_Switchboard[old_prfs_index][ii] == 1)

                {
                    ...
                    else if(Triainig_pivot_plots_Switchboard[old_prfs_index - 1][ii] == 0)

                    {

                        // Clear the old frequency bit

                        Triainig_pivot_plots_Switchboard[old_prfs_index][ii] = 0;

                        // Set the new frequence bits

                        Triainig_pivot_plots_Switchboard[new_prfs_index][ii] = 1;
...

            {
                ...
                if(DCC_Training_Switchboard[old_prfs_index][ii] == 1)

                {
                    ...
                    else if(DCC_Training_Switchboard[old_prfs_index - 1][ii] == 0)

                    {

                        // Clear the old frequency bit

                        DCC_Training_Switchboard[old_prfs_index][ii] = 0;

                        // Set the new frequence bits

                        DCC_Training_Switchboard[new_prfs_index][ii] = 1;
...

            {
                ...
                if(WRLVL_Training_Switchboard[old_prfs_index][ii] == 1)

                {
                    ...
                    else if(WRLVL_Training_Switchboard[old_prfs_index - 1][ii] == 0)

                    {

                        // Clear the old frequency bit

                        WRLVL_Training_Switchboard[old_prfs_index][ii] = 0;

                        // Set the new frequence bits

                        WRLVL_Training_Switchboard[new_prfs_index][ii] = 1;
...

            {
                ...
                if(WR_Training_Switchboard[old_prfs_index][ii] == 1)

                {
                    ...
                    else if(WR_Training_Switchboard[old_prfs_index - 1][ii] == 0)

                    {

                        // Clear the old frequency bit

                        WR_Training_Switchboard[old_prfs_index][ii] = 0;

                        // Set the new frequence bits

                        WR_Training_Switchboard[new_prfs_index][ii] = 1;
...

            {
                ...
                if(RD_Training_Switchboard[old_prfs_index][ii] == 1)

                {
                    ...
                    else if(RD_Training_Switchboard[old_prfs_index - 1][ii] == 0)

                    {

                        // Clear the old frequency bit

                        RD_Training_Switchboard[old_prfs_index][ii] = 0;

                        // Set the new frequence bits

                        RD_Training_Switchboard[new_prfs_index][ii] = 1;
