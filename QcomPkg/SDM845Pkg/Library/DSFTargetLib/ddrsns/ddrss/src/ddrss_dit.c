...
$Header: //components/rel/boot.xf/2.2/QcomPkg/SDM845Pkg/Library/DSFTargetLib/ddrsns/ddrss/src/ddrss_dit.c#3 $
    ...
    while ((loopcnt < max_loopcnt) && (dit_watchdog < DIT_WATCHDOG))
    {
        ...
        if (device_width == DEVICE_WIDTH_IS_x8)
        {
            invalid_count_flag = (
                ...
                ((((MR18_data>>16) & 0x00FF) <= 0x40) && (((MR19_data>>16) & 0x00FF) == 0x00)) ||
