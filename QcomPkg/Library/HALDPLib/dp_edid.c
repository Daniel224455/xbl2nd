  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        /*
         * Limit the number of extension blocks we parse to the available space
         * minus the base 128byte EDID.
         */
        if (uExtBlockNum > (DP_EDID_MAX_NUM_OF_BLOCKS - 1))
        {
           uExtBlockNum =  DP_EDID_MAX_NUM_OF_BLOCKS - 1;
        }
