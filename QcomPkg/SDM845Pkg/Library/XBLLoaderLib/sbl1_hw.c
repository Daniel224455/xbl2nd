...
$Header: //components/rel/boot.xf/2.0/QcomPkg/SDM845Pkg/Library/XBLLoaderLib/sbl1_hw.c#23 $
...
void sbl1_hw_dload_init(bl_shared_data_type *bl_shared_data)
{
  ...
  /* Call into pmic to configure GPIO10 so that hard reset on
    SDM845 does not reset MDM on fusion platform.
  */
