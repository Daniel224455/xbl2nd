...
#define HWIO_GCC_UFS_CARD_2_BCR_ADDR                                                               (GCC_CLK_CTL_REG_REG_BASE      + 0x000a2000)
#define HWIO_GCC_UFS_CARD_2_BCR_RMSK                                                                      0x1
#define HWIO_GCC_UFS_CARD_2_BCR_IN          \
        in_dword_masked(HWIO_GCC_UFS_CARD_2_BCR_ADDR, HWIO_GCC_UFS_CARD_2_BCR_RMSK)
#define HWIO_GCC_UFS_CARD_2_BCR_INM(m)      \
        in_dword_masked(HWIO_GCC_UFS_CARD_2_BCR_ADDR, m)
#define HWIO_GCC_UFS_CARD_2_BCR_OUT(v)      \
        out_dword(HWIO_GCC_UFS_CARD_2_BCR_ADDR,v)
#define HWIO_GCC_UFS_CARD_2_BCR_OUTM(m,v) \
        out_dword_masked_ns(HWIO_GCC_UFS_CARD_2_BCR_ADDR,m,v,HWIO_GCC_UFS_CARD_2_BCR_IN)
#define HWIO_GCC_UFS_CARD_2_BCR_BLK_ARES_BMSK                                                             0x1
#define HWIO_GCC_UFS_CARD_2_BCR_BLK_ARES_SHFT                                                             0x0
