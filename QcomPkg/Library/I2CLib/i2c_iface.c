...
i2c_status bus_iface_transfer (client_ctxt *c_ctxt)
{
    ...
    if ((c_ctxt         == NULL) ||
        (c_ctxt->h_ctxt == NULL))
    {
        I2C_LOG(LEVEL_ERROR, "[I2C] bus_iface_transfer : invalid param");
    ...
    if ((dcfg           == NULL) ||
        ...
        (dc             == NULL))
    {
        I2C_LOG(LEVEL_ERROR, "[I2C] bus_iface_transfer : invalid parameter");
        return I2C_ERROR_INVALID_PARAMETER;
    }
    ...
    if (clk_cfg == NULL)
    {
        I2C_LOG(LEVEL_ERROR, "[I2C] bus_iface_transfer : bus_iface_get_clock_config() failed");
    ...
    {
        I2C_LOG(LEVEL_ERROR, "[I2C] bus_iface_transfer : bus_iface_get_opcode() failed");
...
static i2c_status i2c_handle_cancel_sequence(uint8 *base_addr , i2c_status i_status)
{
	...
	if(retry_count == 0)
	{
		...
		if(retry_count == 0)
		{
            I2C_LOG(LEVEL_ERROR, "[I2C] i2c_handle_cancel_sequence : transfer is force terminated");
			i_status = I2C_TRANSFER_FORCE_TERMINATED;
		}
...
i2c_status bus_iface_init (hw_ctxt *h_ctxt)
{
    ...
    if (g_ctxt == NULL)
    {
        I2C_LOG(LEVEL_ERROR, "[I2C] bus_iface_init : invalid param");
        return I2C_ERROR_INVALID_PARAMETER;
    }
	...
	{
      I2C_LOG(LEVEL_ERROR, "[I2C] bus_iface_init : i2c_fw_load() failed");  
...
i2c_status bus_iface_queue_transfer (client_ctxt *c_ctxt)
{
    ...
    {
        I2C_LOG(LEVEL_ERROR, "[I2C] bus_iface_queue_transfer : invalid param");
        return I2C_ERROR_INVALID_PARAMETER;
    }
