...
/*============================================================================
  ...
  ----------  ---  -----------------------------------------------------------
  06/25/19    ts   ClamShell 1 settings separated

============================================================================*/

/*############################################################################*/
/*############################################################################*/
/*########################## CLAM SHELL 1 SETTINGS ###########################*/
/*############################################################################*/
/*############################################################################*/
 ...
 ******************************************************************************/
/*
 * ENDP GPIO configuration for RP3 in CLS 1 platform
 */
STATIC CONST gpioPinConfig_t cls_1_gpio_config_rp3[] =
{
  {
    .type = MSM_GPIO,
    {
  ...
  ,
  {
   .type = DELAY,
   {
    .DelayValue = 1000000 // 1s delay for power to become stable
   }
  }
  ,
  {
  ...
  ,
  {
   .type = DELAY,
   {
    .DelayValue = 30000 // 30 ms for power switch press
   }
  }
  ,
  {
  ...
  ,
  {
   .type = MSM_GPIO,
   {
    .TlmmGpioParam.GpioNum = 186, // PCIE_RST
    .TlmmGpioParam.Func = 0,
    .TlmmGpioParam.Direction = GPIO_OUTPUT,
    .TlmmGpioParam.Pull = GPIO_NO_PULL,
    .TlmmGpioParam.DriveStrength = GPIO_2MA,
  ...
  ,
  {
   .type = DELAY,
   {
    .DelayValue = 4000000 // 4 second delay for EP device preparation for Link Training
   }
  }
  ,
 ...
 ******************************************************************************/
static portInfo_t cls1_multi_port_info[] =
{
...
/* Include port_info for RP3 if it exist */
#if (RPMASK & PCIE_RP(3))
  {
    ...
    .gpio_cfg            = cls_1_gpio_config_rp3,
    .mem                 = port_3_reg,
 ...
 ******************************************************************************/
STATIC CONST rootPort_t cls1_root_port[] = {
  {
    .port_info = cls1_multi_port_info,
    .num_rp    = ARRAY_LENGTH(cls1_multi_port_info)
  }
};
 ...
 ******************************************************************************/
STATIC CONST pcieBsp_t PcieCls1Bsp[] =
{
  {
