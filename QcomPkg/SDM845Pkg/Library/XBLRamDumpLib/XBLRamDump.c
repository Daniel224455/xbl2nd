...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 05/15/18   aus     Added support for using secure WDT
...
* 
*/ 
#define SEC_WDT_TIMEOUT_ON   10000
...
VOID XBLRamDumpMain( VOID )
{
  ...
  {
    /* Enable Secure WDT only for Minidump case, since full-dumps to eMMC/SDCard/QPST will not complete within WDG expiry */
