...
///////////////////////////////////////////////////////////////////////////////////////////////
//
// llcc_seq_hwioreg.h : automatically generated by Autoseq  3.0 2/19/2017 
// User Name:fengding
//
...
//// Register LLCC_FEAC_DEC_ERR_STATUS0 ////

#define HWIO_LLCC_FEAC_DEC_ERR_STATUS0_ADDR(x)             (x+0x00002024)
#define HWIO_LLCC_FEAC_DEC_ERR_STATUS0_PHYS(x)             (x+0x00002024)
#define HWIO_LLCC_FEAC_DEC_ERR_STATUS0_RMSK                0xffffffff
#define HWIO_LLCC_FEAC_DEC_ERR_STATUS0_SHFT                         0
#define HWIO_LLCC_FEAC_DEC_ERR_STATUS0_IN(x)               \
	in_dword_masked ( HWIO_LLCC_FEAC_DEC_ERR_STATUS0_ADDR(x), HWIO_LLCC_FEAC_DEC_ERR_STATUS0_RMSK)
#define HWIO_LLCC_FEAC_DEC_ERR_STATUS0_INM(x, mask)        \
	in_dword_masked ( HWIO_LLCC_FEAC_DEC_ERR_STATUS0_ADDR(x), mask) 
#define HWIO_LLCC_FEAC_DEC_ERR_STATUS0_OUT(x, val)         \
	out_dword( HWIO_LLCC_FEAC_DEC_ERR_STATUS0_ADDR(x), val)
#define HWIO_LLCC_FEAC_DEC_ERR_STATUS0_OUTM(x, mask, val)  \
	do {\
		HWIO_INTLOCK(); \
		out_dword_masked_ns(HWIO_LLCC_FEAC_DEC_ERR_STATUS0_ADDR(x), mask, val, HWIO_LLCC_FEAC_DEC_ERR_STATUS0_IN(x)); \
		HWIO_INTFREE();\
	} while (0) 

#define HWIO_LLCC_FEAC_DEC_ERR_STATUS0_ERR_ADDR_BMSK       0xffffffff
#define HWIO_LLCC_FEAC_DEC_ERR_STATUS0_ERR_ADDR_SHFT              0x0
...
#define HWIO_LLCC_TRP_CFLUSH_CTRL_1_RMSK                    0x00ff0fff
