...
XML_DEPS = $(SILICON_PATH)/QcomPkg/SDMPkg/Settings/DALSystem/$(MACRO_NAME)/dalsystem_$(MACRO_NAME).xml \
           ...
           $(SILICON_PATH)/QcomPkg/SDMPkg/1000/Settings/PMIC/pm_config_target_core.xml \
	   ...
	   $(SILICON_PATH)/QcomPkg/SDMPkg/1000/Settings/SPI/core/spi_devcfg_Sdm1000.xml \
           $(SILICON_PATH)/QcomPkg/SDMPkg/1000/Settings/SMMU/iort.xml \
...
CALLING_MAKE_FILE = $(SILICON_PATH)/QcomPkg/SDMPkg/1000/Settings/DALConfig/DALConfigCoreLib_LLVM.mk
# \
