...
*/
typedef enum {
  USB_CORE_0_SDM_845 = 0,      /**< Core0. */
  USB_CORE_1_SDM_845,          /**< Core1. */
  USB_CORE_MAX_NUM_SDM_845,    /**< Invalid Core. */
} QCOM_USB_CORE_NUM_SDM_845;

/**
USB Mode
*/
typedef enum {
  USB_HOST_MODE_SDM_845    = 1, /**< HOST MODE. */
  USB_DEVICE_MODE_SDM_845,      /**< DEVICE MODE. */
  USB_DUAL_ROLE_SDM_845,        /**< Detect USB mode based on cable detection */
} QCOM_USB_MODE_TYPE_SDM_845;
