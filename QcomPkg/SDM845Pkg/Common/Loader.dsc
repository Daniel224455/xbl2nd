...
[Components.common]
  QcomPkg/XBLLoader/XBLLoader.inf {
    <LibraryClasses>
      ...
      #PrngLib|QcomPkg/SDM845Pkg/Library/RNGLoaderLib/RNGLibHw.inf

      # Only required for XBL loader
      CPRTargetLib|QcomPkg/SDM845Pkg/Library/CPRTargetLib/Loader/CPRTargetLib.inf
      #CPRTargetLib|QcomPkg/Library/NullLibs/PowerLibNull/CprLibNull.inf
      RailwayTargetLib|QcomPkg/SDM845Pkg/Library/RailwayTargetLib/RailwayTargetLib.inf
