...
/**
  ...
  BSP data for the SDM845 apps clock driver.
*/
/*
  ====================================================================
  ...
  ====================================================================
  $Header: //components/rel/boot.xf/2.2/QcomPkg/SDM845Pkg/Library/ClockLib/ClockAppsBSP.c#1 $
...
)
{
  ...
  switch (eConfigParam)
  {
    ...
    case CLOCK_CONFIG_PARAM_GET_VMIN_REDUCTION_STATE_CLUSTER_1:
      *nValue = (uint32)ClockAppsBSPConfig.aClockOsmCtxt[4].bVminReduction;
      break;
