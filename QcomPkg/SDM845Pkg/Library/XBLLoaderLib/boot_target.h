...
Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/boot.xf/2.0/QcomPkg/SDM845Pkg/Library/XBLLoaderLib/boot_target.h#21 $
  $DateTime: 2018/09/19 03:11:46 $ 
  $Author: pwbldsvc $
...
#define QHEE_IMG_WHITELIST {{SCL_QHEE_CODE_BASE,SCL_QHEE_TOTAL_SIZE},{SCL_QHEE1_CODE_BASE,SCL_QHEE1_TOTAL_SIZE},{SCL_QHEE2_CODE_BASE,SCL_QHEE2_TOTAL_SIZE},{0,0}}
