...
#define HWIO_VER_NUMBER_ADDR(x)                                                               ((x) + 0x0000c1a0)
#define HWIO_VER_NUMBER_OFFS                                                                  (0x0000c1a0)
#define HWIO_VER_NUMBER_RMSK                                                                   0xffffffff
#define HWIO_VER_NUMBER_IN(x)      \
        in_dword_masked(HWIO_VER_NUMBER_ADDR(x), HWIO_VER_NUMBER_RMSK)
#define HWIO_VER_NUMBER_INM(x, m)      \
        in_dword_masked(HWIO_VER_NUMBER_ADDR(x), m)
#define HWIO_VER_NUMBER_IPVERSION_BMSK                                                        0xffffffff
#define HWIO_VER_NUMBER_IPVERSION_SHFT                                                               0x0

#define HWIO_VER_TYPE_ADDR(x)                                                                 ((x) + 0x0000c1a4)
#define HWIO_VER_TYPE_OFFS                                                                    (0x0000c1a4)
#define HWIO_VER_TYPE_RMSK                                                                     0xffffffff
#define HWIO_VER_TYPE_IN(x)      \
        in_dword_masked(HWIO_VER_TYPE_ADDR(x), HWIO_VER_TYPE_RMSK)
#define HWIO_VER_TYPE_INM(x, m)      \
        in_dword_masked(HWIO_VER_TYPE_ADDR(x), m)
#define HWIO_VER_TYPE_VERSIONTYPE_BMSK                                                        0xffffffff
#define HWIO_VER_TYPE_VERSIONTYPE_SHFT                                                               0x0
