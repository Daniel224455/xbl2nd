...
==============================================================================
  ...
  $Header: //components/rel/boot.xf/2.2/QcomPkg/SDM845Pkg/Library/ClockTargetLib/ClockAOP.c#2 $
...
#define PIPPO_TEST_CTL_VAL   0x001E000000200000ULL
...
boolean Clock_ConfigAOP( void )
{
  ...
  if ( Clock_ConfigData.PLL5_Cfg[nVer].bConfig == FALSE )
    if ( !Clock_ConfigurePLL(&Clock_ConfigData.PLL5_Cfg[nVer]) ) return FALSE;
