...
INC_DEPS = $(WORKSPACE)/QcomPkg/Include/api/dal/*.h \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/DALConfig/*.h \
...
#
# __FIX__SDM845:  uncomment driver xmls when corresponding drivers are ported
XML_DEPS = $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/DALSystem/$(MACRO_NAME)/dalsystem_$(MACRO_NAME).xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/I2C/$(MACRO_NAME)/i2c_devcfg_Sdm845.xml \
           $(WORKSPACE)/QcomPkg/Settings/ChipInfo/DalChipInfo.xml\
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/PMIC/pm_config_target_loader.xml \
	   $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/PMIC/pm_config_target.xml \
           $(WORKSPACE)/QcomPkg/Settings/PMIC/pm_config_common.xml \
           $(WORKSPACE)/QcomPkg/Settings/PlatformInfo/PlatformInfo.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/TSENS/tsens_props.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/BootTempCheck/boot_temp_check_props.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/ADC/internal/loader/adc_props.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/ADC/internal/loader/vadc_props.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/ADC/internal/loader/fgadc_props.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/BAM/bam_config.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/UFS/ufs_config.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/ICB/loader/icbcfg_boot.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/SMEM/smem_xbl_loader.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/TLMM/loader/TLMMChipset.xml \
           $(WORKSPACE)/QcomPkg/SDM845Pkg/Settings/Qusb/qusb.xml \
...
$(OUTPUT_DIR)/DALConfigLoaderLib.lib : $(OBJECT_FILES)
	"$(SLINK)" -cr $(OUTPUT_DIR)/DALConfigLoaderLib.lib $(SLINK_FLAGS) $(OUTPUT_DIR)/DALConfig_$(MACRO_NAME).obj
