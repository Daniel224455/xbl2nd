...
/*=====================================================================================
 ...
 11/28/18     pbitra  Added support for wireless charging
 09/07/18     sb      Fix issue where charging is disabled in unknown battery cases
...
EFI_STATUS ChargerPlatform_TakeAction(EFI_QCOM_CHARGER_ACTION_TYPE ChargingAction, CONST QCOM_CHARGER_PLATFORM_ACTION_INFO *pChargerActionInfo)
{
  ...
  case EFI_QCOM_CHARGER_ACTION_FACTORY_MODE_BOOT_TO_HLOS:
	  CHARGER_FILE_UART_DEBUG((EFI_D_WARN, "QcomChargerDxe::Setting Factory Mode ICL \r\n"));
	  /* Set the Debug Accessory Mdoe ICL */
	  ChargerLib_SetDAMICL(gChargerPlatformCfgData.ChargerLibCfgData.schg_cfg_data.DAMSelIcl3AorFMB);
	  break;
    default:
...
)
{
  ...
  if (AsciiStriCmp ((CHAR8*)Section, "PlatformCommon") == 0) //Common
  {
	...
	gChargerPlatformCfgData.ChargerLibCfgData.schg_cfg_data.SchgSkinDieTemp.ProgramSkinAndChargerHotThreshold = (AsciiStriCmp((CHAR8*)Value, "TRUE") == 0);
    return;
    }
	...
	gChargerPlatformCfgData.ChargerLibCfgData.schg_cfg_data.SchgSkinDieTemp.DeviceSkinHotInC = (AsciiStriCmp((CHAR8*)Value, "TRUE") == 0);
    return;
    }
	...
	gChargerPlatformCfgData.ChargerLibCfgData.schg_cfg_data.SchgSkinDieTemp.DeviceSkinTooHotInC = (AsciiStriCmp((CHAR8*)Value, "TRUE") == 0);
    return;
    }
	...
	gChargerPlatformCfgData.ChargerLibCfgData.schg_cfg_data.SchgSkinDieTemp.ChargerTooHotInC = (AsciiStriCmp((CHAR8*)Value, "TRUE") == 0);
    return;
    }
	...
	gChargerPlatformCfgData.ChargerLibCfgData.schg_cfg_data.SchgSkinDieTemp.ChargerHotInC = (AsciiStriCmp((CHAR8*)Value, "TRUE") == 0);
    return;
    }
