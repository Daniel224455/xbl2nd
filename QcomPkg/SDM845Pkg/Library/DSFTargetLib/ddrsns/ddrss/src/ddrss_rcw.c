...
$Header: //components/rel/boot.xf/2.2/QcomPkg/SDM845Pkg/Library/DSFTargetLib/ddrsns/ddrss/src/ddrss_rcw.c#2 $
$DateTime: 2018/01/24 02:33:10 $
$Author: pwbldsvc $
================================================================================
...
//	}
	...
	MC_MR_Write (ddr, CH_1HOT(ch), CS_1HOT(cs), JEDEC_MR_13, 0xC2);
...
if(! all_found)
{
	...
	MC_MR_Write (ddr, CH_1HOT(ch), CS_1HOT(cs), JEDEC_MR_13, 0xC0);
