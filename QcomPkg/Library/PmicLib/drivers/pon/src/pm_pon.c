...
--------   ---     ---------------------------------------------------------- 
12/16/17   pxm     Correct PON reason reading
...
pm_pon_config_uvlo(uint32 pmic_device_index, uint32 uvlo_thresh_voltage_in_mv, uint32 uvlo_hyst_voltage_in_mv, boolean uvlo_enable)
{
  ...
  uvlo_thresh_data = pm_utils_get_upper_idx(uvlo_hyst_voltage_in_mv, pon_uvlo_threshold_val, ARRAY_LENGTH(pon_uvlo_threshold_val));
