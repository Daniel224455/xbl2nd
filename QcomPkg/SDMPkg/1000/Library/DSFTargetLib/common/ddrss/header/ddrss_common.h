...
// Used as function parameter for register value save/restore
typedef enum
{
  SAVE,
  RESTORE
...
#define SHUB_COLLAPSE_MAGIC_NUM    (0x12345678)
...
void DDRSS_Register_Save_Restore_Compressed(SAVE_RESTORE save_restore, REG_BLOCK_COUNTS* cnts_ptr, uint32* mem_ptr, uint32 size);
