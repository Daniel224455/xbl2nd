...
// TODO: Use PCD to obtain MAX_UFS_HCI_ID
   ...
   if (!hba->is_initialized) {
      ...
      osal_memset (&ufs_host_info_array[hufs->ufs_core_id], 0, sizeof(ufs_host_t));
...
void ufs_enable_autoH8(struct ufs_handle *hufs)
{
   ufs_bsp_autoH8(hufs->ufs_core_id); 
}
