...
#include "SDM845Pkg/Library/QusbDciCommonLib/qusb_dci_common_hwio_845.h"
...
static const uint32 qusb_dci_hs_phy_sec_cfg_address[QUSB_DCI_HS_PHY_CFG_ARRAY_ENTRY_CNT] = 
{
  ...
  HWIO_PERIPH_SS_QUSB2PHY_SEC_QUSB2PHY_TUNE1_ADDR,                                  // 05 : (0x45),
  HWIO_PERIPH_SS_QUSB2PHY_SEC_QUSB2PHY_TUNE2_ADDR,                                  // 06 : (0x29),
  HWIO_PERIPH_SS_QUSB2PHY_SEC_QUSB2PHY_TUNE5_ADDR,                                  // 07 : (0x03),  
  //-------------------------------------------------------------------------------------------
  HWIO_PERIPH_SS_QUSB2PHY_SEC_QUSB2PHY_IMP_CTRL1_ADDR,                              // 08 : (0x08),
  HWIO_PERIPH_SS_QUSB2PHY_SEC_QUSB2PHY_PLL_BIAS_CONTROL_2_ADDR,                     // 09 : (0x28),
};
...
static const uint32 qusb_dci_ss_phy_cfg_address_common[QUSB_DCI_SS_PHY_COMMON_CFG_ARRAY_ENTRY_CNT] =
{
  ...
  HWIO_PERIPH_SS_USB3_DP_PHY_USB3_PCS_LFPS_DET_HIGH_COUNT_VAL_ADDR,                 //      : (0x04)
