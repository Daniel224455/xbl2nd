...
typedef struct 
{
  uint32 index;                                     /* Training Index */
  uint32 num_of_times_executed;                       /* Number of times training function called*/
  uint32 trng_total_time;                           /* Total time spent doing this training */
  char func_name[MAX_STRING_SIZE];                  /* Training function name */
  training_func_ptr func_ptr; 	                    /* function pointer to training function */
