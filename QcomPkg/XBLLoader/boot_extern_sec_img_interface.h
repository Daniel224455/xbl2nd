 ...
 *
 */
  bl_error_boot_type boot_sec_img_auth_verify_metadata(uint32 sec_img_id, 
 ...
 *
 */
  bl_error_boot_type boot_sec_img_auth_hash_elf_segments(uint32 sec_img_id,
                                      sec_img_auth_verified_info_s *v_info);
 ...
 *
 */
  bl_error_boot_type boot_sec_img_auth_validate_elf(uint32 format, const void *elf_hdr);
 ...
 *
 */
bl_error_boot_type boot_sec_img_auth_partial_hash_init
( 
  void   *hash_buffer, 
 ...
 *
 */
bl_error_boot_type boot_sec_img_auth_partial_hash_update
( 
  void   *hash_buffer, 
  uintnt hash_buff_size,
  void   *partial_buff, 
 ...
 *
 */
bl_error_boot_type boot_sec_img_auth_partial_hash_finalize
( 
  void   *hash_buffer, 
  uintnt hash_buff_size,
  void   *partial_buff, 
