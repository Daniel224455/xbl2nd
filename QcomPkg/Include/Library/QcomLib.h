...
/*=============================================================================
 ...
 10/26/17	mt		Added the func to save TZlog buffer
...
/**
  ...
  @param[in]   PartitionType   Partition GUID as in partition.xml
  ...
  */
EFI_STATUS
ReadFromPartitionUsingGuid(
    EFI_GUID      *PartytionType,
    VOID          **ReadBuffer,
    UINTN         *ImageSize
    );
