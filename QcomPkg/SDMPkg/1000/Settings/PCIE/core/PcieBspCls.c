...
/*============================================================================
  ...
  ----------  ---  -----------------------------------------------------------
  10/30/18    ts   ClamShell settings separated
...
/*******************************************************************************
 * GPIO configuration for RP0 in CLS platform
 *
 ...
 ******************************************************************************/
/*
 * ENDP GPIO configuration for RP0 in CLS platform
 */
STATIC CONST gpioPinConfig_t cls_gpio_config_rp0[] =
{
 ...
 ******************************************************************************/
static portInfo_t cls_multi_port_info[] =
{
 ...
 ******************************************************************************/
STATIC CONST rootPort_t cls_root_port[] = {
  {
    .port_info = cls_multi_port_info,
    .num_rp    = ARRAY_LENGTH(cls_multi_port_info)
  }
};
 ...
 ******************************************************************************/
STATIC CONST pcieBsp_t PcieClsBsp[] =
{
  {
