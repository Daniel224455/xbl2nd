...
typedef enum {
  ...
  MDP_DISPLAY_PROPERTY_GETPANELRESOLUTION,        /* Retrieve panel resolution */
  MDP_DISPLAY_PROPERTY_GETFRAMECRC,               /* Retrieve frame CRC */
  MDP_DISPLAY_PROPERTY_SUPPORTED_DISPLAY,         /* Is Display supported */
...
typedef union
{
  ...
  MDP_SetModeParamType    sModeParams;                                /* MDP_DISPLAY_PROPERTY_MODE_INFO, MDP_DISPLAY_PROPERTY_SURFACE_RECT */
  ...
  MDP_PanelResolutionType sResolution;                                /* MDP_DISPLAY_PROPERTY_GETPANELRESOLUTION */       
  uint64                  uCRC;                                       /* MDP_DISPLAY_PROPERTY_CRC_CONFIG */
  bool32                  bIsSupported;                               /* MDP_DISPLAY_PROPERTY_SUPPORTED_DISPLAY */  
