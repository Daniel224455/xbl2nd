...
--------   --------     ----------------------------------------------------------
09/11/18   daisond      Increased SCL_SBL1_DSF_ROM_SIZE size
08/29/18   msantos      Added SBL crash dump region
05/02/18   yps          Increased log buffer size
04/23/18   vk           update SEC.ELF range
04/18/18   yps          update serial number register
...
#define SCL_SBL1_DDR_DSF_ROM_SIZE        (SIZE_100KB + SIZE_12KB)
#define SCL_SBL1_DDR_DSF_DATA_BASE       (SCL_SBL1_DDR_DSF_ROM_BASE + SCL_SBL1_DDR_DSF_ROM_SIZE)
#define SCL_SBL1_DDR_DSF_DATA_SIZE       (SIZE_36KB)
#define SCL_SBL1_DDR_STRUCT_BASE         (SCL_SBL1_DDR_DSF_DATA_BASE + SCL_SBL1_DDR_DSF_DATA_SIZE)
#define SCL_SBL1_DDR_STRUCT_SIZE         SIZE_12KB
#define SCL_SBL1_DDR_DSF_SEGMENT_SIZE    SIZE_160KB
...
#define SCL_DDR_TRAINING_DATA_BUF_SIZE   SIZE_12KB
...
#define SCL_SBL1_CODE_SIZE               SIZE_324KB
...
#define SCL_SBL1_DATA_SIZE               SIZE_60KB + DEVCFG_DATA_SECTION_SIZE

#define DEVCFG_DATA_SECTION_BASE         (SCL_SBL1_DATA_BASE + (SCL_SBL1_DATA_SIZE - DEVCFG_DATA_SECTION_SIZE))
#define DEVCFG_DATA_SECTION_SIZE         SIZE_4KB

#define SCL_SBL1_DATA_ZI_BASE            (SCL_SBL1_DATA_BASE + SCL_SBL1_DATA_SIZE)
#define SCL_SBL1_DATA_ZI_SIZE            (SIZE_80KB + SIZE_4KB)
                                         
#define SCL_SBL1_PAGE_TABLE_BASE         (SCL_SBL1_DATA_ZI_BASE + SCL_SBL1_DATA_ZI_SIZE)
#define SCL_SBL1_PAGE_TABLE_SIZE         SIZE_36KB

#define SCL_SBL1_SHARED_FUNCTIONS_TABLE_BASE (SCL_SBL1_DATA_ZI_BASE + SCL_SBL1_DATA_ZI_SIZE - SCL_SBL1_SHARED_FUNCTIONS_TABLE_SIZE )
...
#define SCL_SBL1_DDR_DATA_SIZE           SIZE_172KB
...
#define SCL_RAMDUMP_CODE_SIZE            SIZE_360KB
...
#define SCL_AOP_BASE                     0x85F00000
#define SCL_AOP_SIZE                     0x40000

#define SCL_QSEE_CODE_BASE               SCL_IMEM_BASE
#define SCL_QSEE_TOTAL_SIZE              SIZE_96KB
#define SCL_TZ_STAT_BASE                 0x86200000
#define SCL_TZ_STAT_BASE_SIZE            SIZE_1MB

// OEM_MISC - BOOT_IMEM_END - 16 KB (12 KB + 4 KB reserved)
#define SCL_MULTI_IMAGE_CODE_BASE        (SCL_BOOT_IMEM_BASE_ADDR + SCL_BOOT_IMEM_BASE_SIZE - SIZE_16KB)
...
// SECDATA
#define SCL_SECDATA_BASE                 0x85FFD000
...
#define SCL_QHEE_CODE_BASE_2                0x80000000
#define SCL_QHEE_TOTAL_SIZE_2               SIZE_12KB
#define SCL_QHEE_CODE_BASE_3                0xA000000
#define SCL_QHEE_TOTAL_SIZE_3               SIZE_8KB
#define SCL_QHEE_CODE_BASE_4                0xC0000000
#define SCL_QHEE_TOTAL_SIZE_4               SIZE_256MB
...
#define SCL_IPA_IU_BASE    0x01E60000
#define SCL_IPA_IU_SIZE    0x9F00
#define SCL_IPA_SRAM_BASE  0x01E47000
#define SCL_IPA_SRAM_SIZE  0x2800
#define SCL_IPA_MBOX_BASE  0x01E72000
#define SCL_IPA_MBOX_SIZE  0x100
#define SCL_IPA_GSI_BASE   0x01E04000 
#define SCL_IPA_GSI_SIZE   0x1000
#define SCL_IPA_GSI_SHRAM_BASE 0x1E06000
#define SCL_IPA_GSI_SHRAM_SIZE 0x1000
#define SCL_IPA_HRAM_BASE  0x01E4A000
#define SCL_IPA_HRAM_SIZE  0x8000
#define SCL_IPA_SEQ_BASE   0x01E5E000
#define SCL_IPA_SEQ_SIZE   0x200
...
//reuse PMIC buffer for devcfg prior to loading pmic
#define DEVCFG_META_SECTION_BASE (SCL_PMIC_CONFIG_BUF_BASE)
#define DEVCFG_DATA_BUFFER_BASE (DEVCFG_META_SECTION_BASE+0x14)
