...
#define QSEE_APP_START_EMBEDDED_COMMAND  0x11
...
/*
   Top level TZ syscall request structure for
   QSEE_APP_START_EMBEDDED_COMMAND. */
   
/**
   @weakgroup weak_tzos_app_start_embedded_s
@{
*/
typedef struct tzos_app_start_embedded_s
{
  UINT64                     app_name;      // Pointer to TA name.
  UINT64                     app_name_len;  // Length of TA name.
} __attribute__ ((packed)) tzos_app_start_embedded_t;
