...
[Defines]
  ...
  FLASH_DEFINITION               = QcomPkg/SDMPkg/1000/AU/Core.fdf

[Defines.ARM]
  OUTPUT_DIRECTORY               = Build/SDM1000AU_Core_32

[Defines.AARCH64]
  OUTPUT_DIRECTORY               = Build/SDM1000AU_Core
...
[LibraryClasses.common]
  ...
  ArmMmuLib|ArmPkg/Library/ArmMmuLib/ArmMmuBaseLib_AU.inf
  ...
  #UefiSecAppLoaderLib|QcomPkg/Library/UefiSecAppLoaderLib/UefiSecAppLoaderLib.inf
  ...
  StorageBootCommonLib|QcomPkg/Library/StorageCommonLib/StorageCoreCommon.inf
  ...
  PmicLib|QcomPkg/SDMPkg/1000/Library/PmicLib/PmicAuLib.inf
  ...
  PmicShutdownLibBoot|QcomPkg/SDMPkg/1000/Library/PmicLib/core/au/pm_shutdown.inf
  PmicShutdownRuntimeLib|QcomPkg/SDMPkg/1000/Library/PmicLib/core/au/pm_runtime_shutdown.inf
  SmemTargetLib|QcomPkg/SDMPkg/Library/SmemTargetLib/SmemTargetLib.inf

  # DAL Target Libraries
  DALGenLibCore|QcomPkg/SDMPkg/1000/Settings/DALConfig/DALGenLibCore_AU.inf
  DALGenLibTools|QcomPkg/SDMPkg/1000/Settings/DALConfig/DALGenLibTools.inf
  DALConfigLib|QcomPkg/SDMPkg/1000/Settings/DALConfig/DALConfigCoreLib_AU.inf
  ...
  # MpPower Library
  # MpPowerLib|QcomPkg/SDMPkg/Library/MpPowerLib/MpPowerLib.inf
...
[LibraryClasses.common.DXE_DRIVER]
  ...
  BdsTargetLib|QcomPkg/SDMPkg/Library/BdsTargetLib/BdsTargetLib.inf
...
[BuildOptions.AARCH64]
 GCC:*_*_AARCH64_ARCHCC_FLAGS  == -fno-common -mtune=cortex-a53 -I$(WORKSPACE)/QcomPkg/SDMPkg/Include -I$(WORKSPACE)/QcomPkg/SDMPkg/1000/Include -include $(WORKSPACE)/QcomPkg/Include/Library/DebugLib.h -DQCOM_EDK2_PATCH -DDISABLE_DEP $(FEATURE_FLAGS) -DENABLE_XN -DENABLE_DEP_64 -DENABLE_ASLR -DENABLE_EXEC_CODE_READY_TO_BOOT -DENABLE_AUTO_PLAT -DENABLE_AUTO_BOOT_OPTIMIZATION -DENABLE_UEFI_MULTI_CORE
 GCC:*_*_AARCH64_ARCHPP_FLAGS  == -I$(WORKSPACE)/QcomPkg/SDMPkg/Include -I$(WORKSPACE)/QcomPkg/SDMPkg/1000/Include -include $(WORKSPACE)/QcomPkg/Include/Library/DebugLib.h -DQCOM_EDK2_PATCH -DDISABLE_DEP $(FEATURE_FLAGS) -DENABLE_XN -DENABLE_DEP_64 -DENABLE_ASLR -DENABLE_EXEC_CODE_READY_TO_BOOT -DENABLE_AUTO_PLAT -DENABLE_AUTO_BOOT_OPTIMIZATION -DENABLE_UEFI_MULTI_CORE
...
[PcdsFeatureFlag.common]
  ...
  # HW Watchdog
  #gQcomTokenSpaceGuid.ForceEnableHWWdog|TRUE
...
#
  ...
  # No charger policy used for display
  gQcomTokenSpaceGuid.PcdDisplayChargerPolicy|0
  # Enable PFS for display
  gQcomTokenSpaceGuid.PcdPrimaryFlags|0x10000000
  # Bitmask to configure which displays are active
  gQcomTokenSpaceGuid.PcdSupportedDisplays|0x0B
...
#
  ...
  #I2C
  gQcomTokenSpaceGuid.EEPROMI2CCore|15
  gQcomTokenSpaceGuid.EEPROMSlaveAddress|0x52
  ...
  gQcomTokenSpaceGuid.SDCCRegBase|"+PERIPH_SS_SDC2_SDCC_SDCC5_HC"
  ...
  gQcomTokenSpaceGuid.USBMultiPortSupported|FALSE
...
# SEC
#
  QcomPkg/XBLCore/XBLCore_AU.inf {
    <LibraryClasses>
      SchedulerLib|QcomPkg/Library/SchedulerLib/SchedulerLib.inf
  }
...
#
  ...
  # CPR DXE driver
  #
  QcomPkg/Drivers/CPRDxe/CPRAuDxe.inf {
    <LibraryClasses>
    # CPR Library
    CPRLib|QcomPkg/SDMPkg/1000/Library/CPRTargetLib/Core/CPRTargetLibAu.inf
  }
  ...
  #
  QcomPkg/Drivers/PmicDxe/PmicDxeAu.inf {
    <LibraryClasses>
     #PMIC Library
    PmicCoreLib|QcomPkg/SDMPkg/1000/Library/PmicLib/core/au/PmicCoreLibau.inf
  }
  ...
  # Bds
  #
  QcomPkg/Drivers/QcomBds/QcomBds_AU.inf

  #
  # NOCBW
  #
  QcomPkg/Drivers/NOCBWDxe/NOCBWDxe.inf
